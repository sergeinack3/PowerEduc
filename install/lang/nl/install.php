...
$string['pathssubadmindir'] = 'Sommige webhosts gebruiken /admin als een speciale url om toegang tot bijvoorbeeld een controlepaneel te krijgen. Dit kan conflicten veroorzaken met de standaardlocatie van de Moodle admin scripts. Je kunt dit oplossen door de admin map van Moodle te hernoemen en de nieuwe naam hier te zetten. Bijvoorbeeld <em>powereducadmin</em>. Dat zal de admin links in Moodle herstellen.';
...
$string['welcomep40'] = 'Dit pakket bevat ook <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
