...
$string['clialreadyconfigured'] = 'Het configuratiebestand config.php bestaat al. Maak aub gebruik van admin/cli/install_database.php als je PowerEduc voor deze site wenst te installeren.';
$string['clialreadyinstalled'] = 'Het configuratiebestand config.php bestaat al. Maak aub gebruik van admin/cli/install_database.php als je PowerEduc voor deze site wenst te upgraden.';
$string['cliinstallheader'] = 'PowerEduc {$a} command line installatieprogramma';
...
$string['dirroot'] = 'PowerEduc-map';
$string['environmenthead'] = 'Omgeving controleren ...';
$string['environmentsub2'] = 'Elke PowerEducversie vraagt een minimale PHP-versie en een aantal vereiste PHP-extenties.
...
<p>Hierdoor kan PowerEduc geheugenproblemen krijgen, vooral als je veel modules installeert en/of veel gebruikers hebt.</p>
...
Hierdoor kan PowerEduc zelf zijn geheugenlimiet instellen.
...
<li>Op sommige PHP-servers kun je een .htaccess-bestand maken in de PowerEduc-map met volgende lijn: <p><blockquote>php_value memory_limit 40M</blockquote></p>
...
$string['pathssubadmindir'] = 'Sommige webhosts gebruiken /admin als een speciale url om toegang tot bijvoorbeeld een controlepaneel te krijgen. Dit kan conflicten veroorzaken met de standaardlocatie van de PowerEduc admin scripts. Je kunt dit oplossen door de admin map van PowerEduc te hernoemen en de nieuwe naam hier te zetten. Bijvoorbeeld <em>powereducadmin</em>. Dat zal de admin links in PowerEduc herstellen.';
$string['pathssubdataroot'] = '<p>Een map waar PowerEduc geüploade bestanden kan bewaren.</p>
...
$string['pathssubdirroot'] = '<p>Het volledig pad naar de PowerEduc-code.</p>';
$string['pathssubwwwroot'] = '<p>Het volledige webadres waarlangs de toegang naar PowerEduc zal gebeuren - het adres dat gebruikers zullen ingeven om PowerEduc te bereiken.</p>
<p>Het is niet mogelijk toegang tot PowerEduc te krijgen via meerdere adressen. Als je site meerdere publieke adressen heeft, dan zul je permanente verwijzingen moeten opzetten voor al die andere adressen.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc heeft minstens PHP-versie 5.6.5 of 7.1 nodig (7.0.x heeft een aantal beperkingen).</p>
...
$string['welcomep30'] = 'Deze uitgave van <strong>{$a->installername}</strong> bevat de software die nodig is om een omgeving te creëren waarin <strong>PowerEduc</strong> zal werken, namelijk:';
$string['welcomep40'] = 'Dit pakket bevat ook <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'De volgende pagina\'s leiden je door een aantal makkelijk te volgen stappen om <strong>PowerEduc</strong> te installeren op je computer. Je kunt de standaardinstellingen overnemen of, optioneel, ze aanpassen aan je noden.';
$string['welcomep70'] = 'Klik op de "volgende"-knop om verder te gaan met de installatie van <strong>PowerEduc</strong>';
