...
$string['pathssubadmindir'] = 'Nieliczne portale używają URL /admin jako specjalnego adresu panelu sterowania. Niestety jest to sprzeczne ze standardowej lokalizacją folderu stron administratora Moodle. Można to naprawić poprzez zmianę nazwy katalogu administratora w instalacji i podanie tej nazwy tu, np.: <em>powereducadmin.</em> Linki administratora Moodle będą automatycznie poprawione.';
...
$string['welcomep40'] = 'Pakiet zawiera <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
