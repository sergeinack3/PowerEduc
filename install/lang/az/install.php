...
$string['dirroot'] = 'PowerEduc kataloqu';
...
Bu halda PowerEduc özü yaddaşa məhdudiyyət qoya bilir.</li>
...
<li>Bəzi PHP serverlərində PowerEduc kataloqunda .htaccess faylı yaratmaq və aşağıdakı sətri daxil etmək olar:
...
$string['pathssubadmindir'] = 'Veb-hostinqlərin sayı az olduqda yol/admin idarəetmə panelinə və ya digər bir yerə keçmək üçün xüsusi URL-dir. Təəssüf ki, bu Moodlun idarəetmə səhifələrinin standart mövqeyi ilə ziddiyyət təşkil edir. Bunu PowerEduc kataloqunda admin qovluğunun adını dəyişməklə və burada yeni adı göstərməklə aradan qaldırmaq olar. Məsələn, <em>powereducadmin</em>. Bu zaman Moodlun idarəetmə panelinə bütün keçidlər avtomatik olaraq dəyişir.';
...
$string['phpversionhelp'] = '<p>PowerEduc üçün PHP-nin 4.3.0  və ondan yuxarı  və ya 5.1.0 və ondan yuxarı versiyaları(5.0.versiyasının bəzi problemləri məlumdur) lazımdır.</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>  proqram paketinin bu versiyasında <strong>PowerEduc</strong>un işləyəcəyi mühiti yaratmaq üçün aşağıdakı proqramlar var:';
$string['welcomep40'] = 'Paketə həmçinin <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong> daxildir.';
...
$string['welcomep60'] = 'Növbəti səhifələrdə Siz, bir neçə sadə addımla öz kompyüterinizdə <strong>PowerEduc</strong>-un parametrlərini sazlaya və quraşdıra bilərsiniz. Siz sazlama parametrlərini susmaya görə qəbul edə və ya öz tələblərinizdən asılı olaraq dəyişə bilərsiniz.';
$string['welcomep70'] = '<strong>PowerEduc</strong> quraşdırma prosesini davam etmək üçün "Növbəti" düyməsini sıxın.';
