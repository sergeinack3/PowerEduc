...
$string['clialreadyconfigured'] = 'Lo fichero de configuración config.php ya existe. Per favor, faga servir admin/cli/install_database.php pa instalar PowerEduc en este puesto.';
$string['clialreadyinstalled'] = 'Lo fichero de configuración config.php ya existe. Per favor, faga servir admin/cli/install_database.php pa actualizar PowerEduc en este puesto.';
$string['cliinstallheader'] = 'Programa d\'instalación PowerEduc de linia de comando {$a}';
...
$string['environmentsub2'] = 'Cada versión de PowerEduc tiene bell requisito minimo d\'a versión de PHP y un numero obligatorio d\'extensions de PHP.
...
<p>Esto puede ocasionar que PowerEduc tienga problemas de memoria mas abance, especialment si vusté tiene activaus muitos modulos y/u muitos usuarios.</p>
...
Esto fa que PowerEduc fixe per ell mesmo lo limite de memoria.</li>
...
<li>En qualques servidors PHP vusté puede creyar en o directorio PowerEduc un fichero .htaccess que contienga esta linia:
...
$string['pathssubadmindir'] = 'Muit pocos servidors web usan /admin como un URL especial pa acceder a un panel de control u bella cosa semellant. Lamentablement, esto dentra en conflicto con a ubicación estandard pa las pachinas d\'administración de PowerEduc. Vusté puede solucionar este problema, renombrando lo directorio admin en a suya instalación PowerEduc, metendo un nuevo nombre aquí. Per eixemplo: <em> powereducadmin </em>. Esto solucionará los vinclos d\'administración en instalación PowerEduc.';
$string['pathssubdataroot'] = 'Necesita bell espacio an que PowerEduc puede alzar los fichers puyaus. En este directorio ha de poder LEYER y ESCRIBIR l\'usuario d\'o servidor web (per lo cheneral \'nobody\',  \'apache\' u \'www-data\'), pero no ha de poder-se acceder a esta carpeta dreitament a traviés d\'a web. L\'instalador tractará de creyar-la si no existe.';
$string['pathssubdirroot'] = '<p>Rota completa d\'o directorio que contiene lo codigo de  PowerEduc.</p>';
$string['pathssubwwwroot'] = 'Adreza web completa pa acceder a PowerEduc. No ye posible acceder a PowerEduc utilizando multiples adrezas. Si lo suyo puesto tiene quantas adrezas publicas ha de configurar redireccions permanents en totas ellas, fueras d\'en2 esta. Si lo suyo puesto web ye accesible tanto dende una intranet como dende Internet, escriba aquí l\'adreza publica y configure la suya DNS pa que los usuarios d\'o suyo intranet puedan tamién utilizar l\'adreza publica.';
...
$string['phpversionhelp'] = '<p>PowerEduc requiere a lo menos una versión de PHP 4.3.0 u 5.1.0 ((5.0.x tiene una serie de problemas conoixius).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    aplicacions necesarias pa que <strong>PowerEduc</strong> funcione en o suyo ordinador,
    principalment:';
$string['welcomep40'] = 'Lo paquet tamién incluye <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Las siguients pachinas le guiarán a traviés de qualques sencillos pasos pa configurar
    y achustar <strong>PowerEduc</strong> en o suyo ordinador. Puede utilizar las valors per defecto sucherius u,
    de forma opcional, modificar-los pa que s\'achusten a las suyas necesidatz.';
$string['welcomep70'] = 'Prete en o botón "Siguient" pa continar con a configuración de <strong>PowerEduc</strong>.';
