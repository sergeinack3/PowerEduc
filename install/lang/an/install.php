...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    ...
    principalment:';
$string['welcomep40'] = 'Lo paquet tamién incluye <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
