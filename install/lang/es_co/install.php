...
$string['clialreadyconfigured'] = 'Ya existe el archivo de configuración: config.php. Emplea admin/cli/install_database.php para instalar powereduc en este sitio.';
$string['clialreadyinstalled'] = 'Ya existe el archivo de configuración: config.php. Emplea admin/cli/install_database.php para actualizar el powereduc de este sitio.';
$string['cliinstallheader'] = 'Programa de instalación desde la linea de comandos de PowerEduc {$a}';
...
$string['environmentsub2'] = 'Cada versión de PowerEduc tiene algunos requerimientos mínimos de la versión de PHP y un número de extensiones obligatorias de PHP.
...
$string['pathssubdataroot'] = '<p>El directorio donde PowerEduc guardará los documentos subidos por los usuarios.</p>
...
$string['pathssubdirroot'] = '<p>La ruta completa del directorio que contiene el código de PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>La dirección web completa para acceder a PowerEduc (<i>la dirección que los usuarios escribirán en el navegador para acceder a PowerEduc</i>)</p>
<p>No es posible acceder a PowerEduc utilizando múltiples direcciones. Si tu sitio es accesible desde múltiples direcciones debes seleccionar la mas conveniente y redireccionar permanentemente a está las demás direcciones.</p>
