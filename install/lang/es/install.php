...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para instalar PowerEduc en este sitio.';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar PowerEduc en este sitio.';
...
$string['dirroot'] = 'Directorio de PowerEduc';
$string['environmenthead'] = 'Comprobando su entorno';
$string['environmentsub2'] = 'Cada versión de PowerEduc tiene algún requisito mínimo de la versión de PHP y un número obligatorio de extensiones de PHP.
...
<li>En algunos servidores PHP puede crear en el directorio PowerEduc un archivo .htaccess que contenga esta línea:
...
$string['pathssubdataroot'] = '<p>Un directorio en el que PowerEduc puede guardar los archivos subidos por usuarios.</p>
...
$string['pathssubdirroot'] = '<p>Ruta completa del directorio que contiene el código de  PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>Dirección web completa para acceder a PowerEduc, es decir, la dirección que los usuarios escribirán en la barra de búsqueda del navegador para acceder a PowerEduc.</p>
<p>No es posible acceder a PowerEduc utilizando múltiples direcciones. Si su portal tiene varias direcciones debe configurar la más sencilla y configurar un redireccionamiento permanente desde las otras.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc requiere una versión de PHP que sea al menos la 5.6.5 o 7.1 (7.0.x tiene algunas limitaciones del motor).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las
    aplicaciones necesarias para que <strong>PowerEduc</strong> funcione en su ordenador,
    principalmente:';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar y ajustar <strong>PowerEduc</strong> en su ordenador. Puede utilizar los valores por defecto sugeridos o, de forma opcional, modificarlos para que se ajusten a sus necesidades.';
