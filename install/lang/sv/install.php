...
$string['clialreadyconfigured'] = 'Filen <em>config.php</em> finns redan. Använd <code>admin/cli/install_database.php</code> för att installera PowerEduc på denna server.';
$string['clialreadyinstalled'] = 'Filen <code>config.php</code> finns redan. Vänligen använd <code>admin/cli/upgrade.php</code> om du vill uppgradera PowerEduc på den här webbplatsen.';
$string['cliinstallheader'] = 'Kommandoradsbaserat installationsprogram för PowerEduc {$a}';
...
$string['dirroot'] = 'PowerEduc-katalog';
$string['environmenthead'] = 'Kontrollerar miljön...';
$string['environmentsub2'] = 'Varje PowerEducversion har ett lägsta PHP-versionskrav samt krav på ett antal obligatoriska PHP-tillägg.
...
<p>Detta kan leda till att PowerEduc får minnesproblem senare, särskilt om du har många moduler aktiverade och/eller många användare.</p>
...
<li>Om du kan, kompilera om PHP med <code>--enable-memory-limit</code>.
    Detta gör det möjligt för PowerEduc att själv ställa in minnesgränsen.</li>
...
<li>På vissa PHP-servrar kan du skapa en HTACCESS-fil i PowerEduc-katalogen
...
kontrollpanel eller liknande. Tyvärr står detta i konflikt med standardplatsen för PowerEduc-administratörssidorna.  Du kan åtgärda detta genom att
byta namn på administratörskatalogen i installationen och ange det nya namnet här. Till exempel: <var>powereducadmin</var>. Detta kommer att korrigera administratörslänkarna i PowerEduc.';
$string['pathssubdataroot'] = '<p>En katalog där PowerEduc lagrar allt filinnehåll som laddas upp av användare.</p>
...
$string['pathssubdirroot'] = '<p>Fullständig sökväg till katalogen som innehåller PowerEduc-koden.</p>';
$string['pathssubwwwroot'] = '<p>Den fullständiga webadressen där PowerEduc finns, dvs. adressen som användarna kommer att ange i adressfältet i sin webbläsare för att komma åt PowerEduc.</p>
<p>Det går inte att komma åt PowerEduc med flera adresser. Om din webbplats är tillgänglig via flera adresser väljer du den enklaste och ställer in en permanent omdirigering för var och en av de andra adresserna.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc kräver minst PHP-version 5.6.5 eller 7.1 (7.0.x har vissa motorbegränsningar).</p>
...
$string['welcomep30'] = 'Den här versionen av <strong>{$a->installername}</strong> innehåller program för att skapa en miljö där <strong>PowerEduc</strong> kommer att fungera, nämligen:';
$string['welcomep40'] = 'I paketet ingår även <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Följande sidor leder dig genom några enkla steg för att konfigurera och installera <strong>PowerEduc</strong> på din dator. Du kan acceptera standardinställningarna eller, alternativt, modifiera dem för att passa dina egna behov.';
$string['welcomep70'] = 'Klicka på "Nästa" här nedan för att fortsätta installationen av <strong>PowerEduc</strong>.';
