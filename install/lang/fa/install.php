...
نام جدید در این قسمت برطرف نمائید. به‌عنوان مثال: <em>powereducadmin</em>. این کار پیوندهای مدیر در مودل را اصلاح خواهد کرد.';
...
$string['welcomep40'] = 'بستهٔ مورد نظر همچنین شامل <strong>مودل <span dir="ltr>{$a->powereducrelease}</span> )<span dir="ltr>{$a->powereducversion}</span>(</strong> است.';
