...
$string['dirroot'] = 'PowerEduc direktorijs';
...
<p>Sistēmā PowerEduc tas vēlāk var izraisīt atmiņas izmantošanas problēmas, it īpaši tad,
...
<li>Ja iespējams, atkārtoti kompilējiet PHP, izmantojot <i>--enable-memory-limit</i>.
    Šādā gadījumā sistēma PowerEduc atmiņas apjoma ierobežojumu varēs iestatīt automātiski.</li>
...
<li>Dažos PHP serveros PowerEduc direktorijā var izveidot failu .htaccess, kurā ir šāda rinda:    <p><blockquote>php_value memory_limit 40M</blockquote></p>
...
$string['phpversionhelp'] = '<p>Sistēmā PowerEduc jāizmanto PHP, kuras versija ir vismaz 4.3.0 vai 5.1.0 (versijai 5.0.x piemīt vairākas zināmas problēmas).</p>
...
$string['welcomep30'] = 'Šajā <strong>{$a->installername}</strong> laidienā ir iekļautas lietojumprogrammas,
    kas paredzētas, lai izveidotu vidi, kurā darbosies sistēma <strong>PowerEduc</strong>, proti:';
$string['welcomep40'] = 'Pakotnē ir iekļauta arī sistēma <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Nākamajās lapās tiks sniegti vienkārši norādījumi par to, kā
    datorā konfigurēt un iestatīt sistēmu <strong>PowerEduc</strong>. Varat akceptēt noklusējuma
    iestatījumus vai varat tos mainīt, lai pielāgotu savām vajadzībām.';
$string['welcomep70'] = 'Noklikšķiniet uz pogas Tālāk, lai turpinātu sistēmas <strong>PowerEduc</strong> instalēšanu.';
