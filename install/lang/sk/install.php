...
$string['clialreadyconfigured'] = 'Konfiguračný súbor config.php už existuje. Spusťte admin/cli/install_database.php, ak chcete inštalovať PowerEduc pre tento portál.';
...
$string['cliinstallheader'] = 'PowerEduc {$a} inštalačný program z príkazového riadku';
...
$string['dirroot'] = 'Adresár PowerEduc';
$string['environmenthead'] = 'Kontrola programového prostredia...';
$string['environmentsub2'] = 'Každé vydanie PowerEduc vyžaduje určitú minimálnu verziu PHP a niekoľko povinných rozšírení PHP. Plná kontrola prostredia sa vykonáva pred každou inštaláciou a aktualizáciou. Prosím, kontaktujte správcu servera, ak neviete, ako nainštalovať novú verziu, alebo povoliť rozšírenia PHP.';
...
<p>Toto môže neskôr spôsobiť problémy v PowerEduc, najmä ak máte veľa modulov a/alebo veľa používateľov.</p>
...
<ol>
<li>Ak je to možné, znovu vytvorte PHP s <i>--enable-memory-limit</i>. Toto umožní PowerEduc samonastavenie limitu pamäte.</li>
...
Na niektorých PHP serveroch, si môžete vytvoriť súbor .htaccess v Adresári PowerEduc, ktorý bude obsahovať tento riadok: <p><blockquote><div>php_value memory_limit 40M</div></blockquote></p>
...
$string['pathssubadmindir'] = 'Na niektorých serveroch je URL adresa /admin vyhradená pre špeciálne účely (napr. pre ovládací panel). Na takých serveroch môže dojsť ku kolízii so štandardným umiestnením stránok pre administratívu PowerEduc. Ak máte tento problém, premenujte adresár <em>admin</em> vo vašej inštalácii PowerEduc a sem zadajte jeho nový názov - napríklad <em>powereducadmin</em>. Všetky generované odkazy na stránky správy PowerEduc budú používať tento nový názov.';
$string['pathssubdataroot'] = '<p>Potrebujete adresár, kam PowerEduc bude ukladať nahrané súbory.</p>
...
$string['pathssubdirroot'] = '<p>Absolútna cesta adresára PowerEduc inštalácie.</p>';
$string['pathssubwwwroot'] = '<p>Zadajte úplnú webovú adresu, na ktorej bude PowerEduc dostupný, t.j. adresa, ktorú zadajú používatelia do adresného riadku svojho prehliadača, aby spustili PowerEduc.</p>
<p>PowerEduc potrebuje jedinečnú adresu, nie je možné ho prevádzkovať na niekoľkých URL súčasne. Ak používate niekoľko verejných domén, musíte si sami nastaviť permanentné presmerovanie na jednu z nich a tú potom použiť.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc si vyžaduje verziu PHP aspoň  5.6.5 alebo 7.1 (7.0.x má určité obmedzenia jadra).</p>
...
$string['welcomep30'] = 'Táto verzia <strong>{$a->installername}</strong> obsahuje aplikáciu k vytvoreniu prostredia, v ktorom bude prevádzkovaný váš <strong>PowerEduc</strong>. Menovite sa jedná o:';
$string['welcomep40'] = 'Balíček tiež obsahuje <strong>PowerEduc vo verzii {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Nasledujúce stránky vás povedú v nekoľkých jednoduchých krokoch nastavením <strong>PowerEduc</strong> na vašom počítači. Môžete prijať východzie nastavenie, alebo si ich upraviť podľa svojich potrieb.';
$string['welcomep70'] = 'Stlačením nižšie uvedeného tlačidla "Ďalší" pokračujte v nastavení vašej inštalácie PowerEduc.';
