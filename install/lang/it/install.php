...
$string['pathssubadmindir'] = 'Alcuni web host utilizzano la cartella /admin come URL di accesso a pannelli di controllo od altre funzioni particolari. Tuttavia questo nome coincide con il nome della cartella che Moodle utilizza per i propri file di amministrazione. Per evitare conflitti, è possibile specificare un nome alternativo per la cartella Admin di Moodle. Ad esempio:<p><b>powereducadmin</b></p>
...
$string['welcomep40'] = 'Il pacchetto include anche <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
