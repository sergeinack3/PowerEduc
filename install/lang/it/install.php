...
Utilizzare admin/cli/install_database.php per installare PowerEduc.';
$string['clialreadyinstalled'] = 'Il file config.php è già presente.
Utilizzare admin/cli/install_database.php per aggiornare PowerEduc.';
$string['cliinstallheader'] = 'Programma di installazione PowerEduc {$a} via linea di comando';
...
<p>Tale limite potrà causare problemi nel funzionamento di PowerEduc, specialmente se si utilizzano molti moduli di attività con molti utenti.</p>
...
Questo consentirà a PowerEduc di impostare in autonomia il limite di memoria.</li>
...
<li>Su alcuni server con il PHP è possibile creare un file .htaccess nella cartella di PowerEduc contenente questa linea:
...
$string['pathssubadmindir'] = 'Alcuni web host utilizzano la cartella /admin come URL di accesso a pannelli di controllo od altre funzioni particolari. Tuttavia questo nome coincide con il nome della cartella che PowerEduc utilizza per i propri file di amministrazione. Per evitare conflitti, è possibile specificare un nome alternativo per la cartella Admin di PowerEduc. Ad esempio:<p><b>powereducadmin</b></p>
Tutti i link che puntano ai file di amministrazione di PowerEduc terranno conto di questa variazione.';
$string['pathssubdataroot'] = '<p>La cartella dove PowerEduc memorizzerà i file caricati dagli utenti.</p>
...
$string['pathssubdirroot'] = '<p>Percorso assoluto della cartella dove si trova il codice di PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>L\'indirizzo web per raggiungere a PowerEduc, in altre parole l\'indirizzo che gli utenti inseriranno nella barra degli indirizzi del proprio browser per accedere a questa installazione.</p>
<p>Non è possibile accedere alla stessa installazione PowerEduc usando più di un indirizzo web. Se il tuo sito usa più indirizzi web, devi configurare dei re-indirizzamenti permanenti per tutti gli altri indirizzi web.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc necessita come minimo della versione 5.6.5 o 7.1del PHP. (La versione 7.0.x ha alcuni limiti nel motore)</p>
...
$string['welcomep30'] = 'La release di <strong>{$a->installername}</strong> include l\'applicazione per creare l\'ambiente necessario a far girare <strong>PowerEduc</strong>:';
$string['welcomep40'] = 'Il pacchetto include anche <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Le prossime pagine ti guideranno attraverso semplici passi per installare e configurare <strong>PowerEduc</strong> nel tuo computer. Puoi utilizzare le impostazioni di default oppure modificarle per adeguarle alle tue esigenze.';
$string['welcomep70'] = 'Fai click sul pulsante "Avanti" per continuare l\'installazione di <strong>PowerEduc</strong>.';
