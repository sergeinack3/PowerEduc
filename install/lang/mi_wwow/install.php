...
$string['dirroot'] = 'Whaiaronga PowerEduc';
...
$string['memorylimithelp'] = '<p>I tēnei wā ko te tepe pūmahara PHP mō tō tūmau ko te {$a}.</p><p>Mā tēnei pea ka raru ai te pūmahara o PowerEduc, inā ki te maha ake ngā kōwae e hohe ana, ngā kaiwhakamahi hoki/rānei.</p> <p>Ko tāku ki a koe, me whirihora te PHP ki te tepe teitei ake mēnā e taea ana, pēnei ake i te 40M. Arā atu ngā huarahi hei whakatutuki i tēnei:</p><ol><li>Mēnā ka taea, whakahiato anōtia te PHP ki te <i>--enable-memory-limit</i>. Mā tēnei ka taea e PowerEduc te tepe pūmahara te whakarite.</li><li>Mēnā he āheitanga tāu ki tō kōnae php.ini, ka taea te tautuhinga <b>memory_limit</b> te huri kia āhua 40M. Ki te kore ō āheitanga, pātaihia tō kaiwhakahaere, māna tērā āheitanga e hoatu ki a koe.</li><li>I runga i ētahi tūmau PHP ka taea te waihanga kōnae .htaccess ki roto i te whaiaronga PowerEduc e pupuru ana i tēnei rārangi: <p><blockquote>php_value memory_limit 40M</blockquote></p> <p>Heoi, i runga i ētahi tūmau ka kaupare pea te mahinga o ngā whārangi PHP <b>katoa</b> (ka kitea ngā hapa inā tirohia ngā whārangi) nō reira, me tango te kōnae .htaccess.</p></li></ol>';
$string['phpversion'] = 'Putanga PHP';
$string['phpversionhelp'] = '<p>E hiahiatia ana e PowerEduc kia  4.1.0 neke atu rānei te putanga PHP.</p><p>I tēnei wā kei te whakahaere koe i te putanga {$a}</p><p>Me whakahōu te PHP, nuku rānei ki tētahi kaihautū me te putanga hōu PHP hōu ake!</p>';
...
$string['welcomep30'] = 'Kei roto hoki i tēnei <strong>{$a->installername}</strong> he taupānga hei hanga i tētahi taiao whakahaere tino pai mō <strong>PowerEduc</strong>, arā ko';
$string['welcomep40'] = 'Kei roto hoki i tēnei pōkai he <strong>PowerEduc {$a->powereducrelease}({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Mā ngā whārangi e whai mai nei ka arataki i a koe ki te whirihora me te whakarite i a <strong>PowerEduc</strong> i runga i tō rorohiko.';
$string['welcomep70'] = 'Pāwhiritia te pātene "Panuku" kia whakarite tonu ai i a <strong>PowerEduc</strong>.';
