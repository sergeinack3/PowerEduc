...
$string['pathssubadmindir'] = '간혹 어떤 웹호스트 업체는 제어판 등을 제공하는 특별한 URL으로서 /admin을 사용합니다. 불행하게도 이것은 무들 관리페이지를 위한 표준 위치와 충돌을 일으킵니다. 설치과정에서 관리 디렉토리의 이름을 바꿈으로서 이 문제를 고칠수 있는 데, 다음의 예와 같이 새이름을 여기에 넣으면 됩니다. 예: <em>powereducadmin</em> 이렇게 하면 무들에서 관리자 링크문제가 해결됩니다.';
...
$string['welcomep40'] = '이 패키지는 <strong>무들 {$a->powereducrelease} ({$a->powereducversion})</strong> 을 포함하고 있습니다.';
