...
renaming the admin directory in your installation, and putting that  new name here.  For example: <em>powereducadmin</em>. This will fix admin links in Moodle.';
...
$string['welcomep40'] = 'The package also includes <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
