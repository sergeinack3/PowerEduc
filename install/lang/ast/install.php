...
$string['dirroot'] = 'Direutoriu PowerEduc';
...
<p>Esto va facer que PowerEduc tenga problemes de memoria más tarde, especialmente si tien munchos módulos y/o munchos usuarios.</p>
...
<li>Si pue, recompile PHP con <i>--enable-memory-limit</i>.
   Esto va permitir que\'l propiu PowerEduc modifique la llende de memoria.</li>
...
<li>En dellos servidores PHP pue crear un ficheru .htaccess nel direutoriu PowerEduc cola ringlera que vien darréu:
...
$string['phpversionhelp'] = '<p>PowerEduc necesita una versión de PHP de 4.3.0 como mínimo o 5.1.0 (5.0.x tien problemes conocíos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> inclúi les aplicaciones pa crear l\'ámbitu nel que <strong>PowerEduc</strong> pue funcionar, llamaes:';
$string['welcomep40'] = 'El paquete tamién inclúi <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Les páxines siguientes van llevalu per dellos pasos fáciles de siguir pa configurar <strong>PowerEduc</strong> nel ordenador. Pue aceptar la configuración por defeutu o, opcionalmente, usar otres más adaptaes a les sos necesidaes.';
$string['welcomep70'] = 'Calque\'l botón "Siguiente" qu\'hai embaxo pa siguir cola configuración de <strong>PowerEduc</strong>.';
