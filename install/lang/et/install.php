...
$string['chooselanguagesub'] = 'Valige PowerEduc’i keel. Valitud keelt kasutatakse õpikeskkonna vaikekeelena ja seda saab hiljem muuta.';
$string['clialreadyconfigured'] = 'Fail „config.php“ on juba olemas. Kasutage sellele saidile PowerEduc’i installimiseks faili „admin/cli/install_database.php“.';
$string['clialreadyinstalled'] = 'Konfiguratsioonifail config.php on juba olemas. Palun kasutage PowerEduc’i selles õpikeskkonnas uuendamiseks faili admin/cli/install_database.php.';
$string['cliinstallheader'] = 'PowerEduc’i {$a} käsureapõhine installiprogramm';
...
$string['dirroot'] = 'PowerEduc’i kataloog';
$string['environmenthead'] = 'Keskkonna kontrollimine...';
$string['environmentsub2'] = 'Igal PowerEduc’i väljaandel on oma minimaalne PHP versiooni nõue ja kohustuslikud PHP- laiendused.
...
<p>See võib hiljem tekitada PowerEduc’il mäluprobleeme,
...
<li>Kui võimalik, siis kompileerige PHP uuesti parameetriga <i>--enable-memory-limit</i>.
    See lubab PowerEduc’il ise mälulimiidi määrata.</li>
...
<li>Mõnes PHP-serveris saab luua PowerEduc’i kataloogi faili .htaccess,
...
$string['pathssubadmindir'] = 'Väga vähestes veebihostides on juhtpaneelile vm juurdepääsuks spetsiaalse URL-ina kasutusel „/admin“. Kahjuks ei vasta see PowerEduc’i administreerimislehtede tavaasukohale. Saate olukorda parandada, kui nimetate kataloogi admin oma installis ümber ja sisestate uue nime siin. Näiteks: <em>powereducadmin</em>. See parandab PowerEduc’is olevad administreerimisliidese lingid.';
$string['pathssubdataroot'] = '<p>Kataloog, kuhu PowerEduc salvestab kõigi kasutajate üleslaaditud failide sisu.</p>
...
$string['pathssubdirroot'] = '<p>PowerEduc’i koodi sisaldava kataloogi täielik tee.</p>';
$string['pathssubwwwroot'] = '<p>Täielik veebiaadress, kustkaudu PowerEduc’ile juurde pääsetakse, s.t see aadress, mille kasutajad PowerEduc’ile juurdepääsemiseks oma brauseri aadressiribale sisestavad.</p>
<p>PowerEduc’ile poole võimalik juurde pääseda mitme aadressi kaudu. Kui teie õpikeskkond on juurdepääsetav mitme aadressi kaudu, valige neist lihtsaim ja määrake kõigilt teistelt aadressidelt püsiv ümbersuunamine.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc vajab vähemalt PHP versiooni 5.6.5 või 7.1 (versioonil 7.0.x on mõned mootoripiirangud).</p>
...
$string['welcomep30'] = 'See <strong>{$a->installername}</strong> väljaanne hõlmab rakendusi, mille abil
    saab luua <strong>PowerEduc’i</strong> toimimiseks vajaliku keskkonna, nt:';
$string['welcomep40'] = 'Pakett sisaldab ka järgmist: <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Järgmistel lehtedel toodud lihtsate juhiste abil saate konfigureerida ja
    häälestada <strong>PowerEduc</strong>’i oma arvutis. Võite nõustuda
    vaikesätetega või muuta sätteid oma vajaduste järgi.';
$string['welcomep70'] = '<strong>PowerEduc’i</strong> installi jätkamiseks klõpsake nuppu Edasi.';
