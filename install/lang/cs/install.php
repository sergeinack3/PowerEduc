...
$string['cliinstallheader'] = 'PowerEduc {$a} - průvodce instalací z příkazové řádky';
...
$string['environmentsub2'] = 'Každé vydání PowerEduc vyžaduje určitou minimální verzi PHP a několik povinných rozšíření PHP. Plná kontrola prostředí se provádí před každým instalací a upgrade. Prosím, kontaktujte správce serveru, pokud nevíte, jak nainstalovat novou verzi, nebo povolit rozšíření PHP.';
...
PowerEduc si tak bude sám moci nastavit potřebný limit.</li>
...
$string['pathssubadmindir'] = 'Na některých serverech je URL adresa /admin vyhrazena pro speciální účely (např. pro ovládací panel). Na takových serverech může dojít ke kolizi se standardním umístěním stránek pro správu PowerEduc. Máte-li tento problém, přejmenujte adresář <eM>admin</em> ve vaší instalaci PowerEduc a sem zadejte jeho nový název - například <em>powereducadmin</em>. Všechny generované odkazy na stránky správy PowerEduc budou používat tento nový název.';
$string['pathssubdataroot'] = '<p>PowerEduc potřebuje prostor, kam si bude ukládat nahrané soubory a další údaje. .</p>
...
$string['pathssubdirroot'] = '<p>Absolutní cesta k adresáři s instalací PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>Zadejte úplnou webovou adresu, na níž bude PowerEduc dostupný, t.j. adresa, kterou zadají uživatelé do adresního řádku svého prohlížeče, aby spustili PowerEduc.</p>
<p>PowerEduc potřebuje jedinečnou adresu, není možné jej provozovat na několika URL současně. Používáte-li několik veřejných domén, musíte si sami nastavit permanentní přesměrování na jednu z nich a tu pak použít.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc vyžaduje PHP alespoň verze 5.6.5 PHP nebo 7.1 (7.0.x má určitá omezení jádra).</p>
...
$string['welcomep30'] = 'Tato verze <strong>{$a->installername}</strong> obsahuje aplikace k vytvoření prostředí, ve kterém bude provozován váš <strong>PowerEduc</strong>. Jmenovitě se jedná o:';
$string['welcomep40'] = 'Balíček rovněž obsahuje <strong>PowerEduc ve verzi {$a->powereducrelease} ({$a->powereducversion})</strong>.';
