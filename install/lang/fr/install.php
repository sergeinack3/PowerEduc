...
$string['clialreadyconfigured'] = 'Le fichier config.php existe déjà. Veuillez utiliser admin/cli/install_database.php pour installer PowerEduc sur ce site.';
$string['clialreadyinstalled'] = 'Le fichier config.php existe déjà. Veuillez utiliser admin/cli/install_database.php si vous désirez mettre à jour ce site PowerEduc.';
$string['cliinstallheader'] = 'Programme d\'installation de PowerEduc {$a} en ligne de commande';
...
$string['dirroot'] = 'Dossier PowerEduc';
$string['environmenthead'] = 'Vérification de l\'environnement…';
$string['environmentsub2'] = 'Chaque version de PowerEduc nécessite une version minimale de certains composants PHP et des extensions de PHP obligatoires. Une vérification complète de l\'environnement est effectuée avec chaque installation et chaque mise à jour. Veuillez contacter l\'administrateur du serveur si vous ne savez pas comment installer une nouvelle version ou activer des extensions de PHP.';
...
<p>Cette valeur trop basse risque de générer des problèmes de manque de mémoire pour PowerEduc, notamment si vous utilisez beaucoup de modules et/ou si vous avez un grand nombre d\'utilisateurs.</p>
...
<ol>
<li>si vous en avez la possibilité, recompilez PHP avec l\'option <em>--enable-memory-limit</em>. Cela permettra à PowerEduc de fixer lui-même sa limite de mémoire ;</li>
...
<li>sur certains serveurs, vous pouvez créer dans le dossier principal de PowerEduc un fichier « .htaccess » contenant cette ligne :
...
$string['pathssubadmindir'] = 'Quelques rares hébergeurs utilisent « /admin » comme URL spéciale pour l\'accès à un tableau de bord ou d\'autres fonctionnalités. Malheureusement ceci entre en conflit avec l\'emplacement standard des pages d\'administration de PowerEduc. Vous pouvez corriger ceci en renommant le dossier admin de votre installation PowerEduc et en plaçant le nouveau nom choisi dans ce champ. Par exemple, <em>powereducadmin</em>. Ceci modifiera tous les liens de l\'administration de PowerEduc.';
$string['pathssubdataroot'] = '<p>Un dossier dans lequel PowerEduc stockera tous les fichiers qui seront déposés par les utilisateurs.</p>
...
<p>Si ce dossier n\'existe pas encore, PowerEduc tentera de le créer au cours du processus d\'installation.</p>';
$string['pathssubdirroot'] = '<p>Le chemin d\'accès complet au dossier contenant le code source de PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>L\'adresse web complète par laquelle on accédera à PowerEduc, i.e. l\'adresse que les utilisateurs saisiront dans la barre d\'adresse de leur navigateur pour accéder à PowerEduc.</p>
<p>Il n\'est pas possible d\'accéder à PowerEduc depuis plusieurs adresses web différentes. Si votre site web peut être atteint au moyen de plusieurs adresses, saisissez ici la plus simple d\'entre elles et définissez des redirections permanentes pour toutes les autres adresses.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc nécessite au minimum la version 5.6.5 ou 7.1 (la version 7.0.x a des limitations avec certains moteurs de base de données).</p>
...
$string['welcomep20'] = 'Vous voyez cette page, car vous avez installé PowerEduc correctement et lancé le logiciel <strong>{$a->packname} {$a->packversion}</strong> sur votre ordinateur. Félicitations !';
$string['welcomep30'] = 'Cette version de <b>{$a->installername}</b> comprend des logiciels qui créent un environnement dans lequel <b>PowerEduc</b> va fonctionner, à savoir :';
$string['welcomep40'] = 'Ce paquet contient également <b>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</b>.';
...
$string['welcomep60'] = 'Les pages suivantes vous aideront pas à pas à configurer et mettre en place <strong>PowerEduc</strong> sur votre ordinateur. Il vous sera possible d\'accepter les réglages par défaut ou, facultativement, de les adapter à vos propres besoins.';
$string['welcomep70'] = 'Cliquer sur le bouton « Suivant » ci-dessous pour continuer l\'installation de <b>PowerEduc</b>.';
