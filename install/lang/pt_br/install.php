...
$string['clialreadyconfigured'] = 'Arquivo config.php já existe. Por favor, use admin/cli/install_database.php para instalar o PowerEduc neste site.';
$string['clialreadyinstalled'] = 'Arquivo config.php já existe. Por favor use admin/cli/install_database.php para atualizar o PowerEduc neste site.';
$string['cliinstallheader'] = 'Programa de instalação por linha de comando do PowerEduc {$a}';
...
$string['dirroot'] = 'Diretório PowerEduc';
$string['environmenthead'] = 'Verificando o ambiente ...';
$string['environmentsub2'] = 'Cada release do PowerEduc requer uma versão mínima do PHP e diversas extensões do PHP.
...
<p>Este limite pode causar problemas com o PowerEduc no futuro, especialmente quando muitos módulos estiverem ativados ou em caso de um número elevado de usuários.</p>
...
Com esta operação PowerEduc será capaz de configurar o seu limite de memória sózinho.</li>
...
<li>Em alguns servidores é possível fazer esta mudança criando um arquivo .htaccess no diretório PowerEduc. O arquivo deve conter a seguinte expressão:
...
$string['pathssubadmindir'] = 'Alguns poucos webhosts usam /admin como um URL especial para acesso ao painel de controle ou outras coisas. Infelizmente isto conflita com a localizaçao padrão das páginas do administrador PowerEduc. Você pode corrigir isso renomeando a pasta admin na sua instalação, e colocando esse novo nome aqui. Por exemplo: <em>powereducadmin</em>. Isto irá corrigir os links das páginas do administrador PowerEduc.';
$string['pathssubdataroot'] = '<p>Um diretório em que PowerEduc armazenará todo o conteúdo de arquivos enviados pelos usuários. </p>
...
$string['pathssubwwwroot'] = '<p>O endereço completo em que PowerEduc pode ser acessado ou seja, o endereço que os usuários vão digitar na barra de endereços do seu navegador para acessar PowerEduc. </p>
<p>Não é possível acessar PowerEduc usando múltiplos endereços. Se o seu site é acessível através de múltiplos endereços, em seguida, escolher o mais fácil e configurar um redirecionamento permanente para cada um dos outros endereços. </p>
...
$string['phpversionhelp'] = '<p>O PowerEduc requer uma versão PHP de pelo menos 5.6.5 ou 7.1 (o 7.0.x tem algumas limitações do mecanismo).</p>
...
$string['welcomep30'] = 'Esta versão do <strong>{$a->installername}</strong> inclui as aplicações para a criação de um ambiente em que o <strong>PowerEduc</strong> possa operar:';
$string['welcomep40'] = 'O pacote inclui também o <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'As seguinte páginas guiam passo a passo a configuração de <strong>PowerEduc</strong> no seu computador. Você pode usar a configuração padrão ou alterá-las de acordo com as suas necessidades.';
$string['welcomep70'] = 'Clique no botão "Próximo" abaixo para continuar a configuração do <strong>PowerEduc</strong>.';
