...
$string['cliinstallheader'] = 'PowerEduc {$a} командний рядок програми установки';
...
$string['dirroot'] = 'PowerEduc Каталог';
$string['environmenthead'] = 'Перевірка залежностей...';
$string['environmentsub2'] = 'Кожен PowerEduc реліз вимагає деяку мінімальну версію РНР та специфічний набір додаткових розширень. Повна перевірка проводиться до початку встановлення або оновлення. Будь ласка, зв’яжіться з вашим адміністратором, якщо ви не знаєте, як встановити нову версію або налаштувати РНР.';
...
$string['memorylimithelp'] = '<p>Обмеження пам\'яті в PHP на сервері зараз встановлено в {$a}.</p> <p>Це може стати проблемою при подальшій роботі PowerEduc, коли ви будете мати багато курсів, модулів та користувачів.</p> <p>Ми рекомендуємо сконфігурувати РНР на обмеження пам\'яті не менше 16 Мб. Це можна зробити шляхом:</p> <ol> <li>перекомпіляції PHP з параметром <i>--enable-memory-limit</i>. Це надасть можливість PowerEduc встановити обмеження пам\'яті самостійно.</li> <li>встановлення в php.ini змінної <b>memory_limit</b> порядка 16Mб. Якщо ви не маєте доступу до цього файлу попросіть адміністратора зробити це для вас.</li> <li>створення в корні сайту файлу .htaccess, куди добавити наступний рядок: <p><blockquote>php_value memory_limit 16M</blockquote></p> <p>Але на деяких серверах це призведе до помилок на <b>всіх</b> сторінках, тоді вам потрібно видалити .htaccess.</p></li> </ol>';
$string['paths'] = 'Шляхи';
...
$string['pathssubadmindir'] = 'Дуже мало web хостингів використовують /admin в якості спеціальної адреси для доступу до адміністративного управління. На жаль, це суперечить стандартному розташуванню сторінок адміністрування для PowerEduc. Ви можете виправити це перейменуванням каталогу admin в будь-яке інше ім’я та вписати його тут. Наприклад: <em>powereducadmin</em>. Це виправить посилання на адміністрування в PowerEduc.';
$string['pathssubdataroot'] = '<p>Каталог, де PowerEduc буде зберігати всі файли, які завантажують користувачі.</p>
...
$string['pathssubdirroot'] = '<p>Повний шлях до каталогу встановлення powereduc.</p>';
$string['pathssubwwwroot'] = '<p>Повна веб-адреса, за якою ваш сайт powereduc буде доступним. PowerEduc може мати тільки одну адресу доступу. </p>
...
$string['phpversionhelp'] = '<p>PowerEduc потребує версії PHP принаймні 5.6.5 або 7.1 (7.0.x має деякі обмеження двигуна). </p>
...
$string['welcomep30'] = 'Цей випуск <strong>{$a->installername}</strong> включає в себе програми для створення середовища, в якому <strong>PowerEduc</strong> працюватиме, а саме:';
$string['welcomep40'] = 'Цей пакет також включає <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Наступні сторінки будуть проводити вас через процедуру встановлення та налаштування <strong>PowerEduc</strong> на вашому комп’ютері. Ви можете прийняти автоматичне налаштування, а потім змінити параметри під себе.';
$string['welcomep70'] = 'Натисніть кнопку "Далі" для продовження встановлення <strong>PowerEduc</strong>.';
