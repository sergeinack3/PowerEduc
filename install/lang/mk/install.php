...
$string['clialreadyconfigured'] = 'Конфигурациската датотека config.php веќе постои. Ве молиме користете ја admin/cli/install_database.php за да го инсталирате PowerEduc на овој сајт.';
$string['clialreadyinstalled'] = 'Конфигурациската датотека config.php веќе постои. Ве молиме користете ја admin/cli/install_database.php за да го надградите PowerEduc за овој сајт.';
$string['cliinstallheader'] = 'Програма за инсталирање на PowerEduc {$a} командна линија';
...
$string['dirroot'] = 'PowerEduc директориум';
...
<li>Ако сте способен, повторно компајлирајте PHP со<i>--enable-memory-limit</i>.
    Ова ќе овозможи на PowerEduc сам да го постави прагот на меморијата. </li>
...
<li>На некои PHP сервери, можете да креирате датотека .htaccess во директориумот на PowerEduc,
...
$string['welcomep30'] = 'Оваа верзија на <strong>{$a->installername}</strong> вклучува апликации за креирање околина во која <strong>PowerEduc</strong> ќе работи:';
$string['welcomep40'] = 'Овој пакет исто така вклучува <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Следните страници ќе Ве водат низ неколку лесни чекори за поставување на <strong>PowerEduc</strong> на Вашиот компјутер. Може да ги прифатите стандардните поставувања, или да ги промените за Ваши потреби.';
$string['welcomep70'] = 'Кликнете на копчето „Следно“ за да продолжите со поставување на <strong>PowerEduc</strong>.';
