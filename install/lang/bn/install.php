...
নাম পরিবর্তন করে নতুন নাম দিয়ে এ সমস্যার সমাধান করতে পারেন। যেমন: <em>powereducadmin</em>। এর ফলে মডুলে অ্যাডমিনে লিঙ্কগুলো নির্ধারণ করে দিবে।';
...
$string['welcomep40'] = 'প্যাকেজে <strong>মুডল {$a->powereducrelease} ({$a->powereducversion})</strong> ও থাকে।';
