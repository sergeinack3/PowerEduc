...
$string['clialreadyconfigured'] = 'Konfiguracijska datoteka config.php že obstaja. Uporabite admin/cli/install_database.php, če želite namestiti PowerEduc na to spletno mesto.';
...
$string['cliinstallheader'] = 'PowerEduc {$a} namestitveni program z ukazno vrstico';
...
$string['dirroot'] = 'PowerEduc imenik';
$string['environmenthead'] = 'Preverjanje vašega okolja ...';
$string['environmentsub2'] = 'Vsaka PowerEduc različica ima nekatere minimalne PHP zahteve in številne obvezne PHP razširitve.
...
<p>To lahko povzroči, da bo imel PowerEduc pozneje težave s pomnilnikom. Še posebej,
...
<li>Če lahko, ponovno prevedite PHP z <i>--enable-memory-limit</i>.
    To bo omogočilo, da bo PowerEduc sam nastavil omejitev pomnilnik zase.</li>
...
<li>Na nekaterih strežnikih PHP lahko ustvarite datoteko .htaccess v imeniku PowerEduc,
...
$string['pathssubdirroot'] = '<p>Polna pot do imenika s kodo PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>Polni spletni naslov na katerem bo PowerEduc dostopen. To je naslov, ki ga bodo uporabniki, za dostop do Moodla, vnesli v naslovno vrstico brskalnika.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc zahteva različico PHP vsaj 5.6.5 ali 7.1 (7.0.x ima vrsto mehanskih težav).</p>
...
$string['welcomep30'] = 'Ta različica <strong>{$a->installername}</strong> vključuje aplikacije
    za ustvarjanje okolja v katerem bo deloval <strong>PowerEduc</strong> in sicer:';
$string['welcomep40'] = 'Ta paket vključuje tudi <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Naslednje strani vas bodo popeljale skozi nekaj enostavno sledljivih korakov za
    konfiguracijo in nastavitev <strong>PowerEduc</strong>  na vašem računalniku. Sprejmete lahko privzete
    nastavitve ali jih, če tako želite, spremenite, da bodo ustrezale vašim potrebam.';
$string['welcomep70'] = 'Kliknite spodnji gumb "Naprej" za nadaljevanje nastavitve <strong>PowerEduc</strong>.';
