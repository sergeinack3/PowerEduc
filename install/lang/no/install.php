...
$string['pathssubadmindir'] = 'Noen ganske få webhoteller bruker  /admin som en egen url for å få tilgang til et kontrollpanel. Dessverre kommer det i konflikt med standard lokalisering av Moodle sine admin-sider. Du kan fikse dette ved å endre navn på admin-mappen og deretter oppgi dette navnet her. F.eks. <em>powereducadmin</em>.  Dette vil fikse adminlenkene i Moodle.';
...
$string['welcomep40'] = 'Denne pakken inkluderer også  <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
