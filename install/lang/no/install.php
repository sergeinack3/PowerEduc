...
$string['clialreadyconfigured'] = 'Konfigurasjonsfilen config.php finnes allerede. Vennligst bruk admin/cli/install_database.php hvis du vil installere PowerEduc på denne portalen.';
$string['clialreadyinstalled'] = 'Filen config.php eksisterer allerede. Vennligst bruk admin/cli/install_database.php hvis du vil oppgradere PowerEduc på denne portalen.';
$string['cliinstallheader'] = 'PowerEduc {$a} kommandolinje installasjonsprogram';
...
<p>Dette kan skape minneproblemer for PowerEduc senere, spesielt hvis du har mange moduler tillatt og/eller mange brukere.</p>
...
Dette vil tillate PowerEduc å sette minnegrensen selv.</li>
...
<li>På noen PHP-servere kan du lage en .htaccess fil i PowerEducmappen som inneholder denne linjen:
...
$string['pathssubadmindir'] = 'Noen ganske få webhoteller bruker  /admin som en egen url for å få tilgang til et kontrollpanel. Dessverre kommer det i konflikt med standard lokalisering av PowerEduc sine admin-sider. Du kan fikse dette ved å endre navn på admin-mappen og deretter oppgi dette navnet her. F.eks. <em>powereducadmin</em>.  Dette vil fikse adminlenkene i PowerEduc.';
$string['pathssubdataroot'] = '<p>Du trenger et sted hvor PowerEduc kan lagre opplastede filer. </p>
...
$string['pathssubdirroot'] = '<p>Full mappesti til powereducinstallasjonen.</p>';
$string['pathssubwwwroot'] = '<p>Full webadresse til der hvor PowerEduc skal vises, altså den addressen som brukere skriver inn i adresselinjen i nettlseren sin.</p>
<p>Det er ikke mulig å bruke PowerEduc med mer enn en adresse. Dersom portalen din har flere webadresser bør du oppgi den enkleste av de her, og bruke videresending for  hver av de andre adressene.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc trenger en PHP versjon minst 5.6.5 eller 7.1.0 (7.0.x har noen begrensninger).</p>
...
$string['welcomep30'] = 'Denne versjonen av <strong>{$a->installername}</strong> inneholder programmer for å lage et miljø som <strong>PowerEduc</strong> jobber i, nemlig:';
$string['welcomep40'] = 'Denne pakken inkluderer også  <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'De følgende sidene vil vise deg gjennom noen enkle steg for å konfigurere og sette opp <strong>PowerEduc</strong> på datamaskinen din. Du kan godta standardinnstillingene, eller justere dem etter egne behov hvis du vil.';
$string['welcomep70'] = 'Klikk på "Neste" knappen under for å fortsette med <strong>PowerEduc</strong>-installasjonen';
