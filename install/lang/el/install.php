...
$string['welcomep40'] = 'Το πακέτο περιλαμβάνει επίσης το <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
