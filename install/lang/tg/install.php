...
$string['cliinstallheader'] = 'Барномаи ҷойгиркунии PowerEduc {$a} дар реҷаи сатри фармонҳо';
...
$string['dirroot'] = 'феҳристи PowerEduc';
$string['environmenthead'] = 'Тафтиши муҳит...';
$string['environmentsub2'] = 'Ҳар як версияи PowerEduc талаботҳои минималӣ ба версияи PHP ва маҷмӯи васеъшавиҳои ҳатмии PHP-ро дорад.
...
<p>Аз ин сабаб баъди муддате дар PowerEduc мушкилоти хотира пайдо шуда метавонанд, хусусан агар Шумо бисёр модулҳо ва/ё истифодабарандаҳо дошта бошед.</p>
...
Дар ин маврид PowerEduc метавонад мустақилона маҳдудкунии хотираро муқаррар намояд.</li>
...
<li>Дар баъзе серверҳои PHP дар феҳристи PowerEduc файли .htaccess бунёд кардан мумкин аст, ки сатри зеринро дорад:
...
$string['pathssubadmindir'] = 'Дар миқдори ками веб-ҳостингҳо роҳи /admin барои дастрасӣ ба ба панели идоракунӣ ё ягон чизи дигар истифода мешавад. Мутаассифона, ин ба ҷойгиршавии стандартии саҳифаҳои идоракунии PowerEduc мухолифат дорад. Инро бо аз нав номгузорӣ кардани папкаи "admin" дар феҳристи PowerEduc ва дар ин ҷо зикр намудани номи нави он ислоҳ кардан мумкин аст. Масалан: <em>powereducadmin</em>. Дар айни ҳол ҳамаи истинодҳо ба панели идоракунии PowerEduc автоматӣ ислоҳ мешаванд';
$string['pathssubdataroot'] = 'Ҷоеро зикр намудан даркор аст, ки PowerEduc файлҳои боршавандаро нигаҳдорӣ хоҳад кард. Ин феҳрист бояд барои хондан ва  САБТ НАМУДАНИ истифодабаранда, ки веб-сервер аз номи ӯ ба кор андохта шудааст, дастрас бошад (одатан \'nobody\' ё \'apache\'), аммо дар айни ҳол он набояд бевосита аз Интернет дастрас бошад. Барномаи ҷойгиркунӣ кӯшиш мекунад, ки ин феҳристро бунёд кунад, агар он вуҷуд надошта бошад.';
$string['pathssubdirroot'] = 'Роҳи пурра ба феҳристи ҷойгиркунии PowerEduc.';
$string['pathssubwwwroot'] = 'Веб-адреси пурра, ки аз он PowerEduc дастрас хоҳад буд.
Барои дастрасӣ ба PowerEduc якчанд адресҳои умумиро истифода бурдан ғайриимкон аст.
...
$string['phpversionhelp'] = '<p>Барои PowerEduc  PHP-и версияи 4.3.0 ва болотар ё 5.1.0 ва болотар даркор аст (баъзе мушкилот бо версияи 5.0.x маълуманд).</p>
...
$string['welcomep30'] = 'Ин версияи маҷмӯи барномаҳо <strong>{$a->installername}</strong> барномаҳои зеринро дар бар мегирад, ки барои бунёд кардани муҳите ки дар он <strong>PowerEduc</strong> кор хоҳад кард, даркоранд:';
$string['welcomep40'] = 'Ҳамчунин ба ин маҷмӯъ <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong> дохил мешавад.';
...
$string['welcomep60'] = 'Дар саҳифаҳои минбаъда Шумо якчанд қадамҳои оддии ба компютери худ танзим ва ҷойгир кардани <strong>PowerEduc</strong> -ро дида метавонед. Шумо метавонед танзимҳоро аз рӯи хомӯшӣ қабул намоед ё онҳоро вобаста ба эҳтиёҷоти худ тағйир диҳед.';
$string['welcomep70'] = 'Тугмаи "Давомаш"-ро зер кунед, то ки раванди ҷойгиркунии <strong>PowerEduc</strong>-ро давом диҳед';
