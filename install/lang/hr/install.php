...
$string['cliinstallheader'] = 'PowerEduc {$a} program za instalaciju iz naredbenog retka';
...
$string['dirroot'] = 'PowerEduc mapa';
$string['environmenthead'] = 'Provjera okruženja vašeg poslužitelja ...';
$string['environmentsub2'] = 'Svaka inačica PowerEduc-a ima minimalne zahtjeve po pitanju odgovarajuće PHP inačice i nekoliko obvezatnih PHP ekstenzija.
...
<p>Ova postavka može kasnije rezultirati memorijskim problemima na vašem PowerEduc sustavu, posebno ako imate veći broj omogućenih modula i/ili veći broj korisnika.</p>
...
<ol>
<li>Ako možete, rekompajlirajte PHP s <i>--enable-memory-limit</i>. Ovo će dopustiti PowerEduc sustavu samostalno postavljanje memorijskog ograničenja.</li>
...
<li>Na nekim PHP poslužiteljima možete napraviti .htaccess datoteku u PowerEduc mapi koja sadrži red: <p><blockquote>php_value memory_limit 40M</blockquote></p>
...
$string['pathssubadmindir'] = 'Manji broj webhosting tvrtki koristi /admin kao posebni URL za Vaš pristup upravljanju vašim hosting paketom. Nažalost, to rezultira konfliktom sa standardnom lokacijom za PowerEduc administratorsku stranicu. Navedenu lokaciju unutar PowerEduc sustava možete preimenovati. Na primjer: <br /> <br /><em>powereducadmin</em><br /> <br />
Ovo će promijeniti administratorsku poveznicu na PowerEduc sustavu u novu vrijednost.';
$string['pathssubdataroot'] = 'Mora postojati mapa u koju PowerEduc može pohraniti prenešene datoteke. Korisnik pod kojim je pokrenut web server (obično \'nobody\' ili \'apache\') bi morao imati mogućnost čitanja/pisanja podataka u toj mapi, ali oni ne bi trebali biti dostupni direktno preko weba. Instalacijska skripta će pokušati stvoriti navedenu mapu ako ista ne postoji.';
$string['pathssubdirroot'] = '<p>Puna putanja (PATH) do PowerEduc instalacije.</p>';
$string['pathssubwwwroot'] = 'Unesite punu web adresu putem koje će se pristupati vašem PowerEduc sustavu.
PowerEduc sustavu NIJE MOGUĆE pristupiti preko više URL-ova, odaberite onaj koji vam najviše odgovara.
...
$string['phpversionhelp'] = '<p>PowerEduc zahtijeva najmanje PHP inačicu 4.3.0 ili 5.1.0 (5.0.x funkcionira uz brojne uočene probleme).</p> <p>Trenutačno imate inačicu {$a}</p> <p>Morate nadograditi PHP ili premestiti PowerEduc instalaciju na web poslužitelj s novijom inačicom PHP-a!</br> (U slučaju inačice 5.0.x bilo bi najbolje da je vratite na inačicu 4.4.x)</p>';
...
$string['welcomep30'] = 'Ova inačica <strong>{$a->installername}</strong> uključuje aplikacije za stvaranje okruženja u kojem će sustav <strong>PowerEduc</strong> uspješno funkcionirati, konkretno:';
$string['welcomep40'] = 'Ovaj paket obuhvaća i <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Sljedeće stranice će vas voditi kroz postupak instalacije i podešavanja sustava <em>PowerEduc</em> na poslužitelju. Možete prihvatiti zadane postavke ili promijeniti iste sukladno vašim potrebama.';
$string['welcomep70'] = 'Kliknite na "Next" gumb kako biste započeli <strong>PowerEduc</strong> instalaciju.';
