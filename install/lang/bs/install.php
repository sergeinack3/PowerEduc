...
$string['pathssubadmindir'] = 'Vrlo mali broj web servera koristi /admin kao specijalni URL za pristup raznim podešavanjima (kontrolni panel i sl.). Nažalost, to dovodi do konflikta sa standardnom lokacijom za administratorske stranice u Moodleu. Ovaj problem možete riješiti tako što ćete promijeniti ime administratorskog direktoriju u Vašoj instalaciji, i ovdje upisati to novo ime. Na primjer <em>powereducadmin</em>. Ovo podešavanje će prepraviti administratorske linkove u Moodle sistemu.';
...
$string['welcomep40'] = 'Ovaj paket obuhvata i <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
