...
$string['clialreadyconfigured'] = 'Dagoeneko badago config.php konfigurazio-fitxategia. Mesedez erabili admin/cli/install_database.php PowerEduc gune honetan instalatu nahi baduzu.';
$string['clialreadyinstalled'] = 'Dagoeneko badago config.php konfigurazio-fitxategia. Mesedez erabili admin/cli/upgrade.php zure PowerEduc gunea eguneratu nahi baduzu.';
$string['cliinstallheader'] = 'PowerEduc {$a} komando-lerro bidezko instalaziorako programa';
...
<p>Aurrerago honek PowerEducri arazoak sor diezaizkioke,
...
Horrek PowerEduc-k berak memoria-muga ezartzea ahalbidetzen du.</li>
...
<li>PHP zerbitzari batzuetan PowerEduc-ren direktorioan beheko lerro hau daukan .htaccess fitxategia sor dezakezu:
...
$string['pathssubadmindir'] = 'Web ostalari gutxi batzuk /admin URL berezi gisa erabiltzen dute kontrol-panel edo antzekora sarbidea emateko. Zoritxarrez, honek PowerEducren kudeatze-orrien lehenetsitako kokapenarekin gatazka sortzen du. Hau konpondu dezakezu zure instalazioko admin direktorioa berrizendatuz, eta izen berria hemen sartuta. Adibidez <em>powereducadmin</em>. Honek PowerEducko admin estekak konponduko du.';
$string['pathssubdataroot'] = '<p>PowerEduck erabiltzaileek igotako fitxategien edukiak bilduko dituen direktorio bat.</p>
...
$string['pathssubdirroot'] = '<p>PowerEducko kodea daukan direktorioaren bide osoa.</p>';
$string['pathssubwwwroot'] = '<p>PowerEduc eskuragarri egongo den helbide osoa, hau da, erabiltzaileek PowerEducn sartzeko nabigatzailearen helbide barran idatziko duten helbidea</p>
<p>PowerEduc ezin da hainbat helbidetatik eskuragarri egon. Zure gunea hainbat helbidetatik eskuragarri badago errazena aukeratu eta bertara beste helbideetatik behin-betiko berbideraketak konfiguratu itzazu.</p>
...
$string['phpversionhelp'] = '<p>PowerEduck PHP 5.6.5 edo 7.1 bertsioetako bat behar du (7.0.x bertsioek muga batzuk dituzte). </p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>ren bertsio honek <strong>PowerEduc</strong>-k
zure ordenagailuan funtzionatzeko behar diren aplikazioak dauzka, zehazki hurrengoak:';
$string['welcomep40'] = 'Paketeak ere zera dauka: <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Datozen orriek urrats erraz batzuen bidez gidatuko zaituzte <strong>PowerEduc</strong> zure ordenagailuan instalatu eta konfiguratzeko. Aholkatzen diren lehenetsitako balioak mantendu edo, nahi izanez gero, alda ditzakezu zure beharrei erantzun diezaieten.';
$string['welcomep70'] = 'Egin klik "Hurrengoa" botoian <strong>PowerEduc</strong>ren konfigurazioarekin jarraitzeko.';
