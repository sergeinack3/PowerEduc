...
$string['clialreadyconfigured'] = 'Датотека config.php већ постоји. Молимо, користите admin/cli/install_database.php ако желите да инсталирате PowerEduc на овом серверу.';
$string['clialreadyinstalled'] = 'Датотека config.php већ постоји. Молимо користите admin/cli/upgrade.php ако желите да надоградите PowerEduc на овом серверу.';
$string['cliinstallheader'] = 'PowerEduc {$a} програм за инсталацију из командне линије';
...
$string['dirroot'] = 'PowerEduc директоријум';
$string['environmenthead'] = 'Проверавање Вашег окружења...';
$string['environmentsub2'] = 'Свако издање PowerEduca има минимум захтева по питању одговарајуће PHP верзије и неколико обавезних PHP екстензија.
...
<p>Ово подешавање може касније да проузрокује да PowerEduc има проблема са меморијом, посебно ако имате много активираних модула и/или много корисника.</p>
...
<li>Ако можете, рекомпајлирајте PHP са <i>--enable-memory-limit</i>. Ово ће омогућити PowerEduc систему да сам постави меморијско ограничење.</li>
...
<li>На неким PHP серверима можете да креирате .htaccess датотеку у PowerEduc директоријуму која садржи ред:
...
$string['pathssubadmindir'] = 'Врло мали број веб сервера користи /admin као специјални URL за приступ разним подешавањима (контролни панел и сл.). Нажалост, то доводи до конфликта са стандардном локацијом за администраторске странице у PowerEducu. Овај проблем можете решити тако што ћете променити име администраторског директоријума у вашој инсталацији, и овде уписати то ново име. На пример <em>powereducadmin</em>. Ово подешавање ће преправити администраторске линкове у PowerEduc систему.';
$string['pathssubdataroot'] = '<p>Директоријум где ће PowerEduc чувати датотеке и садржај који су поставили корисници. </p>
...
$string['pathssubdirroot'] = '<p>Пуна путања до директоријума који садржи кôд PowerEduca.</p>';
$string['pathssubwwwroot'] = '<p>Пуна адреса путем које ће се приступати PowerEducu, тј. адреса коју ће корисници унети у адресну траку својих веб читача како би приступили PowerEducu.</p>
<p>Није могуће приступати PowerEducu коришћењем више адреса. Ако се вашем сајту може приступити са више адреса, онда изаберите најлакшу, а за све остале адресе подесите перманентну редирекцију.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc захтева PHP верзију барем 5.6.5 или 7.1 (7.0.x има нека ограничења).</p>
<p>Тренутно користите верзију {$a}</p>
<p>Морате да надоградите PHP или да преместити PowerEduc на веб сервер са новијом верзијом PHP-a.</p>';
...
$string['welcomep30'] = 'Ово издање <strong>{$a->installername}</strong> укључује апликације за креирање окружења у којем ће <strong>PowerEduc</strong> успешно функционисати, конкретно:';
$string['welcomep40'] = 'Овај пакет обухвата и <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Наредне странице ће вас провести кроз неколико једноставних корака током којих ћете конфигурисати и подесити <strong>PowerEduc</strong> на свом рачунару. Можете прихватити подразумевана подешавања или их, опционо, прилагодити сопственим потребама.';
$string['welcomep70'] = 'Кликните на дугме за наставак да бисте даље подешавали <strong>PowerEduc</strong>.';
