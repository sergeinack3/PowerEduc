...
$string['clialreadyconfigured'] = 'El fitxer config.php ja existeix; feu servir admin/cli/install_database.php si voleu instal·lar PowerEduc en aquest lloc web.';
$string['clialreadyinstalled'] = 'El fitxer de configuració config.php ja existeix. Feu servir admin/cli/upgrade.php si voleu actualitzar PowerEduc per a aquest lloc web.';
$string['cliinstallheader'] = 'Programa d\'instal·lació de línia d\'ordres de PowerEduc {$a}';
...
$string['dirroot'] = 'Directori de PowerEduc';
$string['environmenthead'] = 'S\'està comprovant el vostre entorn';
$string['environmentsub2'] = 'Cada versió de PowerEduc té uns requeriments mínims de versió de PHP i un nombre d\'extensions de PHP necessàries.
...
<p>Això pot causar que PowerEduc tingui problemes de memòria més endavant, especialment, si teniu molts mòduls habilitats i/o molts usuaris.</p>
...
<ol>
<li>Si podeu, recompileu el PHP amb <i>--enable-memory-limit</i>. Això permetrà que PowerEduc defineixi el límit de memòria per si mateix.</li>
...
<li>En alguns servidors PHP podeu crear un fitxer .htaccess dins el directori de PowerEduc amb aquesta línia:
...
$string['pathssubadmindir'] = 'Alguns serveis d\'allotjament web (pocs) utilitzen /admin com a URL especial perquè accediu a un tauler de control o quelcom semblant. Malauradament, això entra en conflicte amb la ubicació estàndard de les pàgines d\'administració de PowerEduc. Podeu arreglar aquest problema canviant el nom del directori d\'administració de PowerEduc en la vostra instal·lació i posant el nom nou aquí. Per exemple: <em>powereducadmin</em>. Això arreglarà els enllaços d\'administració de PowerEduc.';
$string['pathssubdataroot'] = '<p>Directori on PowerEduc emmagatzemarà els materials pujats pels usuaris.</p>
...
$string['pathssubdirroot'] = 'Camí complet del directori d\'instal·lació de PowerEduc.';
$string['pathssubwwwroot'] = '<p>L\'adreça web completa on s\'accedirà a PowerEduc; per exemple, l\'adreça que els usuaris introduiran a la barra d\'adreces del navegador per accedir a PowerEduc.</p> <p> No és possible accedir a PowerEduc utilitzant diferents adreces. Si el vostre lloc és accessible a través de diferents adreces, trieu-ne la més fàcil i configureu una redirecció permanent per a cadascuna de les altres adreces.</p> <p>
...
$string['phpversionhelp'] = '<p>PowerEduc necessita una versió de PHP 4.3.0 o 5.1.0 (les versions 5.0.x tenien uns quants problemes coneguts).</p>
<p>A hores d\'ara esteu utilitzant la versió {$a}.</p>
<p>Us cal actualitzar el PHP o traslladar PowerEduc a un ordinador amb una versió de PHP més recent.<br />(Si esteu utilitzant la versió 5.0.x, alternativament també podríeu tornar enrere a la 4.4.x)</p>';
...
$string['welcomep30'] = 'Aquesta versió de <strong>{$a->installername}</strong> inclou les aplicacions necessàries per crear un entorn en el qual funcioni <strong>PowerEduc</strong>, concretament:';
$string['welcomep40'] = 'El paquet inclou també <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Les pàgines següents us guiaran per una sèrie de passos fàcils de seguir per configurar <strong>PowerEduc</strong> en el vostre ordinador. Podeu acceptar els paràmetres per defecte o, opcionalment, modificar-los perquè s\'ajustin a les vostres necessitats.';
$string['welcomep70'] = 'Feu clic al botó «Següent» per continuar amb la configuració de <strong>PowerEduc</strong>.';
