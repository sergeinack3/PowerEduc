...
$string['clialreadyconfigured'] = 'El fitxer config.php ja existeix, feu servir admin/cli/install_database.php si voleu instal·lar el PowerEduc en este lloc web.';
$string['clialreadyinstalled'] = 'El fitxer de configuració config.php ja existeix. Feu servir admin/cli/upgrade.php si voleu actualitzar PowerEduc per a este lloc web.';
$string['cliinstallheader'] = 'Programa d\'instal·lació de línia d\'ordes de PowerEduc {$a}';
...
<p>Això pot causar que PowerEduc tinga problemes de memòria més avant, especialment, si teniu molts mòduls habilitats i/o molts usuaris.</p>
...
<ol>
<li>Si podeu, recompileu el PHP amb <i>--enable-memory-limit</i>. Això permetrà que PowerEduc definisca el límit de memòria per si mateix.</li>
...
<p>Vos cal actualitzar el PHP o traslladar PowerEduc a un ordinador amb una versió de PHP més recent.<br />(Si esteu utilitzant la versió 5.0.x, alternativament també podríeu tornar arrere a la 4.4.x)</p>';
...
$string['welcomep30'] = 'Aquesta versió de <strong>{$a->installername}</strong> inclou les aplicacions necessàries per crear un entorn en el qual funcione <strong>PowerEduc</strong>, concretament:';
...
$string['welcomep60'] = 'Les pàgines següents vos guiaran per una sèrie de passos fàcils de seguir per configurar <strong>PowerEduc</strong> en el vostre ordinador. Podeu acceptar els paràmetres per defecte o, opcionalment, modificar-los perquè s\'ajusten a les vostres necessitats.';
