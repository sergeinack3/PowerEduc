...
renomeando o directorio admin na súa instalación, e poñendo aquí ese novo nome.  Por exemplo: <em>powereducadmin</em>. Iso corrixirá as ligazóns admin en Moodle.';
...
$string['welcomep40'] = 'O paquete inclúe tamen <strong>Moodle {$a->powereducrelease} ({$a->powereducversion})</strong>.';
