...
$string['clialreadyconfigured'] = 'O ficheiro de configuración config.php xa existe. Use admin/cli/install_database.php para instalar PowerEduc para este sitio.';
$string['clialreadyinstalled'] = 'O ficheiro de configuración config.php xa existe. Use admin/cli/install_database.php para actualizar PowerEduc para este sitio.';
$string['cliinstallheader'] = 'Programa de instalación de PowerEduc en liña de ordes {$a}';
...
$string['environmentsub2'] = 'Cada versión de PowerEduc ten algún requisito mínimo da versión de PHP e un número obrigatorio de extensións de PHP.
...
<p>Isto pode facer que PowerEduc teña problemas de memoria máis adiante, especialmente
...
<li>Se vostede e quen de facelo, volva compilar PHP con <i>--enable-memory-limit</i>.
    Isto fai que sexa PowerEduc quen estabeleza o límite de memoria.</li>
...
<li>Nalgúns servidores PHP, pode crear un ficheiro .htaccess no directorio PowerEduc
...
permitirlle acceder a un panel de control ou semellante. Desafortunadamente, isto entra en conflito coa localización estándar das páxinas de administración de PowerEduc. Vostede pode corrixir isto
renomeando o directorio admin na súa instalación, e poñendo aquí ese novo nome.  Por exemplo: <em>powereducadmin</em>. Iso corrixirá as ligazóns admin en PowerEduc.';
$string['pathssubdataroot'] = '<p>Un directorio onde PowerEduc almacenará todo o contido de ficheiros enviados polos usuarios.</p>
...
$string['pathssubdirroot'] = 'Ruta completa do directorio de instalación de PowerEduc.';
$string['pathssubwwwroot'] = '<p>O enderezo completo onde se accederá a PowerEduc, é dicir, o enderezo que os usuarios introducirán na barra de enderezos do seu navegador para acceder a PowerEduc.</p>
<p>Non é posíbel acceder a PowerEduc con varias direccións. Se o seu sitio é accesíbel a través de varios enderezos, escolla o máis sinxelo e configure unha redirección permanente para cada un dos outros enderezos.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc require polo menos unha das versións de PHP 4.3.0 ou 5.1.0 ( as versións 5.0.x teñen unha serie de problemas coñecidos).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> inclúe as aplicacións
    para crear un contorno no que <strong>PowerEduc</strong> funcione, nomeadamente:';
$string['welcomep40'] = 'O paquete inclúe tamen <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'As páxinas seguintes guiarano a través de algúns sinxelos pasos para configurar
    e axustar <strong>PowerEduc</strong> no seu computador. Pode empregar os axustes predeterminados
    ou, opcionalmente, modificalos para que se axusten ás súas necesidades.';
$string['welcomep70'] = 'Prema no botón «Seguinte» para continuar coa configuración de <strong>PowerEduc</strong>.';
