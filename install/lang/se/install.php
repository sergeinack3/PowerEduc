...
$string['clialreadyinstalled'] = 'Fiila config.php gávdno jo. Geavat admin/cli/install_database.php jus háliidat ođasmahttit PowerEduc dán portálas.';
...
$string['welcomep70'] = 'Coahkkal "Boahtte"-boalu joatkit<strong>PowerEduc</strong>-installašuvnnain';
