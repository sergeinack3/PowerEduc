...
$string['cliinstallheader'] = 'PowerEducn {$a} komentoriviasennusohjelma';
...
$string['dirroot'] = 'PowerEduc-hakemisto';
$string['environmenthead'] = 'Ympäristön tarkistus';
$string['environmentsub2'] = 'Jokaisessa PowerEduc-julkaisussa on joitakin vähimmäisvaatimuksia PHP-versiolta sekä joitakin pakollisia PHP-lisäosia.
...
<p>Tämä saattaa aiheuttaa PowerEduclle muistiongelmia myöhemmin, varsinkin jos sinulla on paljon mahdollisia moduuleita ja/tai paljon käyttäjiä.</p>
...
Tämä sallii PowerEducn asettaa muistirajan itse.</li>
...
<li>Joillain PHP palvelimilla voit luoda a .htaccess tiedoston PowerEduc hakemistossa, sisältäen tämän rivin:
...
$string['pathssubadmindir'] = 'Jotkut sivustot käyttävät /admin URL-osoitetta hallintapaneelille tai vastaavalle. Tämä on valitettavasti ristiriidassa PowerEducn normaalin admin-sivun sijainnin kanssa.
Voit korjata tämän nimeämällä asennuksesi admin-hakemiston uudelleen, antamalla uuden nimen tähän. Esimerkiksi: <em>powereducadmin</em>. Tämä korjaa admin-linkit PowerEducssa.';
$string['pathssubdataroot'] = 'Tarvitset paikan, jonne PowerEduc voi tallentaa ladatut tiedostot. Tämän hakemiston pitäisi olla luettavissa ja kirjoitettavissa web-palvelimen käyttäjän taholta (yleensä "nobody" tai "apache"), mutta se ei saa olla käytettävissä suoraan web:in kautta. Jos hakemistoa ei ole, asennusohjelma yrittää luoda sen.';
$string['pathssubdirroot'] = 'Koko hakemistopolku PowerEduc-asennukseen.';
$string['pathssubwwwroot'] = 'PowerEducn koko verkko-osoite.
PowerEducen ei ole mahdollista päästä käyttäen useita osoitteita.
...
$string['phpversionhelp'] = '<p>PowerEduc vaatii vähintään PHP-version 4.3.0 tai 5.1.0 (5.0.x sisältää monia tunnettuja ongelmia).</p> <p>Käytössäsi on versio {$a}</p> <p>Sinun pitää päivittää PHP tai siirtää palvelimelle jossa on uudempi PHP.<br /> (Jos käytössäsi on 5.0.x voit myös päivittää alaspäin 4.4.x -versioon)</p>';
...
Onnittelut!';
$string['welcomep30'] = 'Tämä julkaisu <strong>{$a->installername}</strong> sisältää sovellukset ympäristön luomiseen, jossa <strong>PowerEduc</strong> toimii:';
$string['welcomep40'] = 'Tämä paketti sisältää myös <strong>PowerEducn {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Seuraavat sivut opastavat sinua helposti seurattavien vaiheiden läpi <strong>PowerEducn</strong> konfiguroinnissa koneellesi. Voit hyväksyä oletusasetukset tai vaihtoehtoisesti muuttaa niitä tarvitsemallasi tavalla.';
$string['welcomep70'] = 'Napsauta "Seuraava"-painiketta jatkaaksesi powereducn asennusta';
