...
Voit korjata tämän nimeämällä asennuksesi admin-hakemiston uudelleen, antamalla uuden nimen tähän. Esimerkiksi: <em>powereducadmin</em>. Tämä korjaa admin-linkit Moodlessa.';
...
$string['welcomep40'] = 'Tämä paketti sisältää myös <strong>Moodlen {$a->powereducrelease} ({$a->powereducversion})</strong>.';
