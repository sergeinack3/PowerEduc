...
$string['clialreadyinstalled'] = 'Fișierul de configurare config.php există deja. Vă rugăm să folosiți dmin/cli/install_database.php to pentru a upgrada PowerEduc pentru acest site.';
$string['cliinstallheader'] = 'Program  command line installation PowerEduc {$a}';
...
$string['dirroot'] = 'Director PowerEduc';
$string['environmenthead'] = 'Se verifică mediul...';
$string['environmentsub2'] = 'Fiecare versiune PowerEduc are o anumită cerință minimă PHP și un număr de extensii PHP obligatorii.
...
<p> Acest lucru poate determina PowerEduc să aibă probleme de memorie mai târziu, în special
...
<li> Dacă puteți, recompilați PHP cu <i> --enable-memory-limit </i>.
    Aceasta va permite PowerEduc să stabilească singură limita de memorie. </li>
...
<li> Pe unele servere PHP puteți crea un fișier .htaccess în directorul PowerEduc
...
panoul de control sau ceva de genul acesta. Din păcate, acest lucru intră în conflict cu locația standard pentru paginile de administrare PowerEduc. Puteți rezolva acest lucru
redenumirea directorului de administrare din instalarea dvs. și plasarea acestui nou nume aici. De exemplu: <em> powereducadmin </em>. Aceasta va remedia linkurile de administrator din PowerEduc.';
$string['pathssubdataroot'] = '<p>Un director unde PowerEduc va stoca tot conținutul unui fișier încărcat de către utilizatori.</p>
...
$string['pathssubdirroot'] = '<p>Calea completă către directorul care conține codul PowerEduc .</p>';
$string['pathssubwwwroot'] = '<p> Adresa completă unde va fi accesat PowerEduc, adică adresa pe care utilizatorii o vor introduce în bara de adrese a browserului lor pentru a accesa PowerEduc. </p>
<p> Nu este posibil să accesați PowerEduc utilizând mai multe adrese. Dacă site-ul dvs. este accesibil prin mai multe adrese, alegeți-l pe cel mai simplu și configurați o redirecționare permanentă pentru fiecare dintre celelalte adrese. </p>
...
$string['phpversionhelp'] = '<p> PowerEduc necesită o versiune PHP de cel puțin 5.6.5 sau 7.1 (7.0.x are unele limitări ale motorului). </p>
...
$string['welcomep30'] = 'Această versiune <strong>{$a->installername}</strong> include aplicații pentru a crea un mediu în care <strong>PowerEduc</strong> va funcționa, și anume:';
$string['welcomep40'] = 'Pachetul include și <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Următoarele pagini vă oferă pași ușor de urmat pentru a
   configura și seta <strong>PowerEduc</strong> în computerul       dumneavoastră. Puteți accepta setările implicite
    sau, opțional, să le modificați pentru a corespunde nevoilor dumneavoastră.';
$string['welcomep70'] = 'Click pe butonul "Next" de mai jos pentru a continua setarea <strong>PowerEduc</strong>.';
