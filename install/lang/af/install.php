...
$string['clialreadyconfigured'] = 'Die konfigurasielêer config.php bestaan reeds. Gebruik admin/cli/install_database.php asseblief om PowerEduc vir hierdie webwerf te installeer.';
$string['clialreadyinstalled'] = 'Die konfigurasielêer config.php bestaan reeds. Gebruik admin/cli/install_database.php asseblief om PowerEduc vir hierdie webwerf by te werk.';
$string['cliinstallheader'] = 'Installasieprogram vir PowerEduc-{$a}-opdraglyn';
...
$string['dirroot'] = 'PowerEduc-gids';
$string['environmenthead'] = 'Gaan tans jou omgewing na ...';
$string['environmentsub2'] = 'Elke PowerEduc-vrystelling het \'n paar minimumvereistes vir PHP-weergawes en \'n aantal verpligte PHP-uitbreidings.
...
<p>Dit kan veroorsaak dat PowerEduc mettertyd geheueprobleme ervaar, veral as baie modules aangeskakel en/of daar baie gebruikers is.</p>
...
<li>As jy kan, herkompileer PHP met <i>--enable-memory-limit</i>.
    Dit sal PowerEduc in staat stel om self die geheueperk te stel.</li>
...
<li>Op sommige PHP-bedieners kan jy \'n .htaccess-lêer in die PowerEduc-gids skep wat hierdie lyn bevat:
...
$string['pathssubadmindir'] = 'Slegs \'n paar webgashere gebruik /admin \'n spesiale URL sodat jy toegang tot \'n kontrolepaneel of iets dergliks kan verkry. Ongelukkig bots dit met die standaardligging vir die PowerEduc-adminblaaie. Jy kan dit regstel deur die admingids in jou installasie te herbenaam, en daardie nuwe naam hier aan te bring. Byvoorbeeld: <em>powereducadmin</em>. Dit sal die adminskakels in PowerEduc regstel.';
$string['pathssubdataroot'] = '<p>\'n Gids waar PowerEduc alle lêerinhoud wat deur gebruikers opgelaai is, sal stoor.</p>
...
$string['pathssubdirroot'] = '<p>Die volledige roete na die gids wat die PowerEduc-kode bevat.</p>';
$string['pathssubwwwroot'] = '<p>Die volledige adres waar toegang tot PowerEduc verkry sal word, d.w.s. die adres wat gebruikers in die adresbalk van hul blaaier sal intik om toegang tot PowerEduc te verkry.</p>
<p>Dit is nie moontlik om toegang tot PowerEduc te verkry deur van veelvoudige adresse gebruik te maak nie. As jou webwerf via veelvoudige adresse toeganklik is, kies dan die maklikste een en stel \'n permanente heradressering vir elk van die ander adresse op.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc vereis \'n PHP-weergawe van ten minste 5.6.5 of 7.1 (7.0.x het \'n paar enjinbeperkings).</p>
...
$string['welcomep30'] = 'Hierdie vrystelling van die <strong>{$a->installername}</strong> sluit die toepassings in om \'n omgewing te skep waarbinne <strong>PowerEduc</strong> gaan funksioneer, naamlik:';
$string['welcomep40'] = 'Die pakket sluit ook <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong> in.';
...
$string['welcomep60'] = 'Die volgende blaaie gaan jou deur \'n paar maklik volgbare stappe lei om <strong>PowerEduc</strong> op jou rekenaar te konfigureer en op te stel. Jy kan die verstekinstellings aanvaar of, opsioneel, hulle wysig om by jou eie behoeftes te pas.';
$string['welcomep70'] = 'Klik die "Volgende"-knoppie hieronder om voort te gaan met die opstelling van <strong>PowerEduc</strong>.';
