...
$string['phpversionhelp'] = '<p>PowerEduc krefst útgáfu 4.3.0 eða 5.1.0 af PHP (5.0.x útgáfan inniheldur villur).</p>
...
$string['welcomep70'] = 'Smelltu á "Áfram" hnappinn hér að neðan til þess að halda áfram uppsetningunni á <strong>PowerEduc</strong>.';
