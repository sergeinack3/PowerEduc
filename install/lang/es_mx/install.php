...
$string['clialreadyconfigured'] = 'El archivo de configuración config.php ya existe. Por favor, use admin/cli/install_database.php para instalar PowerEduc para este sitio';
$string['clialreadyinstalled'] = 'El archivo de configuración config.php ya existe. Por favor, utilice admin/cli/install_database.php para actualizar PowerEduc para este sitio.';
$string['cliinstallheader'] = 'Programa de instalación PowerEduc de línea de comando {$a}';
...
$string['dirroot'] = 'Directorio PowerEduc';
$string['environmenthead'] = 'Comprobando su entorno';
$string['environmentsub2'] = 'Cada versión de PowerEduc tiene algún requisito mínimo de la versión de PHP y un número obligatorio de extensiones de PHP. Una comprobación del entorno completo se realiza antes de cada instalación y actualización. Por favor, póngase en contacto con el administrador del servidor si no sabe cómo instalar la nueva versión o habilitar las extensiones PHP.';
...
<p>Esto puede ocasionar que PowerEduc tenga problemas de memoria más adelante, especialmente si usted tiene activados muchos módulos y/o muchos usuarios.</p>
...
Esto hace que PowerEduc fije por sí mismo el límite de memoria.</li>
...
<li>En algunos servidores PHP usted puede crear en el directorio PowerEduc un archivo .htaccess que contenga esta línea:
...
panel de control o algo similar. Lamentablemente, esto entra en conflicto con la ubicación estándar para las páginas de administración de PowerEduc. Usted puede solucionar este problema, renombrando el directorio admin en su instalación PowerEduc, poniendo un nuevo nombre aquí. Por ejemplo: <em> powereducadmin </em>. Esto solucionará los enlaces de administración en instalación PowerEduc.';
$string['pathssubdataroot'] = '<p>Un directorio en donde PowerEduc almacenará todo el contenido de los archivos subidos por usuarios.</p>
...
$string['pathssubdirroot'] = '<p> La ruta completa al directorio que contiene el código de PowerEduc.</p>';
$string['pathssubwwwroot'] = '<p>La dirección completa desde donde se accederá a PowerEduc; o sea, la dirección que los usuarios escribirán en la barra de dirección de su navegador para acceder a PowerEduc.</p>
<p>No es posible acceder a PowerEduc usando direcciones múltiples. Si su sitio fuera accesible desde direcciones múltiples, entonces elija la más sencilla y configure una redirección permanente para cada una de las otras direcciones.</p>
...
$string['phpversionhelp'] = '<p>PowerEduc requiere una versión de PHP de al menos 5.6.5 o 7.1 (7.0.x tiene algunas limitaciones del motor).</p>
...
$string['welcomep30'] = 'Esta versión de <strong>{$a->installername}</strong> incluye las aplicaciones necesarias para que <strong>PowerEduc</strong> funcione en su computadora,  principalmente:';
$string['welcomep40'] = 'El paquete también incluye <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Las siguientes páginas le guiarán a través de algunos sencillos pasos para configurar y ajustar <strong>PowerEduc</strong> en su computadora. Puede utilizar los valores por defecto sugeridos o, de forma opcional, modificarlos para que se ajusten a sus necesidades.';
$string['welcomep70'] = 'Pulse en el botón "Siguiente" para continuar con la configuración de <strong>PowerEduc</strong>.';
