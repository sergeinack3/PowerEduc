...
$string['dirroot'] = 'PowerEduc դիրեկտորիա';
...
<p>հետագայում կարող եք հիշողության հետ կապված խնդիրներ ունենալ,
   եթե PowerEduc-ում ունենաք շատ մոդուլներ և/կամ մեծ թվով օգտագործողներ։</p>
...
<ol>
<li>Եթե դուք կարող եք, վերակազմարկել PHP-ն <i>--enable-memory-limit</i>-ով։ Այն թույլ կտա PowerEduc-ին ինքնուրույն կարգաբերել հիշողության սահմանը։</li>
<li>Եթե Ձեզ մատչելի է php.ini ֆայլը, կարող եք փոխել <b>memory_limit</b>-ը՝
    կարգաբերելով մոտավորապես 40M։  </li>
<li>Որոշ PHP սպասարկիչներում PowerEduc դիրեկտորիայում կարող եք ստեղծել .htaccess ֆայլը, որը պարունակում է այս տողը՝
...
$string['phpversionhelp'] = '<p>PowerEduc Մուդլը պահանջում է PHP 4.3.0 կամ 5.1.0 տարբերակները (5.0.x -ը ունի որոշ հայտնի խնդիրներ)։</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong> թողարկումը պարունակում է  կիրառական ծրագրեր, որոնք ստեղծում են միջավայր, որտեղ <strong>PowerEduc</strong> կաշխատի, մասնավորապես՝';
$string['welcomep40'] = 'Այս փաթեթը պարունակում է նաև <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>։';
...
$string['welcomep60'] = 'Հետևյալ էջերի որոշ հեշտ քայլերին հետևելով՝ կարող եք <strong>PowerEduc</strong> տեղակայել Ձեր համակարգչում։ Դուք կարող եք համաձայնվել լռելյայն կարգաբերումների հետ կամ փոխել դրանք՝ ձեր պահանջներին համապատասխան:';
$string['welcomep70'] = 'Սեղմեք ստորև գտնվող \'Հաջորդ\' կոճակը, որպեսզի անցնեք <strong>PowerEduc</strong>-ի կարգաբերման հաջորդ քայլին:';
