...
$string['cliinstallheader'] = 'Rhaglen gosod llinell gorchymyn PowerEduc {$a}';
...
$string['dirroot'] = 'Cyfeiriadur PowerEduc';
$string['environmenthead'] = 'Wrthi\'n profi eich amgylchedd ...';
$string['environmentsub2'] = 'Mae gan bob fersiwn PowerEduc ofyniad fersiwn PHP sylfaenol ac amryw o estyniadau PHP gorfodol.
...
<li>Os ydych yn gallu, ceisiwch ail-grynhoi PHP gyda <i>--enable-memory-limit</i>.
    Bydd hyn yn gadael i PowerEduc osod maint y cof ei hun.</li>
...
<li>Ar rai gweinyddion PHP, gallwch greu ffeil .htaccess yng nghyfeiriadur PowerEduc
...
$string['pathssubadmindir'] = 'Nifer fach iawn o westeiwyr gwe sy\'n defnyddio /admin fel URL arbennig i chi gael mynd i mewn i\'r panel rheoli neu beth bynnag. Yn anffodus, mae hyn yn gwrthdaro â lleoliad safonol tudalennau gweinyddol PowerEduc. Gallwch drwsio hyn drwy ailenwi cyfeiriadur y gweinyddwr wrth osod y rhaglen, a rhoi\'r enw newydd yma. Er enghraifft: <em>gweinyddpowereduc</em>.  Bydd hyn yn trwsio\'r dolenni gweinyddol yn PowerEduc';
$string['pathssubdataroot'] = 'Mae PowerEduc angen lle ar gyfer cadw ffeiliau sy\'n cael eu llwytho i fyny. Dylai defnyddiwr gweinydd y we (fel arfer \'neb\' neu \'apache\') allu darllen ac YSGRIFENNU ar y cyfeiriadur hwn, ond ni ddylid gallu mynd i mewn iddo\'n uniongyrchol drwy\'r we. Bydd y rhaglen osod yn ceisio ei greu os nad yw\'n bodoli.';
$string['pathssubdirroot'] = 'Llwybr cyfeiriadur llawn i raglen PowerEduc.';
$string['pathssubwwwroot'] = 'Y cyfeiriad gwe llawn a ddefnyddir i fynd i mewn i PowerEduc.
Nid yw\'n bosibl mynd i mewn i PowerEduc wrth ddefnyddio amryw o gyfeiriadau.
...
$string['phpversionhelp'] = '<p>Mae angen o leiaf fersiwn PHP 4.3.0 neu 5.1.0 ar PowerEduc (mae llawer o broblemau gyda 5.0.x).</p>
...
$string['welcomep30'] = 'Mae\'r fersiwn <strong>{$a->installername}</strong> yn cynnwys rhaglenni
    i greu amgylchedd y gall  <strong>PowerEduc</strong> weithio ynddo, sef:';
$string['welcomep40'] = 'Mae\'r pecyn hefyd yn cynnwys <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'Bydd y tudalennau canlynol yn eich arwain drwy\'r camau syml i
    ffurfweddu a gosod <strong>PowerEduc</strong> ar eich cyfrifiadur. Gallwch ddewis derbyn y gosodiadau
    diofyn, neu gallwch eu newid eich hun ar gyfer eich dibenion chi.';
$string['welcomep70'] = 'Cliciwch y botwm "Nesaf" i fwrw ymlaen i osod <strong>PowerEduc</strong>.';
