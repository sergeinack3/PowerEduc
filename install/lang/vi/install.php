...
$string['dirroot'] = 'Thư mục PowerEduc';
$string['installation'] = 'Cài đặt';
$string['memorylimithelp'] = '<p> PHP thiết lập giới hạn bộ nhớ cho máy chủ của bạn hiện tại là {$a}.</p>

<p>Đây có thể là nguyên nhân PowerEduc có các vấn đề về bộ nhớ vào một thời điểm nào đó, đặc biệt
...
<li>Nếu bạn có khả năng, biên tập lại PHP với <i>--giới hạn bộ nhớ cho phép</i>.
    Điều này sẽ cho phép PowerEduc tự thiết lập giới hạn bộ nhớ.
...
<li> Trên một số máy chủ chạy PHP bạn có thể tạo một file .htaccess trong thư mục PowerEduc
    chứa dòng này:
...
$string['phpversionhelp'] = '<p>PowerEduc yêu cầu một phiên bản PHP ít nhất là 4.1.0.</p>
