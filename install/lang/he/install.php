...
$string['cliinstallheader'] = 'תוכנית התקנת PowerEduc {$a} בשורת הפקודה';
...
$string['dirroot'] = 'ספריית ה-PowerEduc';
$string['environmenthead'] = 'בודק את הסביבה שלך...';
$string['environmentsub2'] = 'לכל התקנת PowerEduc יש דרישות מינימליות לגרסת ה-PHP ומספר הרחבות הכרחי של ה-PHP.
...
דבר זה יאפשר ל-PowerEduc להגדיר את גבול הזיכרון לבד. </i>
...
<i> בכמה שרתי PHP תוכל ליצור קובץ  .htaccess בספריית  ה-PowerEduc שלך בצירוף שורה זו:
...
$string['pathssubdirroot'] = 'הנתיב המלא לספריית ההתקנה של PowerEduc';
...
$string['welcomep30'] = 'גירסת <strong>{$a->installername}</strong> כוללת את היישומים ליצור סביבה אשר בה <strong> PowerEduc </strong>
יפעל דהיינו:';
$string['welcomep40'] = 'החבילה כוללת בנוסף
<strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'העמודים הבאים יובילו אותך בצורה פשוטה דרך כמה צעדים לקביעת הגדרות <strong>PowerEduc</strong> בשרת.
ניתן לאשר הגדרות בררת־המחדל או לשנותם לפי צרכיך.';
$string['welcomep70'] = 'לחצו "המשך" למטה כדי להמשיך עם הגדרת ה-<strong>PowerEduc</strong>';
