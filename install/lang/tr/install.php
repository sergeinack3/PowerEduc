...
$string['cliinstallheader'] = 'PowerEduc {$a} komut satırı kurulum programı';
...
Bu, PowerEduc\'nın kendi kendine bellek limitini ayarlasına izin verecek.</li>
...
<li>Bazı PHP sunucularında PowerEduc klasörü içinde şu ayarı içeren bir
...
$string['pathssubadmindir'] = 'Pek az web sunucusu /admin adresini kontrol paneline yada benzeri birşeye erişmek için kullanır. Ne yazık ki bu PowerEduc admin sayfalarının standart konumuyla bir karışıklık yaratır. Bu durumu düzeltmek için kurulumunuzdaki admin dizinini yeniden isimlendirip buraya yeni ismi yazınız. Örneğin: <em>powereducadmin</em>. Bu PowerEduc\'daki admin bağlantısını düzeltecektir.';
$string['pathssubdataroot'] = '<p>PowerEduc\'ın yüklenen dosyaları kayıt etmesi için bir yere ihtiyacınız var. </p>
...
$string['pathssubdirroot'] = '<p>PowerEduc kurulumu için tam klasör yolu.</p >';
$string['pathssubwwwroot'] = '<p>PowerEduc\'a erişilecek tam web adresi. PowerEduc\'ın birden çok adres kullanması mümkün değildir. </p>
...
$string['phpversionhelp'] = '<p>PowerEduc, PHP sürümünün en az 4.3.0 veya 5.1.0 olmasını gerektirir (5.0.x sürümünde çok fazla hata var).</p>
...
$string['welcomep30'] = '<strong>{$a->installername}</strong>\'nin bu sürümü <strong>PowerEduc</strong>\'da bir ortam oluşturmak için uygulamaları içerir:';
$string['welcomep40'] = 'Bu paket <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong> sürümünü de içerir.';
...
$string['welcomep60'] = 'Aşağıdaki sayfalar <strong>PowerEduc</strong>ın kurulumu ve yapılandırılması için size basitçe yol gösterecektir. Varsayılan ayarları kabul edebilir veya ihtiyaçlarınıza göre bunları değiştirebilirsiniz.';
$string['welcomep70'] = '<strong>PowerEduc</strong> kurulumu için aşağıdaki "İleri" tuşuna basın.';
