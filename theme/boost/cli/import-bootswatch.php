...
/**
 * Used to convert a bootswatch file from https://bootswatch.com/ to a PowerEduc preset.
 *
 * @package    theme_boost
 * @subpackage cli
...
$usage = "
Utility to convert a Bootswatch theme to a PowerEduc preset compatible with Bootstrap 4.
