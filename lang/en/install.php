...
/**
 * Strings for component 'install', language 'en', branch 'POWEREDUC_20_STABLE'
 *
 * @package   core
...
$string['admindirsetting'] = 'A very few webhosts use /admin as a special URL for you to access a
    ...
    standard location for the PowerEduc admin pages.  You can fix this by
    renaming the admin directory in your installation, and putting that
    new name here.  For example: <br /> <br /><b>powereducadmin</b><br /> <br />
    This will fix admin links in PowerEduc.';
...
$string['clialreadyconfigured'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to install PowerEduc for this site.';
$string['clialreadyinstalled'] = 'The configuration file config.php already exists. Please use admin/cli/install_database.php to upgrade PowerEduc for this site.';
$string['cliinstallfinished'] = 'Installation completed successfully.';
$string['cliinstallheader'] = 'PowerEduc {$a} command line installation program';
...
$string['compatibilitysettingssub'] = 'Your server should pass all these tests to make PowerEduc run properly';
$string['configfilenotwritten'] = 'The installer script was not able to automatically create a config.php file containing your chosen settings, probably because the PowerEduc directory is not writeable. You can manually copy the following code into a file named config.php within the root directory of PowerEduc.';
...
$string['configurationcompletesub'] = 'PowerEduc made an attempt to save your configuration in a file in the root of your PowerEduc installation.';
...
$string['databasetypesub'] = 'PowerEduc supports several types of database servers. Please contact server administrator if you do not know which type to use.';
...
$string['dbtype'] = 'Type';
$string['directorysettings'] = '<p>Please confirm the locations of this PowerEduc installation.</p>

<p><b>Web address:</b>
Specify the full web address where PowerEduc will be accessed.
...
$string['directorysettingshead'] = 'Please confirm the locations of this PowerEduc installation';
...
$string['dirroot'] = 'PowerEduc directory';
$string['dirrooterror'] = 'The \'PowerEduc directory\' setting seems to be incorrect - we can\'t find a PowerEduc installation there. The value below has been reset.';
...
<p>PowerEduc can still be installed, but without this ability, you will not be able
...
$string['inputwebdirectory'] = 'PowerEduc directory:';
...
$string['nativeauroramysqlhelp'] = '<p>The database is where most of the PowerEduc settings and data are stored and must be configured here.</p>
...
<p>If the database currently does not exist, and the user you specify has permission, PowerEduc will attempt to create a new database with the correct permissions and settings.</p>
<p>This driver is not compatible with legacy MyISAM engine.</p>';
$string['nativemariadb'] = 'MariaDB (native/mariadb)';
$string['nativemariadbhelp'] = '<p>The database is where most of the PowerEduc settings and data are stored and must be configured here.</p>
<p>The database name, username, and password are required fields; table prefix is optional.</p>
<p>The database name may contain only alphanumeric characters, dollar ($) and underscore (_).</p>
<p>If the database currently does not exist, and the user you specify has permission, PowerEduc will attempt to create a new database with the correct permissions and settings.</p>
<p>This driver is not compatible with legacy MyISAM engine.</p>';
$string['nativemysqli'] = 'Improved MySQL (native/mysqli)';
$string['nativemysqlihelp'] = '<p>The database is where most of the PowerEduc settings and data are stored and must be configured here.</p>
<p>The database name, username, and password are required fields; table prefix is optional.</p>
<p>The database name may contain only alphanumeric characters, dollar ($) and underscore (_).</p>
<p>If the database currently does not exist, and the user you specify has permission, PowerEduc will attempt to create a new database with the correct permissions and settings.</p>';
$string['nativeoci'] = 'Oracle (native/oci)';
$string['nativeocihelp'] = 'Now you need to configure the database where most PowerEduc data will be stored.
...
$string['nativepgsqlhelp'] = '<p>The database is where most of the PowerEduc settings and data are stored and must be configured here.</p>
...
$string['nativesqlsrvhelp'] = 'Now you need to configure the database where most PowerEduc data will be stored.
This database must already have been created and a username and password created to access it. Table prefix is mandatory.';
...
control panel or something.  Unfortunately this conflicts with the standard location for the PowerEduc admin pages.  You can fix this by
renaming the admin directory in your installation, and putting that  new name here.  For example: <em>powereducadmin</em>. This will fix admin links in PowerEduc.';
...
$string['releasenoteslink'] = 'For information about this version of PowerEduc, please see the release notes at {$a}';
$string['safemode'] = 'Safe mode';
$string['safemodeerror'] = 'PowerEduc may have trouble with safe mode on';
$string['safemodehelp'] = '<p>PowerEduc may have a variety of problems with safe mode on, not least is that
...
<p>Safe mode is usually only enabled by paranoid public web hosts, so you may have
   to just find a new web hosting company for your PowerEduc site.</p>
...
$string['sessionautostarthelp'] = '<p>PowerEduc requires session support and will not function without it.</p>
...
$string['welcomep30'] = 'This release of the <strong>{$a->installername}</strong> includes the applications
    to create an environment in which <strong>PowerEduc</strong> will operate, namely:';
$string['welcomep40'] = 'The package also includes <strong>PowerEduc {$a->powereducrelease} ({$a->powereducversion})</strong>.';
...
$string['welcomep60'] = 'The following pages will lead you through some easy to follow steps to
    configure and set up <strong>PowerEduc</strong> on your computer. You may accept the default
    settings or, optionally, amend them to suit your own needs.';
$string['welcomep70'] = 'Click the "Next" button below to continue with the set up of <strong>PowerEduc</strong>.';
$string['wwwroot'] = 'Web address';
$string['wwwrooterror'] = 'The \'Web Address\' does not appear to be valid - this PowerEduc installation doesn\'t appear to be there. The value below has been reset.';
