...
/**
 * Strings for component 'debug', language 'en', branch 'POWEREDUC_20_STABLE'
 *
 * @package   core
...
$string['configpowereduc'] = 'PowerEduc has not been configured yet. You need to edit config.php first.';
