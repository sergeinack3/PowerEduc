...
/**
 * Strings for component 'grades', language 'en', branch 'POWEREDUC_20_STABLE'
 *
 * @package   core_grades
...
$string['gradepublishing_help'] = 'Grade publishing is a way of importing and exporting grades via a URL without being logged in to PowerEduc. If enabled, administrators and users with the permission to publish grades (by default, users with the role of manager only) are provided with grade export publishing settings in each course gradebook.';
