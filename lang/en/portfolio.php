...
/**
 * Strings for component 'portfolio', language 'en', branch 'POWEREDUC_20_STABLE'
 *
...
$string['format_mbkp'] = 'PowerEduc backup format';
...
$string['leap2a_feedtitle'] = 'Leap2A export from PowerEduc for {$a}';
