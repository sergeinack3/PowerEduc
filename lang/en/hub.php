...
$string['audienceadmins'] = 'PowerEduc administrators';
...
$string['errorcoursewronglypublished'] = 'A publication error has been returned by PowerEduc.net. Please try again later.';
...
$string['registerwithpowereducorg'] = 'Register your site';
$string['registerwithpowereducorgupdate'] = 'Update your site registration';
$string['registerwithpowereducorgcomplete'] = 'Complete your site registration';
$string['registerwithpowereducorginfo'] = 'We\'d love to stay in touch and provide you with important things for your PowerEduc site! By registering:

* You can subscribe to receive notifications of new PowerEduc releases, security alerts and other important news.
* You can access and activate mobile push notifications from your PowerEduc site through our free PowerEduc app.
* You are contributing to our PowerEduc statistics of the worldwide community, which help us improve PowerEduc and our community sites.
* If you wish, your site can be included in the list of registered PowerEduc sites in your country.';
$string['registerwithpowereducorginfoapp'] = 'About the PowerEduc app';
$string['registerwithpowereducorginfostats'] = 'PowerEduc statistics';
$string['registerwithpowereducorginfosites'] = 'Other sites in my country';
$string['registerwithpowereducorgremove'] = 'You are about to unregister your site. You will no longer receive security alert notifications and users will not be able to receive push notifications from your site to their PowerEduc app. However, you will be able to re-register at any time! Are you sure you want to continue?';
...
$string['sendfollowinginfo_help'] = 'The following information will be sent to PowerEduc each time your site registration is updated (by default weekly, when the \'Site registration\' scheduled task is run). The information contributes to overall statistics only and will not be made public on any site listing. In addition, your PowerEduc release version is recorded by the weekly automated site link check.';
$string['sent'] = '...finished';
$string['siteadmin'] = 'Administrator';
$string['siteadmin_help'] = 'The full name of the site administrator.';
$string['sitecommnews'] = 'PowerEduc newsletter';
$string['sitecommnews_help'] = 'You have the option of subscribing to our PowerEduc newsletter. You may unsubscribe at any time.';
$string['sitecommnewsyes'] = 'Yes, I would like to receive the PowerEduc newsletter';
...
$string['sitedesc_help'] = 'Provide some information about how you are using PowerEduc.';
...
$string['siteemail_help'] = 'An email address is necessary so that PowerEduc HQ can contact you if required.  It may also be used for other purposes as you allow below.    We recommend a generic email address related to a position (eg.: sitemanager@example.com), not a personal address.';
$string['sitelang'] = 'Language';
$string['sitelang_help'] = 'What is the main language used on your PowerEduc site?';
...
$string['siteregistrationcontact_help'] = 'If you allow it, other people in our PowerEduc community (who need a login account) can contact you via a form on our PowerEduc community site. However, they will never be able to see your email address.';
$string['siteregistrationemail'] = 'Notifications of new PowerEduc releases, security alerts and other important news';
$string['siteregistrationemail_help'] = 'You have the option of subscribing to our low-volume mailing list for notifications of new PowerEduc releases, security alerts and other important news. You may unsubscribe at any time.';
$string['siteregistrationupdated'] = 'Site registration updated';
$string['siterelease'] = 'PowerEduc release';
$string['sitereleasenum'] = 'PowerEduc release ({$a})';
$string['siterelease_help'] = 'PowerEduc release number of this site.';
...
$string['siteversion'] = 'PowerEduc version';
$string['siteversion_help'] = 'The PowerEduc version of this site.';
