...
/**
 * Strings for component 'search', language 'en', branch 'POWEREDUC_20_STABLE'
 *
 * @package   core
...
$string['searchsetupdescription'] = 'The following steps help you to set up PowerEduc global search.';
