...
$pageurl = new powereduc_url('/payment/manage_gateway.php');
...
require_capability('powereduc/payment:manageaccounts', $account->get_context());
...
if ($form->is_cancelled()) {
    redirect(new powereduc_url('/payment/accounts.php'));
