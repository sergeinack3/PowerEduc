...
/*
 * INTERNAL FUNCTIONS - to be used by powereduc core only
...
function groups_create_group($data, $editform = false, $editoroptions = false) {
    ...
    if (isset($data->idnumber)) {
        ...
        if (groups_get_group_by_idnumber($course->id, $data->idnumber)) {
            throw new powereduc_exception('idnumbertaken');
        }
    }
 ...
 * roles on a course.
 *
 * @param powereduc_recordset $rs The record set (may be false)
