...
if ($groupings = $DB->get_records('groupings', array('courseid'=>$course->id), 'name')) {
    $canchangeidnumber = has_capability('powereduc/course:changeidnumber', $context);
    ...
    foreach($groupings as $grouping) {
        ...
        $url = new powereduc_url('/group/grouping.php', array('id' => $grouping->id));
        ...
        if (empty($grouping->idnumber) || $canchangeidnumber) {
            ...
            $url = new powereduc_url('/group/grouping.php', array('id' => $grouping->id, 'delete' => 1));
        ...
        $url = new powereduc_url('/group/assign.php', array('id' => $grouping->id));
...
echo $OUTPUT->single_button(new powereduc_url('grouping.php', array('courseid'=>$courseid)), $srtnewgrouping);
