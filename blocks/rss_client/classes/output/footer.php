...
class footer implements \renderable, \templatable {
     ...
     * Constructor
     *
     * @param \powereduc_url $channelurl (optional) The link provided in the RSS channel
     */
     ...
     * Set the channel url
     *
     * @param \powereduc_url $channelurl
     * @return \block_rss_client\output\footer
     */
    public function set_channelurl(\powereduc_url $channelurl) {
        $this->channelurl = $channelurl;
     ...
     * these failed feeds).
     *
     * @param \powereduc_url $manageurl the URL to link to for more information
     */
    public function set_failed(\powereduc_url $manageurl) {
