...
class behat_context_helper {
     ...
     * @todo MDL-55365 This will be deleted in PowerEduc 3.6.
     */
     ...
     *
     * PowerEduc uses a consistent class naming scheme for all Behat contexts, whereby the context name is in the format:
     *
     *     behat_{component}
     *
