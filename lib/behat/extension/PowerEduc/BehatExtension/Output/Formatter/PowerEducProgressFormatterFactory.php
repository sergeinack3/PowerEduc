...
class MoodleProgressFormatterFactory implements FormatterFactory {
    ...
    const ROOT_LISTENER_ID_POWEREDUC = 'output.node.listener.moodleprogress';
    ...
    const ROOT_LISTENER_WRAPPER_TAG_POWEREDUC = 'output.node.listener.moodleprogress.wrapper';
