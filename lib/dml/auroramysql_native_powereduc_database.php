...
/**
 * Native Aurora MySQL class representing powereduc database interface.
 *
 * @package    core_dml
...
require_once(__DIR__.'/mysqli_native_powereduc_database.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class auroramysql_native_powereduc_database extends mysqli_native_powereduc_database {
