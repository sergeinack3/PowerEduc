...
require_once(__DIR__.'/test_powereduc_database.php');
require_once(__DIR__.'/../../powereduc_read_slave_trait.php');

/**
 * Database driver test class with powereduc_read_slave_trait
 *
 * @package    core
 * @category   dml
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class read_slave_powereduc_database extends test_powereduc_database {
