 ...
 * @copyright   2021 David Matamoros <davidmc@powereduc.com> based on code from Marina Glancy
...
export const init = () => {
    ...
    tabToggle.on('click', (event) => {
        ...
        getStrings([
            {key: 'changesmade', component: 'powereduc'},
            {key: 'changesmadereallygoaway', component: 'powereduc'},
