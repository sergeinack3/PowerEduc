...
define(['jquery', 'core/config'], function($, config) {
    ...
    return /** @alias module:core/url */ {
        ...
        /**
         * Take a path relative to the powereduc basedir and do some fixing (see class powereduc_url in php).
         *
         * @method relativeUrl
         * @param {string} relativePath The path relative to the powereduc basedir.
