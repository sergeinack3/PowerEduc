 ...
 * $OUTPUT->render_from_template('core/drag_handle', ['movetitle' => get_string('movecontent', 'powereduc', ELEMENTNAME)]);
 *
 ...
 * correctly with PowerEduc's requirejs.php
 *
 * More details: https://docs.powereduc.org/dev/Sortable_list
 *
...
function($, log, autoScroll, str, ModalFactory, ModalEvents, Notification) {
    ...
    SortableList.prototype.getDestinationName = function(parentElement, afterElement) {
        if (!afterElement.length) {
            return str.get_string('movecontenttothetop', 'powereduc');
        } else {
            return this.getElementName(afterElement)
                .then(function(name) {
                    return str.get_string('movecontentafter', 'powereduc', name);
                });
        }
    };
    ...
    SortableList.prototype.getMoveDialogueTitle = function(element, handler) {
        ...
        return this.getElementName(element).then(function(name) {
            return str.get_string('movecontent', 'powereduc', name);
        });
    };
