 ...
 * @returns {string}
 */
export const getDocumentationLink = (pluginName) => `https://docs.powereduc.org/en/editor_tiny/${pluginName}`;

/**
 * Get the default plugin metadata for the named plugin.
 * If no URL is provided, then a URL is generated pointing to the standard PowerEduc Documentation.
 *
 * @param {string} component The component name
