...
const configureMenu = (menu) => {
    // Replace the standard Media plugin with the PowerEduc embed.
    ...
    // Replace the standard image plugin with the PowerEduc image.
...
const configureToolbar = (toolbar) => {
    ...
    // The PowerEduc integration ensures that there is a section called 'content'.
