...
class provider implements
     ...
     * @param   \powereduc_recordset $autosaves The recordset containing the data to export
     */
    protected static function export_autosaves(\stdClass $user, \powereduc_recordset $autosaves) {
