YUI.add('powereduc-editor_atto-menu', function (Y, NAME) {
 ...
 *
 * @module     powereduc-editor_atto-menu
 * @submodule  menu-base
 * @package    editor_atto
...
var LOGNAME = 'powereduc-editor_atto-menu';
var MENUDIALOGUE = '' +
...
/**
 * A Menu for the Atto editor used in PowerEduc.
 *
...
Y.extend(Menu, M.core.dialogue, {
    ...
    initializer: function(config) {
        ...
        var content = bb.one('.powereduc-dialogue-wrap');
        content.removeClass('powereduc-dialogue-wrap')
            .addClass('powereduc-dialogue-content');
...
}, '@VERSION@', {"requires": ["powereduc-core-notification-dialogue", "node", "event", "event-custom"]});
