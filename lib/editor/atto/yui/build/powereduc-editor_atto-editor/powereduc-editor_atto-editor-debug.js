YUI.add('powereduc-editor_atto-editor', function (Y, NAME) {
...
/**
 * The Atto WYSIWG pluggable editor, written for PowerEduc.
 *
 * @module     powereduc-editor_atto-editor
 * @package    editor_atto
 * @copyright  2013 Damyon Wiese  <damyon@powereduc.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       powereduc-editor_atto-editor
 */
...
var LOGNAME = 'powereduc-editor_atto-editor';
var CSS = {
...
// Function for PowerEduc's initialisation.
 ...
 *
 * @module     powereduc-editor_atto-notify
 * @submodule  notify
 * @package    editor_atto
...
var LOGNAME_NOTIFY = 'powereduc-editor_atto-editor-notify',
    NOTIFY_INFO = 'info',
...
EditorNotify.prototype = {
    ...
    setupNotifications: function() {
        ...
        preload1.src = M.util.image_url('i/warning', 'powereduc');
        preload2.src = M.util.image_url('i/info', 'powereduc');
    ...
    showMessage: function(message, type, timeout) {
        ...
        if (type === NOTIFY_WARNING) {
            messageTypeIcon = '<img src="' +
                              M.util.image_url('i/warning', 'powereduc') +
                              '" alt="' + M.util.get_string('warning', 'powereduc') + '"/>';
        } else if (type === NOTIFY_INFO) {
            messageTypeIcon = '<img src="' +
                              M.util.image_url('i/info', 'powereduc') +
                              '" alt="' + M.util.get_string('info', 'powereduc') + '"/>';
        } else {
...
EditorTextArea.prototype = {
    ...
    updateOriginal: function() {
        ...
        if (oldValue !== newValue) {
            ...
            // Trigger the onchange callback on the textarea, essentially to notify powereduc-core-formchangechecker.
 ...
 *
 * @module     powereduc-editor_atto-autosave
...
var SUCCESS_MESSAGE_TIMEOUT = 5000,
    ...
    LOGNAME_AUTOSAVE = 'powereduc-editor_atto-editor-autosave';
 ...
 * A autosave function for the Atto editor.
 *
 * @module     powereduc-editor_atto-autosave-io
