...
Feature: Add links to Atto
  ...
  Scenario: Insert a link without providing text to display
    ...
    When I open my profile in edit mode
    And I click on "Link" "button"
    And I set the field "Enter a URL" to "https://powereduc.org/"
    Then the field "Text to display" matches value "https://powereduc.org/"
    And I click on "Create link" "button"
    And I should see "https://powereduc.org/"
    And I click on "Link" "button"
    And the field "Text to display" matches value "https://powereduc.org/"
    And the field "Enter a URL" matches value "https://powereduc.org/"
    And I click on "Close" "button" in the "Create link" "dialogue"
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    And I should see "https://powereduc.org/</a>"
  ...
  Scenario: Insert a link with providing text to display
    ...
    When I open my profile in edit mode
    And I click on "Link" "button"
    And I set the field "Text to display" to "PowerEduc - Open-source learning platform"
    And I set the field "Enter a URL" to "https://powereduc.org/"
    And I click on "Create link" "button"
    Then I should see "PowerEduc - Open-source learning platform"
    And I click on "Link" "button"
    And the field "Text to display" matches value "PowerEduc - Open-source learning platform"
    And the field "Enter a URL" matches value "https://powereduc.org/"
    And I click on "Close" "button" in the "Create link" "dialogue"
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    And I should see "PowerEduc - Open-source learning platform</a>"
    And I should not see "https://powereduc.org/</a>"
  ...
  Scenario: Edit a link that already had a custom text to display
    ...
    And I press "Save changes"
    And I click on "Edit profile" "link" in the "region-main" "region"
    And I set the field "Description" to "<a href=\"https://powereduc.org/\">PowerEduc - Open-source learning platform</a>"
    And I click on "Update profile" "button"
    And I follow "Preferences" in the user menu
    And I follow "Editor preferences"
  ...
  Scenario: Insert a link for an image
    ...
    And I click on "HTML" "button"
    Then I should see "<a href=\"https://powereduc.org/\" title=\"PowerEduc - Open-source learning platform\"><img"
    And I click on "HTML" "button"
    And I select the text in the "Description" Atto editor
    And I press the shift left key
    And I click on "Insert or edit image" "button"
    And the field "Describe this image for someone who cannot see it" matches value "It's the PowerEduc"
