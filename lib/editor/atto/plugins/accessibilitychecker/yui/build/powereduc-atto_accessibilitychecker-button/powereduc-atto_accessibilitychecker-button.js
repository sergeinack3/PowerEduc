YUI.add('powereduc-atto_accessibilitychecker-button', function (Y, NAME) {
...
/**
 * @module powereduc-atto_accessibilitychecker-button
 */
...
}, '@VERSION@', {"requires": ["color-base", "powereduc-editor_atto-plugin"]});
