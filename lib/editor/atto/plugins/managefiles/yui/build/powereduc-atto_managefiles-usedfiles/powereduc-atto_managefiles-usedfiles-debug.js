YUI.add('powereduc-atto_managefiles-usedfiles', function (Y, NAME) {
...
/**
 * @module powereduc-atto_managefiles-usedfiles
 */
...
M.atto_managefiles.usedfiles = M.atto_managefiles.usedfiles || {
    ...
    init: function(config) {
        ...
        if (!form || !window.parent) {
            Y.log("Unable to find parent window", 'warn', 'powereduc-atto_managemedia-usedfiles');
            return;
        }
