 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class atto_managefiles_manage_form extends powereducform {
    ...
    function definition() {
        ...
        $PAGE->requires->yui_module('powereduc-atto_managefiles-usedfiles', 'M.atto_managefiles.usedfiles.init',
            array(array(
