YUI.add('powereduc-atto_media-button', function (Y, NAME) {
...
/**
 * @module powereduc-atto_media-button
 */
                ...
                '<legend class="d-flex align-items-center px-1">' +
                    '<div class="position-relative d-flex ftoggler align-items-center position-relative mr-1">' +
                        '<a role="button" data-toggle="collapse" href="#{{id}}" aria-expanded="false"' +
                            ...
                            '<span class="expanded-icon icon-no-margin p-2" title="{{get_string "collapse" "powereduc"}}">' +
                                '<i class="icon fa fa-chevron-down fa-fw " aria-hidden="true"></i>' +
                            '</span>' +
                            '<span class="collapsed-icon icon-no-margin p-2" title="{{get_string "expand" "powereduc"}}">' +
...
}, '@VERSION@', {"requires": ["powereduc-editor_atto-plugin", "powereduc-form-shortforms"]});
