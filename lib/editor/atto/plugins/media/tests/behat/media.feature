...
Feature: Add media to Atto
  ...
  Background:
    ...
    And I upload "lib/editor/atto/tests/fixtures/powereduc-logo.webm" file to "Files" filemanager
    And I upload "lib/editor/atto/tests/fixtures/powereduc-logo.mp4" file to "Files" filemanager
  ...
  Scenario: Insert some media as a link
    ...
    And I click on "powereduc-logo.webm" "link"
    And I click on "Select this file" "button"
    And the field "Enter name" matches value "powereduc-logo.webm"
    And I wait until the page is ready
    And I click on "Insert media" "button"
    When I click on "Save changes" "button"
    Then "//a[. = 'powereduc-logo.webm']" "xpath_element" should exist
  ...
  Scenario: Insert some media as a plain video
    ...
    And I click on "Private files" "link" in the ".fp-repo-area" "css_element"
    And I click on "powereduc-logo.mp4" "link"
    And I click on "Select this file" "button"
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'powereduc-logo.webm')]][descendant::source[contains(@src, 'powereduc-logo.mp4')]]" "xpath_element" should exist
  ...
  Scenario: Insert some media as a video with display settings
    ...
    And I click on "Private files" "link" in the ".powereduc-dialogue-base[aria-hidden='false'] .fp-repo-area" "css_element"
    And I click on "powereduc-logo.png" "link"
    And I click on "Select this file" "button" in the ".powereduc-dialogue-base[aria-hidden='false']" "css_element"
    ...
    And I click on "Display options" "link"
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'powereduc-logo.webm')]][contains(@poster, 'powereduc-logo.png')][@width=420][@height=69][@title='VideoTitle']" "xpath_element" should exist
  ...
  Scenario: Insert some media as a video with advanced settings
    ...
    When I click on "Insert media" "button"
    Then "//video[descendant::source[contains(@src, 'powereduc-logo.webm')]][@controls='true'][@loop='true'][@autoplay='true'][@autoplay='true']" "xpath_element" should exist
  ...
  Scenario: Insert some media as a plain audio
    ...
    And I click on "Select this file" "button"
    When I click on "Insert media" "button"
    Then "//audio[descendant::source[contains(@src, 'powereduc-logo.mp4')]]" "xpath_element" should exist
  ...
  Scenario: Insert some media as an audio with display settings
    ...
    When I click on "Insert media" "button"
    Then "//audio[descendant::source[contains(@src, 'powereduc-logo.mp4')]][@title='AudioTitle']" "xpath_element" should exist
  ...
  Scenario: Insert some media as an audio with advanced settings
    ...
    When I click on "Insert media" "button"
    Then "//audio[descendant::source[contains(@src, 'powereduc-logo.mp4')]][@controls='true'][@loop='true'][@autoplay='true'][@autoplay='true']" "xpath_element" should exist
