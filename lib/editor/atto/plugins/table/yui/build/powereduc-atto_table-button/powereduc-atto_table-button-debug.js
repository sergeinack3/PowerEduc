YUI.add('powereduc-atto_table-button', function (Y, NAME) {
...
/**
 * @module powereduc-atto_table-button
 */
...
}, '@VERSION@', {"requires": ["powereduc-editor_atto-plugin", "powereduc-editor_atto-menu", "event", "event-valuechange"]});
