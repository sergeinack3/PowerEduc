YUI.add('powereduc-atto_recordrtc-button', function (Y, NAME) {
...
/**
 * @module powereduc-atto_recordrtc-button
 */
...
}, '@VERSION@', {"requires": ["powereduc-editor_atto-plugin", "powereduc-atto_recordrtc-recording"]});
