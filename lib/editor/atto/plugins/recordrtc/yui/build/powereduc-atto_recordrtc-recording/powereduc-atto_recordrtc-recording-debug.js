YUI.add('powereduc-atto_recordrtc-recording', function (Y, NAME) {
        ...
        cm.uploadBtn.on('click', function() {
            ...
            if (cm.chunks.length === 0) {
                ...
                cm.upload_to_server(cm.recType, function(progress, fileURLOrError) {
                    ...
                    } else if (progress === 'upload-failed-404') { // 404 error = File too large in PowerEduc.
                        cm.uploadBtn.set('disabled', false);
...
M.atto_recordrtc.abstractmodule = {
    // A helper for making a PowerEduc alert appear.
    ...
    show_alert: function(subject, onCloseEvent) {
        Y.use('powereduc-core-notification-alert', function() {
...
}, '@VERSION@', {"requires": ["powereduc-atto_recordrtc-button"]});
