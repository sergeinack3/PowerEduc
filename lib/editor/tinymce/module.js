...
M.editor_tinymce.init_editor = function(Y, editorid, options) {
    ...
    // Load necessary PowerEduc plugins into editor.
    if (options.powereduc_init_plugins) {
        var extraplugins = options.powereduc_init_plugins.split(',');
    ...
    options.setup = function(editor) {
        ...
        Y.use('event', 'powereduc-core-event', function(Y) {
