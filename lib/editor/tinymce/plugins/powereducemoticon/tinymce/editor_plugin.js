/**
 * TinyMCE plugin PowerEducEmoticon - provides GUI to insert emoticon images.
 *
...
(function() {
    tinymce.create('tinymce.plugins.PowerEducEmoticon', {
        ...
        init : function(ed, url) {
            // Register the command so that it can be invoked by using tinyMCE.activeEditor.execCommand('mcePowerEducEmoticon');
            ed.addCommand('mcePowerEducEmoticon', function() {
                lang = ed.getParam('language');
                ed.windowManager.open({
                    file : ed.getParam("powereduc_plugin_base") + 'powereducemoticon/dialog.php?lang=' + lang ,
                    width : 250 + parseInt(ed.getLang('powereducemoticon.delta_width', 0)),
                    height : 400 + parseInt(ed.getLang('powereducemoticon.delta_height', 0)),
                    inline : 1
                }, {
            ...
            ed.onInit.add(function(ed) {
                ...
                this._emoticons = tinymce.util.JSON.parse(ed.getParam('powereducemoticon_emoticons'));
            ...
            // Register powereducemoticon button.
            ed.addButton('powereducemoticon', {
                title : 'powereducemoticon.desc',
                cmd : 'mcePowerEducEmoticon',
                image : url + '/img/powereducemoticon.png'
            });
        },
        ...
        getInfo : function() {
            return {
                longname : 'PowerEduc Emoticon plugin',
                author : 'David Mudrak',
    ...
    // Register plugin.
    tinymce.PluginManager.add('powereducemoticon', tinymce.plugins.PowerEducEmoticon);
})();
