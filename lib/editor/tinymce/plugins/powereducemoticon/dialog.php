...
/**
 * Displays the TinyMCE popup window to insert a PowerEduc emoticon
 *
...
$PAGE->set_url('/lib/editor/tinymce/plugins/powereducemoticon/dialog.php');

$emoticonmanager = get_emoticon_manager();
$stringmanager = get_string_manager();

$editor = get_texteditor('tinymce');
$plugin = $editor->get_plugin('powereducemoticon');
...
<head>
    <title><?php print_string('powereducemoticon:desc', 'tinymce_powereducemoticon'); ?></title>
