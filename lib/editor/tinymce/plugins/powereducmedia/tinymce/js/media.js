...
// No need to require lang packs in powereduc plugins.
...
function generatePreview(c) {
    ...
    pl = tinyMCEPopup.editor.plugins.powereducmedia._parse(pl);
    ...
    p.innerHTML = '<iframe src="' + tinyMCEPopup.editor.getParam("powereduc_plugin_base") + 'powereducmedia/preview.php'
