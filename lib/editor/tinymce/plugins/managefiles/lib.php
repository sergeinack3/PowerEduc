...
class tinymce_managefiles extends editor_tinymce_plugin {
    ...
    protected function update_init_params(array &$params, context $context,
        ...
        if ($row = $this->find_button($params, 'powereducmedia')) {
            // Add button after 'powereducmedia' button.
            $this->add_button_after($params, $row, 'managefiles', 'powereducmedia');
        } else if ($row = $this->find_button($params, 'image')) {
            // If 'powereducmedia' is not found add after 'image'.
