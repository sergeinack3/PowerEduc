...
(function() {
    tinymce.create('tinymce.plugins.PowerEducManageFiles', {
        /**
        ...
        init : function(ed, url) {
            ...
            ed.addCommand('mceManageFiles', function() {
                var managefiles = ed.getParam('managefiles', {}), key, cnt = 0,
                    fileurl = ed.getParam("powereduc_plugin_base") + 'managefiles/manage.php?';
        ...
        getInfo : function() {
            return {
                longname : 'PowerEduc Manage embedded files plugin',
                author : 'Marina Glancy',
    ...
    // Register plugin.
    tinymce.PluginManager.add('managefiles', tinymce.plugins.PowerEducManageFiles);
})();
