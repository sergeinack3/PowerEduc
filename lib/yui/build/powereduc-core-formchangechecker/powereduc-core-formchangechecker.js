YUI.add('powereduc-core-formchangechecker', function (Y, NAME) {

/**
 * A utility to check for form changes before navigating away from a page.
 *
 * @module powereduc-core-formchangechecker
 */
...
window.console.warn(
    'The powereduc-core-formchangechecker has been deprecated ' +
...
}, '@VERSION@', {"requires": ["base", "event-focus", "powereduc-core-event"]});
