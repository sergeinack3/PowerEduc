YUI.add('powereduc-core-tooltip', function (Y, NAME) {

/**
 * Provides the base tooltip class.
 *
 * @module powereduc-core-tooltip
 */
 ...
 * @static
 */
TOOLTIP.NAME = 'powereduc-core-tooltip';
 ...
 * @static
 */
TOOLTIP.CSS_PREFIX = 'powereduc-dialogue';
...
/**
  ...
  *
  * The supplid string will be wrapped in a div with the CSS.PANELTEXT class and a standard PowerEduc spinner
  * appended.
  *
...
Y.extend(TOOLTIP, M.core.dialogue, {
    ...
    initializer: function() {
        ...
        // set.
        this.bb.addClass('powereduc-dialogue-tooltip');
...
Y.Base.modifyAttrs(TOOLTIP, {
     ...
     *
     * PowerEduc override: We override this for tooltip to default it to false.
     *
     * @attribute Modal
     * @type Boolean
     * @default false
