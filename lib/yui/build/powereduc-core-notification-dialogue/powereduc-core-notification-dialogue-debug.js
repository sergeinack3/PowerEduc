YUI.add('powereduc-core-notification-dialogue', function (Y, NAME) {
...
M.core = M.core || {};
/**
 * The generic dialogue class for use in PowerEduc.
 *
 * @module powereduc-core-notification
 * @submodule powereduc-core-notification-dialogue
 */

var DIALOGUE_NAME = 'PowerEduc dialogue',
    DIALOGUE,
    ...
    DOT = '.',
    HAS_ZINDEX = 'powereduc-has-zindex',
...
/**
 * A re-usable dialogue box with PowerEduc classes applied.
 *
...
DIALOGUE = function(config) {
    ...
    var id = 'powereduc-dialogue-' + Y.stamp(this) + '-wrap'; // Can't use this.get('id') as it's not set at this stage.
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    centerDialogOnVisible: function() {
        ...
        if (this.name !== DIALOGUE_NAME) {
            return; // Only centre PowerEduc dialogues.
        }
    ...
    ATTRS: {
         ...
         * @type Boolean
         * @default true
         * @deprecated Since PowerEduc 2.7. Please use modal instead.
         */
        lightbox: {
            lazyAdd: false,
            setter: function(value) {
                Y.log("The lightbox attribute of M.core.dialogue has been deprecated since PowerEduc 2.7, " +
                      "please use the modal attribute instead",
                    'warn', 'powereduc-core-notification-dialogue');
        ...
        closeButtonTitle: {
            ...
            value: M.util.get_string('closebuttontitle', 'powereduc')
        },
...
Y.Base.modifyAttrs(DIALOGUE, {
     ...
     * `align` Attribute.
     *
     * Note: We override this in PowerEduc such that it sets a value for the
    ...
    id: {
        writeOnce: true,
        valueFn: function() {
            var id = 'powereduc-dialogue-' + Y.stamp(this);
            return id;
        }
    },
...
Y.extend(INFO, M.core.dialogue, {
    ...
    NAME: 'PowerEduc information dialogue',
    CSS_PREFIX: DIALOGUE_PREFIX
});
...
M.core.notification.info = INFO;
    ...
    "requires": [
        ...
        "event-key",
        "dd-plugin",
        "powereduc-core-widget-focusafterclose",
        "powereduc-core-lockscroll"
    ]
});
