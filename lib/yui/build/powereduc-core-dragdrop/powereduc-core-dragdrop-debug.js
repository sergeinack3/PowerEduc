YUI.add('powereduc-core-dragdrop', function (Y, NAME) {

/* eslint-disable no-empty-function */
/**
 * The core drag and drop module for PowerEduc which extends the YUI drag and
 * drop functionality with additional features.
 *
 * @module powereduc-core-dragdrop
 */
var MOVEICON = {
    pix: "i/move_2d",
    largepix: "i/dragdrop",
    component: 'powereduc',
    cssclass: 'powereduc-core-dragdrop-draghandle'
};
...
Y.extend(DRAGDROP, Y.Base, {
    ...
    find_element_text: function(n) {
        ...
        return M.util.get_string('emptydragdropregion', 'powereduc');
    },
    ...
    global_start_keyboard_drag: function(e, draghandle, dragcontainer) {
        ...
        var dialogtitle = M.util.get_string('movecontent', 'powereduc', nodetitle);
        ...
        droptargets.each(function(node) {
            ...
            if (validdrop) {
                ...
                if (this.samenodelabel && node.hasClass(this.samenodeclass)) {
                    ...
                    listitemtext = M.util.get_string('tocontent', 'powereduc', nodetitle);
                }
...
}, '@VERSION@', {"requires": ["base", "node", "io", "dom", "dd", "event-key", "event-focus", "powereduc-core-notification"]});
