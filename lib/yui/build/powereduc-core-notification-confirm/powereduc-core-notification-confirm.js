YUI.add('powereduc-core-notification-confirm', function (Y, NAME) {
 ...
 * @submodule powereduc-core-notification-confirm
 */

var CONFIRM_NAME = 'PowerEduc confirmation dialogue',
    CONFIRM;
...
Y.extend(CONFIRM, M.core.notification.info, {
    ...
    ATTRS: {
        ...
        yesLabel: {
            ...
            valueFn: function() {
                return M.util.get_string('yes', 'powereduc');
            },
        ...
        noLabel: {
            validator: Y.Lang.isString,
            valueFn: function() {
                return M.util.get_string('no', 'powereduc');
            },
            setter: function(value) {
                if (this._noButton) {
        ...
        title: {
            validator: Y.Lang.isString,
            value: M.util.get_string('confirm', 'powereduc')
        },
        ...
        question: {
            validator: Y.Lang.isString,
            valueFn: function() {
                return M.util.get_string('areyousure', 'powereduc');
            },
            setter: function(value) {
                if (this._question) {
