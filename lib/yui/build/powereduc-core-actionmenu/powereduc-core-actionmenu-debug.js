YUI.add('powereduc-core-actionmenu', function (Y, NAME) {

/**
 * Provides drop down menus for list of action links.
 *
 * @module powereduc-core-actionmenu
 */
...
ACTIONMENU.prototype = {
    ...
    handleKeyboardEvent: function(e) {
        ...
        if (e.keyCode === 27) {
            ...
            if (!found) {
                Y.log("Unable to find this menu item in the list of menu children", 'debug', 'powereduc-core-actionmenu');
                return;
            }
...
Y.extend(ACTIONMENU, Y.Base, ACTIONMENU.prototype, {
    NAME: 'powereduc-core-actionmenu',
    ATTRS: {
        align: {
            value: [
