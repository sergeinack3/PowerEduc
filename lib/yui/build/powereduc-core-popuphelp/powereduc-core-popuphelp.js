YUI.add('powereduc-core-popuphelp', function (Y, NAME) {

/**
 * A popup help dialogue for PowerEduc.
 *
 * @module powereduc-core-popuphelp
 */
...
var SELECTORS = {
        ...
        FOOTER: 'div.powereduc-dialogue-ft'
    },
...
POPUPHELP.NAME = 'powereduc-core-popuphelp';
...
Y.extend(POPUPHELP, Y.Base, {
    ...
    display_panel: function(e) {
        if (!this.panel) {
            this.panel = new M.core.tooltip({
                ...
                initialheadertext: M.util.get_string('loadinghelp', 'powereduc'),
                initialfootertext: ''
            });
        }
    ...
    set_footer: function(helpobject) {
        // Check for an optional link to documentation on powereduc.org.
...
}, '@VERSION@', {"requires": ["powereduc-core-tooltip"]});
