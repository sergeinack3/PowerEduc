Description of MatthiasMullie\Minify import into PowerEduc

1) Go to from https://github.com/matthiasmullie/minify/releases

Download lastest minify Source code (zip) and unzip
mv minify-X.Y.ZZ/src /path/to/powereduc/lib/minify/matthiasmullie-minify/
mv minify-X.Y.ZZ/data /path/to/powereduc/lib/minify/matthiasmullie-minify/
...
mv path-converter-A.B.C/src/ /path/to/powereduc/lib/minify/matthiasmullie-pathconverter/
...
MDL-68191: https://github.com/matthiasmullie/minify/issues/317 is a bug that stops
  ...
  NOTE: As of 2020/12/08, only the first commit was brought into PowerEduc
