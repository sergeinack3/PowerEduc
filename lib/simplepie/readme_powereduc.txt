Description of SimplePie library import into PowerEduc
...
2. Remove everything inside lib/simplepie/ directory except readme_powereduc.txt (this file) and powereduc_simplepie.php.
...
5. That should leave you with just the following. Do not move them. If there is any difference, check if they also need to be moved and update this doc:
    - idn (This is a third-party library that SimplePie can optionally use. We don't use this in PowerEduc)
    - src
    - CHANGELOG.md
    - composer.json
    - db.sql
