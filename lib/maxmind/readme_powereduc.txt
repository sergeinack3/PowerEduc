...
mv GeoIP2-php-X.Y.Z/src/ /path/to/powereduc/lib/maxmind/GeoIp2/
mv MaxMind-DB-Reader-php-X.Y.Z/src/MaxMind/ /path/to/powereduc/lib/maxmind/MaxMind/

4) Update other MaxMind related files:
mv MaxMind-DB-Reader-php-X.Y.Z/LICENSE /path/to/powereduc/lib/maxmind/MaxMind/
mv MaxMind-DB-Reader-php-X.Y.Z/CHANGELOG.md /path/to/powereduc/lib/maxmind/MaxMind/
mv MaxMind-DB-Reader-php-X.Y.Z/README.md /path/to/powereduc/lib/maxmind/MaxMind/
mv MaxMind-DB-Reader-php-X.Y.Z/composer.json /path/to/powereduc/lib/maxmind/MaxMind/
mv MaxMind-DB-Reader-php-X.Y.Z/autoload.php /path/to/powereduc/lib/maxmind/MaxMind/
