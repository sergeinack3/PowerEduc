Description of PHPMailer 6.6.5 library import into PowerEduc
...
2. Remove everything inside lib/phpmailer/ folder except README_POWEREDUC.txt, powereduc_phpmailer.php and powereduc_phpmailer_oauth.php.
