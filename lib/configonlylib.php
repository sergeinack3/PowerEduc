...
/**
 * Minimalistic library, usable even when no other powereduc libs are loaded.
 *
 ...
 * Can not use optional param because powereduclib.php is not loaded yet
 * @param string $name
 * @param mixed $default
 * @param string $type
 * @return mixed
 ...
 *
 * Note: Can not use optional param because powereduclib.php is not loaded yet.
 *
 * @param string $value
 * @param string $type
 * @return mixed
