...
1/ Download compressed and uncompressed jQuery JS from http://jquery.com/download/,
   ...
   delete old files
   edit plugins.php and lib/requirejs/powereduc-config.js
...
4/ Update the version of jquery in core_privacy\local\request\powereduc_content_writer::write_html_data() and privacy/templates/htmlpage.mustache.
