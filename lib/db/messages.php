 ...
 *     - Message API: {@link http://docs.powereduc.org/dev/Message_API}
...
$messageproviders = array (
    ...
    // cron-based notifications about available powereduc and/or additional plugin updates
    ...
    'courserequested' => array (
        'capability'  => 'powereduc/site:approvecourse'
    ),

    // Course request approval notification
    'courserequestapproved' => array (
         'capability'  => 'powereduc/course:request',
         'defaults' => array(
            'airnotifier' => MESSAGE_PERMITTED + MESSAGE_DEFAULT_ENABLED,
        ),
    ),
    ...
    'badgerecipientnotice' => array (
        ...
        'capability'  => 'powereduc/badges:earnbadge'
    ),
