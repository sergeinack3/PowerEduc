    ...
    Y.extend(FileManagerHelper, Y.Base, {
        ...
        initializer: function(options) {
            ...
            this.selectui = new M.core.dialogue({
                draggable    : true,
                headerContent: '<h3 id="' + labelid +'">' + M.util.get_string('edit', 'powereduc') + '</h3>',
        ...
        setup_buttons: function() {
            ...
            buttonDeleteFile.on('click', function(e) {
                ...
                dialogOptions.header = M.util.get_string('confirm', 'powereduc');
        ...
        setup_select_file: function() {
            ...
            selectnode.one('.fp-file-delete').on('click', function(e) {
                ...
                var dialog_options = {
                    scope: this,
                    header: M.util.get_string('confirm', 'powereduc'),
                };
                var params = {};
                var fileinfo = this.selectui.fileinfo;
        ...
        select_file: function(node) {
            ...
            Y.one('#fm-dialog-label_'+selectnode.get('id')).setContent(Y.Escape.html(M.util.get_string('edit', 'powereduc')+' '+nodename));
            // show panel
            this.selectui.show();
