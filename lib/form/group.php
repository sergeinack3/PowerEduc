 ...
 *
 * Overloaded {@link HTML_QuickForm_group} with default behavior modified for PowerEduc.
 *
 * @package   core_form
 * @category  form
 * @copyright 2007 Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class PowerEducQuickForm_group extends HTML_QuickForm_group implements templatable {
     ...
     */
    public function PowerEducQuickForm_group($elementName=null, $elementLabel=null, $elements=null, $separator=null, $appendName = true) {
     ...
     * This object is later used by {@link PowerEducQuickForm_group::createElement()}
     * @param null|PowerEducQuickForm $mform
     */
    public function setPowerEducForm($mform) {
        if ($mform && $mform instanceof PowerEducQuickForm) {
            $this->_mform = $mform;
        }
    }
     ...
     * storing the PowerEducQuickForm object, see {@link PowerEducQuickForm_group::setPowerEducForm()}
     *
     ...
     * Expects the same arguments as PowerEducQuickForm::createElement()
     */
