 ...
 */
abstract class dynamic_form extends \powereducform {
     ...
     * Example:
     *     $id = $this->optional_param('id', 0, PARAM_INT);
     *     return new powereduc_url('/my/page/where/form/is/used.php', ['id' => $id]);
     *
     * @return powereduc_url
     */
    abstract protected function get_page_url_for_dynamic_submission(): powereduc_url;
}
