...
class util {
     ...
     *
     * This is automatically called from various points in PowerEduc such as send_file_xx functions
     * in filelib.php.
     */
    public static function form_download_complete() {
        // If this doesn't look like a PowerEduc QuickForms request, ignore.
        $quickform = false;
        ...
        setcookie('powereducdownload_' . sesskey(), time());
    }
}
