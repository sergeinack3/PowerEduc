...
export const notifyUploadStarted = async elementId => {
    ...
    changesMadeString = await getString('changesmadereallygoaway', 'powereduc');
 ...
 * @returns {CustomEvent}
 * @fires uploadStarted
 * @deprecated Since PowerEduc 4.0 See {@link module:core_form/events.notifyUploadStarted notifyUploadStarted}
 */
 ...
 * @returns {CustomEvent}
 * @fires uploadCompleted
 * @deprecated Since PowerEduc 4.0 See {@link module:core_form/events.notifyUploadCompleted notifyUploadCompleted}
 */
 ...
 * List of the events.
 *
 * @deprecated since PowerEduc 4.0. See {@link module:core_form/events.eventTypes eventTypes} instead.
 **/
export const types = {
    uploadStarted: 'core_form/uploadStarted',
    uploadCompleted: 'core_form/uploadCompleted',
...
if (!legacyEventsRegistered) {
    ...
    Y.use('event', 'powereduc-core-event', () => {
