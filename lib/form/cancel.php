 ...
 *
 * Overloaded {@link PowerEducQuickForm_submit} with default behavior modified to cancel a form.
 *
 * @package   core_form
 * @category  form
 * @copyright 2007 Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class PowerEducQuickForm_cancel extends PowerEducQuickForm_submit
{
    /**
     * constructor
     *
     ...
     */
    public function PowerEducQuickForm_cancel($elementName=null, $value=null, $attributes=null) {
