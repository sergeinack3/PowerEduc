...
/**
 * Unit tests for PowerEducQuickForm_float
 *
 * Contains test cases for testing PowerEducQuickForm_float
 *
 * @package    core_form
 * @category   test
...
class float_test extends \advanced_testcase {
    ...
    public function test_exportValue() {
        $element = new PowerEducQuickForm_float('testel');
