...
/**
 * Unit tests for PowerEducQuickForm_date_time_selector
 *
 * Contains test cases for testing PowerEducQuickForm_date_time_selector
 *
 * @package    core_form
 * @category   test
...
use powereducform;
use PowerEducQuickForm_date_time_selector;
...
class datetimeselector_test extends \advanced_testcase {
    ...
    public function test_exportvalue() {
        ...
        foreach ($testvals as $vals) {
            ...
            $this->assertTrue($el instanceof PowerEducQuickForm_date_time_selector);
 ...
 */
class temp_form_datetime extends powereducform {
    /**
     * Form definition.
     */
