...
class language_menu implements \renderable, \templatable {
    ...
    /** @var powereduc_page $page the powereduc page that the languague menu belongs to */
    protected $page;
     ...
     *
     * @param powereduc_page $page the powereduc page that the languague menu belongs to.
     */
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        foreach ($this->langs as $langtype => $langname) {
            ...
            $node = [
                ...
                'link' => true,
                'isactive' => $isactive,
                'url' => $isactive ? new \powereduc_url('#') : new \powereduc_url($this->page->url, ['lang' => $langtype]),
            ];
            if (!empty($attributes)) {
