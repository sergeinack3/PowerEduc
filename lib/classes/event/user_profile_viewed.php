...
class user_profile_viewed extends base {
    ...
    public function get_url() {
        if ($this->contextlevel == CONTEXT_COURSE) {
            return new \powereduc_url('/user/view.php', array('id' => $this->relateduserid, 'course' => $this->courseid));
        }
        return new \powereduc_url('/user/profile.php', array('id' => $this->relateduserid));
    }
