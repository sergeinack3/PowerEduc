...
class note_created extends base {
    ...
    public function get_url() {
        $logurl = new \powereduc_url('/notes/index.php', array('course' => $this->courseid, 'user' => $this->relateduserid));
    ...
    protected function get_legacy_logdata() {
        $logurl = new \powereduc_url('index.php', array('course' => $this->courseid, 'user' => $this->relateduserid));
        $logurl->set_anchor('note-' . $this->objectid);
