...
class role_capabilities_updated extends base {
    ...
    public function get_url() {
        if ($this->contextlevel == CONTEXT_SYSTEM) {
            return new \powereduc_url('/admin/roles/define.php', array('action' => 'view', 'roleid' => $this->objectid));
        } else {
            return new \powereduc_url('/admin/roles/override.php', array('contextid' => $this->contextid,
