...
class capability_unassigned extends base {
    ...
    public function get_url() {
        if ($this->contextlevel == CONTEXT_SYSTEM) {
            return new \powereduc_url('/admin/roles/define.php', ['action' => 'view', 'roleid' => $this->objectid]);
        } else {
            return new \powereduc_url('/admin/roles/override.php', ['contextid' => $this->contextid,
