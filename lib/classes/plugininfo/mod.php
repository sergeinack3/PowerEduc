...
use powereduc_url, part_of_admin_tree, admin_settingpage;
...
class mod extends base {
     ...
     *
     * This exception for the Forum has been hard-coded in PowerEduc since ages,
    ...
    public static function get_manage_url() {
        return new powereduc_url('/admin/modules.php');
    }
