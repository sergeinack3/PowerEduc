...
use powereduc_url, part_of_admin_tree, admin_settingpage, admin_externalpage, core_plugin_manager;
...
class dataformat extends base {
    ...
    public static function get_manage_url() {
        return new powereduc_url('/admin/settings.php?section=managedataformats');
    }
