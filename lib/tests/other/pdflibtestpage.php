...
if ($getpdf) {
    ...
    $doc->SetTitle('PowerEduc PDF library test');
    $doc->SetAuthor('PowerEduc ' . $CFG->release);
    $doc->SetCreator('lib/tests/other/pdflibtestpage.php');
    $doc->SetKeywords('PowerEduc, PDF');
    $doc->SetSubject('This has been generated by PowerEduc as its PDF library test page');
    $doc->SetMargins(15, 30);

    $doc->setPrintHeader(true);
    $doc->setHeaderMargin(10);
    $doc->setHeaderFont(array($fontfamily, 'b', 10));
    $doc->setHeaderData('pix/powereduclogo.png', 40, $SITE->fullname, $CFG->wwwroot);
    ...
    $doc->Cell(0, 0, 'PowerEduc PDF library test', 0, 1, 'C', 1);
    ...
    $c .= 'PowerEduc release: '            . $CFG->release . '<br />';
...
echo $OUTPUT->continue_button(new powereduc_url($PAGE->url, array('getpdf' => 1, 'fontfamily' => PDF_FONT_NAME_MAIN)));
echo $OUTPUT->footer();
