// Miscellaneous core Javascript functions for PowerEduc
...
M.util.image_url = function(imagename, component) {
    ...
    if (!component || component == '' || component == 'powereduc' || component == 'core') {
        component = 'core';
    }
...
M.util.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
    ...
    if (this.div.hasClass('collapsed')) {
        ...
        this.icon = Y.Node.create('<img src="'+M.util.image_url(collapsedimage, 'powereduc')+'" alt="" />');
        // Shrink the div as it is collapsed by default
        this.div.setStyle('height', caption.get('offsetHeight')+'px');
    } else {
        // Add the correct image and record the YUI node created in the process
        this.icon = Y.Node.create('<img src="'+M.util.image_url('t/expanded', 'powereduc')+'" alt="" />');
    }
    a.append(this.icon);
    ...
    animation.on('end', function() {
        ...
        if (this.div.hasClass('collapsed')) {
            this.icon.set('src', M.util.image_url(collapsedimage, 'powereduc'));
        } else {
            this.icon.set('src', M.util.image_url('t/expanded', 'powereduc'));
        }
    }, this);
...
/**
 * Makes a best effort to connect back to PowerEduc to update a user preference,
 * however, there is no mechanism for finding out if the update succeeded.
 *
 * Before you can use this function in your JavsScript, you must have called
 * user_preference_allow_ajax_update from powereduclib.php to tell PowerEduc that
...
M.util.show_confirm_dialog = function(e, args) {
    ...
    require(['core_form/changechecker'], function(FormChangeChecker) {
        ...
        YUI().use('powereduc-core-notification-confirm', function(Y) {
    ...
    Y.use('node', 'event-mouseenter', function(){
        ...
        var colourpicker = {
            ...
            init : function() {
                ...
                this.image.setAttribute('src', M.util.image_url('i/colourpicker', 'powereduc'));
        ...
        M.util.block_hider = M.util.block_hider || (function(){
            ...
            Y.extend(blockhider, Y.Base, blockhider.prototype, {
                ...
                ATTRS : {
                    ...
                    preference : {},
                    iconVisible : {
                        value : M.util.image_url('t/switch_minus', 'powereduc')
                    },
                    iconHidden : {
                        value : M.util.image_url('t/switch_plus', 'powereduc')
                    },
                    block : {
 ...
 */
YUI.add('powereduc-core-io', function(Y) {
 ...
 * same way as PHP get_string() in PowerEduc does.
 *
...
M.util.add_lightbox = function(Y, node) {
    var WAITICON = {'pix':"i/loading_small",'component':'powereduc'};
...
/**
 * @deprecated since PowerEduc 3.3, but shouldn't be used in earlier versions either.
 */
