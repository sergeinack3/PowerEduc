...
class file_info_context_course extends file_info {
    ...
    public function get_file_info($component, $filearea, $itemid, $filepath, $filename) {
        ...
        if (!$this->course->visible and !has_capability('powereduc/course:viewhiddencourses', $this->context)) {
            return null;
        }
    ...
    protected function get_area_course_summary($itemid, $filepath, $filename) {
        ...
        if (!has_capability('powereduc/course:update', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
    ...
    protected function get_area_course_legacy($itemid, $filepath, $filename) {
        if (!has_capability('powereduc/course:managefiles', $this->context)) {
            return null;
        }
    ...
    protected function get_area_backup_course($itemid, $filepath, $filename) {
        ...
        if (!has_capability('powereduc/backup:backupcourse', $this->context) and !has_capability('powereduc/restore:restorecourse', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
    ...
    protected function get_area_backup_automated($itemid, $filepath, $filename) {
        ...
        if (!has_capability('powereduc/restore:viewautomatedfilearea', $this->context)) {
            return null;
        }
        if (is_null($itemid)) {
            return $this;
        ...
        $downloadable = has_capability('powereduc/backup:downloadfile', $this->context) &&
                        has_capability('powereduc/restore:userinfo', $this->context);
        $uploadable   = false;
