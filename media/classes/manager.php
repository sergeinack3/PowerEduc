...
final class core_media_manager {
     ...
     *
     * Note as of PowerEduc 3.3, this will call setup for you.
     *
    ...
    /**
     * @deprecated since PowerEduc 3.3. The setup is now done in ::instance() so there is no need to call this.
     */
