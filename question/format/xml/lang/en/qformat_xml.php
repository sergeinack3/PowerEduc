...
/**
 * Strings for component 'qformat_xml', language 'en', branch 'POWEREDUC_20_STABLE'
 *
 * @package    qformat_xml
...
$string['pluginname'] = 'PowerEduc XML format';
$string['pluginname_help'] = 'This is a PowerEduc-specific format for importing and exporting questions.';
