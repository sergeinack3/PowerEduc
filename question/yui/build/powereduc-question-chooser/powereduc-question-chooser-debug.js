YUI.add('powereduc-question-chooser', function (Y, NAME) {
 ...
 *
 * @module powereduc-question-chooser
 */

Y.log("The powereduc-question-chooser module has been deprecated. " +
    "Please use powereduc-qbank_editquestion-chooser instead.", 'powereduc-core-notification', 'warn');
...
}, '@VERSION@', {"requires": ["powereduc-core-chooserdialogue"]});
