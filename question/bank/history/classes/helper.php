...
class helper {
     ...
     */
    public static function question_history_url(int $entryid, string $returnrul, int $courseid): \powereduc_url {
        $params = [
            'entryid' => $entryid,
            'returnurl' => $returnrul,
            'courseid' => $courseid
        ...
        return new \powereduc_url('/question/bank/history/history.php', $params);
    }
