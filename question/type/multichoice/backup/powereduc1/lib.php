 ...
 */
class powereduc1_qtype_multichoice_handler extends powereduc1_qtype_handler {
     ...
     * @param int $oldquestiontextformat - {@see powereduc1_question_bank_handler::process_question()}
    ...
    protected function write_multichoice(array $multichoices, $oldquestiontextformat, $questionid) {
        ...
        foreach ($multichoices as $multichoice) {
            // Append an artificial 'id' attribute (is not included in powereduc.xml).
