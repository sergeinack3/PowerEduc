...
class answer_test extends \advanced_testcase {
    public function test_within_tolerance_nominal() {
        $answer = new qtype_numerical_answer(13, 7.0, 1.0, '', FORMAT_POWEREDUC, 1.0);
    ...
    public function test_within_tolerance_nominal_zero() {
        ...
        $answer = new qtype_numerical_answer(13, 1e-20, 1.0, '', FORMAT_POWEREDUC, 0.0);
        ...
        $answer = new qtype_numerical_answer(13, 0.0, 1.0, '', FORMAT_POWEREDUC, 1e-24);
        ...
        $answer = new qtype_numerical_answer(13, 1e-20, 1.0, '', FORMAT_POWEREDUC, 1e-24);
    ...
    public function test_within_tolerance_blank() {
        $answer = new qtype_numerical_answer(13, 1234, 1.0, '', FORMAT_POWEREDUC, '');
    ...
    public function test_within_tolerance_relative() {
        $answer = new qtype_numerical_answer(13, 7.0, 1.0, '', FORMAT_POWEREDUC, 0.1);
