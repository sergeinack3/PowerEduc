...
$url = new powereduc_url('/grade/import/key.php', ['courseid' => $courseid, 'id' => $id]);
$PAGE->set_url($url);
...
$PAGE->navbar->add($strimportgrades, new powereduc_url(new powereduc_url('/grade/import/index.php', ['id' => $courseid])));
$PAGE->navbar->add($strkeys, new powereduc_url('/grade/import/keymanager.php', ['id' => $courseid]));
