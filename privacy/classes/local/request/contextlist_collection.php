...
class contextlist_collection implements \Iterator, \Countable {
    ...
    public function add_contextlist(contextlist_base $contextlist) {
        ...
        if (empty($component)) {
            throw new \powereduc_exception("The contextlist must have a component set");
        }
        if (isset($this->contextlists[$component])) {
            throw new \powereduc_exception("A contextlist has already been added for the '{$component}' component");
        }
