 ...
 */
class powereduc1_mod_choice_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHOICE does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'choice', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHOICE',
                array(
                    'renamefields' => array(
                        'text' => 'intro',
                        'format' => 'introformat',
            ...
            new convert_path('choice_options', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHOICE/OPTIONS'),
            new convert_path('choice_option', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHOICE/OPTIONS/OPTION'),
        );
    }

    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHOICE
     * data available
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHOICE/OPTIONS/OPTION
     * data available
     */
