...
require_once($CFG->dirroot . '/mod/choice/backup/powereduc2/backup_choice_stepslib.php');
require_once($CFG->dirroot . '/mod/choice/backup/powereduc2/backup_choice_settingslib.php');
