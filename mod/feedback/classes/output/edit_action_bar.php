...
class edit_action_bar extends base_action_bar {
     ...
     */
    public function __construct(int $cmid, powereduc_url $pageurl, ?int $lastposition = null) {
    ...
    public function get_items(): array {
        $url = new powereduc_url('/mod/feedback/view.php', ['id' => $this->cmid]);
        ...
        if (has_capability('mod/feedback:edititems', $this->context)) {
            ...
            $templateurl = new powereduc_url('/mod/feedback/manage_templates.php', $this->urlparams);
            $importurl = new powereduc_url('/mod/feedback/import.php', $this->urlparams);
            ...
            if ($this->currenturl->compare(new powereduc_url('/mod/feedback/use_templ.php'), URL_MATCH_BASE)) {
            ...
            if ($viewquestions) {
                $select = new single_select(new powereduc_url('/mod/feedback/edit_item.php',
                ...
                $exporturl = new powereduc_url('/mod/feedback/export.php', $this->urlparams + ['action' => 'exportfile']);
