 ...
 */
class powereduc1_mod_feedback_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/FEEDBACK does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'feedback', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/FEEDBACK',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
            ...
            new convert_path(
                'feedback_item', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/FEEDBACK/ITEMS/ITEM',
                array (
                    'newfields' => array(
                        'label' => '',
                        'options' => '',
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/FEEDBACK
     * data available
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/FEEDBACK/ITEMS/ITEM
     * data available
     */
