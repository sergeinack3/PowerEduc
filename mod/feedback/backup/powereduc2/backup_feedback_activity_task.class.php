...
require_once($CFG->dirroot . '/mod/feedback/backup/powereduc2/backup_feedback_stepslib.php');
require_once($CFG->dirroot . '/mod/feedback/backup/powereduc2/backup_feedback_settingslib.php');
