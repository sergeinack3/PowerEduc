...
/**
 * imscp conversion handler. This resource handler is called by powereduc1_mod_resource_handler
 *
 * @copyright  2011 Andrew Davis <andrew@powereduc.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class powereduc1_mod_imscp_handler extends powereduc1_resource_successor_handler {

    /** @var powereduc1_file_manager the file manager instance */
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $imscp['intro'] = powereduc1_converter::migrate_referenced_files($imscp['intro'], $this->fileman);
