 ...
 */
class powereduc1_mod_scorm_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/SCORM does not
    ...
    public function get_paths() {
        return array(
            new convert_path('scorm', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/SCORM',
                array(
                    'newfields' => array(
                        'whatgrade' => 0,
                        'scormtype' => 'local',
            ...
            new convert_path('scorm_sco', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/SCORM/SCOES/SCO')
        );
    }

    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/SCORM
     * data available
     */
    public function process_scorm($data) {
        ...
        if ($backupinfo['powereduc_version'] < 2007110503) {
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/SCORM/SCOES/SCO
     * data available
     */
