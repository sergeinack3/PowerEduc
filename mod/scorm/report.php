...
$url = new powereduc_url('/mod/scorm/report.php');

$url->param('id', $id);
if (empty($mode)) {
    $mode = reset($reportlist);
} else if (!in_array($mode, $reportlist)) {
    throw new \powereduc_exception('erroraccessingreport', 'scorm');
}
$url->param('mode', $mode);
...
navigation_node::override_active_url(new powereduc_url('/mod/scorm/report.php', ['id' => $id]));
