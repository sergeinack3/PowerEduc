...
/**
 * Folder conversion handler. This resource handler is called by powereduc1_mod_resource_handler
 */
class powereduc1_mod_folder_handler extends powereduc1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $folder['intro'] = powereduc1_converter::migrate_referenced_files($folder['intro'], $this->fileman);
