 ...
 * Based off of a template @ http://docs.powereduc.org/dev/Backup_1.9_conversion_for_developers
 *
 * @package    mod_assignment
 * @copyright  2011 Aparup Banerjee <aparup@powereduc.com>
 ...
 */
class powereduc1_mod_assignment_handler extends powereduc1_mod_handler {

    /** @var powereduc1_file_manager */
    ...
    /** @var array of a powereduc1_assignment_[subplugin_name]_handler instances */
    private $subpluginhandlers = null;

    /**
     * Declare the paths in powereduc.xml we are able to convert
     *
     * The method returns list of {@link convert_path} instances.
     * For each path returned, the corresponding conversion method must be
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT does not
     * actually exist in the file. The last element with the module name was
     * appended by the powereduc1_converter class.
     *
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'assignment', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT',
                array(
                    'renamefields' => array(
                        'description' => 'intro',
                        'format' => 'introformat',
            ...
            //new convert_path('assignment_submission', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT/SUBMISSIONS/SUBMISSION')
        );
    }

    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT
     * data available
     */
    public function process_assignment($data) {
        ...
        $data['intro'] = powereduc1_converter::migrate_referenced_files($data['intro'], $this->fileman);
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/ASSIGNMENT/SUBMISSIONS/SUBMISSION
     * data available
     */
     ...
     * @return powereduc1_assignment_subplugin_handler the instance of the handler
     */
    protected function get_subplugin_handler($subplugin) {
        ...
        if (is_null($this->subpluginhandlers)) {
            ...
            foreach ($subplugins as $name => $dir) {
                ...
                $handlerclass = "powereduc1_mod_assignment_{$name}_subplugin_handler";
                ...
                if (!$this->subpluginhandlers[$name] instanceof powereduc1_assignment_subplugin_handler) {
                    throw new powereduc1_convert_exception('wrong_handler_class', get_class($this->subpluginhandlers[$name]));
                }
            }
        }
        ...
        if (!isset($this->subpluginhandlers[$subplugin])) {
            ...
            $this->subpluginhandlers[$subplugin] = new powereduc1_assignment_unsupported_subplugin_handler($this, $subplugin);
        }
 ...
 */
abstract class powereduc1_assignment_subplugin_handler extends powereduc1_submod_handler {

    /**
     * @param powereduc1_mod_handler $assignmenthandler the handler of a module we are subplugin of
     * @param string $subpluginname the name of the subplugin
     */
    public function __construct(powereduc1_mod_handler $assignmenthandler, $subpluginname) {
 ...
 */
class powereduc1_assignment_unsupported_subplugin_handler extends powereduc1_assignment_subplugin_handler {
}
