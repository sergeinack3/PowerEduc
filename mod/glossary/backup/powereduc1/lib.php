 ...
 */
class powereduc1_mod_glossary_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/GLOSSARY does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'glossary', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/GLOSSARY',
                array(
                    'newfields' => array(
            ...
            new convert_path('glossary_categories', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES'),
            new convert_path(
                'glossary_category', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES/CATEGORY',
                array(
                    'dropfields' => array(
                        'glossaryid'
                    )
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/GLOSSARY
     * data available
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/GLOSSARY/CATEGORIES/CATEGORY
     * data available
     */
