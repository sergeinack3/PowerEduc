...
require_once($CFG->dirroot . '/mod/forum/backup/powereduc2/backup_forum_stepslib.php');
require_once($CFG->dirroot . '/mod/forum/backup/powereduc2/backup_forum_settingslib.php');
