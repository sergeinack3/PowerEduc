 ...
 */
class powereduc1_mod_forum_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the paths /POWEREDUC_BACKUP/COURSE/MODULES/MOD/FORUM do not
    ...
    public function get_paths() {
        return array(
            new convert_path('forum', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/FORUM',
                array(
                    'renamefields' => array(
    ...
    /**
     * Converts /POWEREDUC_BACKUP/COURSE/MODULES/MOD/FORUM data
     */
