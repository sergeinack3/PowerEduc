...
class url {
     ...
     */
    public function get_course_url_from_courseid(int $courseid) : powereduc_url {
        return new powereduc_url('/course/view.php', [
            'id' => $courseid,
        ]);
    }
     ...
     * @return powereduc_url
     */
    public function get_course_url_from_forum(forum_entity $forum) : powereduc_url {
     ...
     * @return powereduc_url
     */
    public function get_discussion_create_url(forum_entity $forum) : powereduc_url {
        return new powereduc_url('/mod/forum/post.php', [
            'forum' => $forum->get_id(),
        ]);
    }
    ...
    public function get_forum_view_url_from_forum(forum_entity $forum, ?int $pageno = null,
            ?int $sortorder = null) : powereduc_url {
    ...
    public function get_forum_view_url_from_course_module_id(int $coursemoduleid, ?int $pageno = null,
        ...
        $url = new powereduc_url('/mod/forum/view.php', [
            'id' => $coursemoduleid,
        ]);
     ...
     * @return powereduc_url
     */
    public function get_discussion_view_url_from_discussion_id(int $discussionid) : powereduc_url {
        return new powereduc_url('/mod/forum/discuss.php', [
            'd' => $discussionid
        ]);
    }
     ...
     * @return powereduc_url
     */
    public function get_discussion_view_url_from_discussion(discussion_entity $discussion) : powereduc_url {
    ...
    public function get_discussion_view_latest_post_url_from_discussion(discussion_entity $discussion, ?int $latestpost) {
        ...
        if (null === $latestpost) {
            ...
            return new powereduc_url($viewurl, ['parent' => $latestpost]);
        }
    }
     ...
     * @return powereduc_url
     */
    public function get_discussion_view_url_from_post(post_entity $post) : powereduc_url {
     ...
     * @return powereduc_url
     */
    public function get_view_post_url_from_post_id(int $discussionid, int $postid) : powereduc_url {
     ...
     * @return powereduc_url
     */
    public function get_view_post_url_from_post(post_entity $post) : powereduc_url {
     ...
     * @return powereduc_url
     */
    public function get_view_isolated_post_url_from_post_id(int $discussionid, int $postid) : powereduc_url {
        $url = $this->get_discussion_view_url_from_discussion_id($discussionid);
     ...
     * @return powereduc_url
     */
    public function get_view_isolated_post_url_from_post(post_entity $post) : powereduc_url {
     ...
     * @return powereduc_url
     */
    public function get_edit_post_url_from_post(forum_entity $forum, post_entity $post) : powereduc_url {
     ...
     * @return powereduc_url
     */
    public function get_split_discussion_at_post_url_from_post(post_entity $post) : powereduc_url {
        return new powereduc_url('/mod/forum/post.php', [
            'prune' => $post->get_id()
        ]);
    }
     ...
     * @return powereduc_url
     */
    public function get_delete_post_url_from_post(post_entity $post) : powereduc_url {
        return new powereduc_url('/mod/forum/post.php', [
            'delete' => $post->get_id()
        ]);
    }
     ...
     * @return powereduc_url
     */
    public function get_reply_to_post_url_from_post(post_entity $post) : powereduc_url {
        return new powereduc_url('/mod/forum/post.php#mformforum', [
            'reply' => $post->get_id()
        ]);
    }
     ...
     * @return powereduc_url
     */
    public function get_export_post_url_from_post(post_entity $post) : ?powereduc_url {
        global $CFG;
        ...
        $url = $button->to_html(PORTFOLIO_ADD_POWEREDUC_URL);
        return $url ?: null;
    }
     ...
     * @return powereduc_url
     */
    public function get_mark_post_as_read_url_from_post(post_entity $post, int $displaymode = FORUM_MODE_THREADED) : powereduc_url {
        $params = [
        ...
        $url = new powereduc_url('/mod/forum/discuss.php', $params);
     ...
     * @return powereduc_url
     */
    public function get_mark_post_as_unread_url_from_post(post_entity $post, int $displaymode = FORUM_MODE_THREADED) : powereduc_url {
        $params = [
            'd' => $post->get_discussion_id(),
            'postid' => $post->get_id(),
            'mark' => 'unread'
     ...
     */
    public function get_export_attachment_url_from_post_and_attachment(post_entity $post, stored_file $attachment) : ?powereduc_url {
        global $CFG;
     ...
     * @return powereduc_url
     */
    public function get_author_profile_url(author_entity $author, int $courseid) : powereduc_url {
        return new powereduc_url('/user/view.php', [
            'id' => $author->get_id(),
            'course' => $courseid
        ]);
    }
     ...
     * @return powereduc_url
     */
    public function get_author_group_url(\stdClass $group) : powereduc_url {
        return new powereduc_url('/user/index.php', [
                'id' => $group->courseid,
                'group' => $group->id
        ]);
    }
    ...
    public function get_mark_discussion_as_read_url_from_discussion(
        ...
        return new powereduc_url('/mod/forum/markposts.php', [
     ...
     * @return powereduc_url
     */
    public function get_mark_all_discussions_as_read_url(forum_entity $forum) : powereduc_url {
        return new powereduc_url('/mod/forum/markposts.php', [
            'f' => $forum->get_id(),
            'mark' => 'read',
            'sesskey' => sesskey(),
     ...
     * @return powereduc_url
     */
    public function get_discussion_subscribe_url(discussion_entity $discussion) : powereduc_url {
        return new powereduc_url('/mod/forum/subscribe.php', [
            'sesskey' => sesskey(),
     ...
     */
    public function get_pin_discussion_url_from_discussion(discussion_entity $discussion) : powereduc_url {
        return new powereduc_url('discuss.php', [
            'sesskey' => sesskey(),
            'd' => $discussion->get_id(),
