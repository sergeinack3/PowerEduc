...
class page_viewed extends \core\event\base {
    ...
    public function get_url() {
        if (!empty($this->data['other']['wid'])) {
            return new \powereduc_url('/mod/wiki/view.php', array('wid' => $this->data['other']['wid'],
            ...
            return new \powereduc_url('/mod/wiki/prettyview.php', array('pageid' => $this->objectid));
        } else {
            return new \powereduc_url('/mod/wiki/view.php', array('pageid' => $this->objectid));
        }
    }
