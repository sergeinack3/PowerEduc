...
class collaborative_page extends \core_search\base_mod {
    ...
    public function get_document($record, $options = array()) {
        ...
        // Convert to text.
        $content = content_to_text($page->cachedcontent, FORMAT_POWEREDUC);
    ...
    public function get_doc_url(\core_search\document $doc) {
        ...
        return new \powereduc_url('/mod/wiki/view.php', $params);
    }
    ...
    public function get_context_url(\core_search\document $doc) {
        ...
        return new \powereduc_url('/mod/wiki/view.php', array('id' => $contextmodule->instanceid));
    }
