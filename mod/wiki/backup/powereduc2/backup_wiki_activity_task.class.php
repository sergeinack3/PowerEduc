...
require_once($CFG->dirroot . '/mod/wiki/backup/powereduc2/backup_wiki_stepslib.php');
require_once($CFG->dirroot . '/mod/wiki/backup/powereduc2/backup_wiki_settingslib.php');
