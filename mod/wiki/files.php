...
$url = new powereduc_url('/mod/wiki/files.php', ['pageid' => $pageid]);
$PAGE->set_url($url);
...
if (has_capability('mod/wiki:managefiles', $context)) {
    echo $OUTPUT->single_button(new powereduc_url('/mod/wiki/filesedit.php', array('subwiki'=>$subwiki->id, 'pageid'=>$pageid)), get_string('editfiles', 'wiki'), 'get');
}
echo $OUTPUT->footer();
