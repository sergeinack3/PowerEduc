...
class PowerEducQuickForm_wikifiletable extends HTML_QuickForm_element {
     ...
     */
    public function PowerEducQuickForm_wikifiletable($elementName = null, $elementLabel = null, $attributes = null, $fileinfo = null, $format = null) {
...
//register wikieditor
PowerEducQuickForm::registerElementType('wikifiletable', $CFG->dirroot."/mod/wiki/editors/wikifiletable.php", 'PowerEducQuickForm_wikifiletable');
