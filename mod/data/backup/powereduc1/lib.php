 ...
 */
class powereduc1_mod_data_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/DATA does not
    ...
    public function get_paths() {
        return array(
            new convert_path('data', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/DATA',
                        array(
                            'newfields' => array(
                                'introformat' => 0,
                                'assesstimestart' => 0,
            ...
            new convert_path('data_field', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/DATA/FIELDS/FIELD')
        );
    }

    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/DATA
     * data available
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/DATA/FIELDS/FIELD
     * data available
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/DATA/RECORDS/RECORD
     * data available
     */
