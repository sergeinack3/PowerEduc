...
require_once($CFG->dirroot . '/mod/workshop/backup/powereduc2/backup_workshop_settingslib.php');
require_once($CFG->dirroot . '/mod/workshop/backup/powereduc2/backup_workshop_stepslib.php');
