 ...
 */
class powereduc1_mod_book_handler extends powereduc1_mod_handler {
     ...
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/BOOK does not
    ...
    public function get_paths() {
        return array(
            new convert_path('book', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/BOOK',
                    array(
                        'renamefields' => array(
                            'summary' => 'intro',
                        ),
            ...
            new convert_path('book_chapters', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/BOOK/CHAPTERS/CHAPTER',
                    array(
                        'newfields' => array(
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/BOOK
     * data available
     * @param array $data
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/BOOK/CHAPTERS/CHAPTER
     * data available
     * @param array $data
     */
    public function process_book_chapters($data) {
        ...
        $data['content'] = powereduc1_converter::migrate_referenced_files($data['content'], $this->fileman);
