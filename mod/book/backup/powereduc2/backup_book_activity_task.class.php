...
require_once($CFG->dirroot.'/mod/book/backup/powereduc2/backup_book_stepslib.php');    // Because it exists (must)
require_once($CFG->dirroot.'/mod/book/backup/powereduc2/backup_book_settingslib.php'); // Because it exists (optional)
