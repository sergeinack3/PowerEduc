...
class user_submission_actionmenu implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if ($this->showedit) {
            $url = new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'editsubmission']);
            ...
            if ($status !== ASSIGN_SUBMISSION_STATUS_NEW && $status !== ASSIGN_SUBMISSION_STATUS_REOPENED) {
                $url = new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'removesubmissionconfirm']);
            ...
            if ($status === ASSIGN_SUBMISSION_STATUS_NEW) {
                ...
                if ($this->timelimit && empty($this->submission->timestarted)) {
                    ...
                    $beginbutton = new \action_link(
                        new powereduc_url('/mod/assign/view.php', $urlparams),
                            get_string('beginassignment', 'assign'),
                            $confirmation,
        ...
        if ($this->showsubmit) {
            $url = new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'submit']);
