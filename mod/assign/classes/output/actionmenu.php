...
class actionmenu implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        return [
            'submissionlink' => (new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'grading']))->out(false),
            'gradelink' => (new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'grader']))->out(false)
        ];
    }
