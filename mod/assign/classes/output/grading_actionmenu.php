...
class grading_actionmenu implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        if ($this->submissionpluginenabled && $this->submissioncount) {
            $downloadall = (new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid, 'action' => 'downloadall']))->out(false);
        }
        return [
            'back' => (new powereduc_url('/mod/assign/view.php', ['id' => $this->cmid]))->out(false),
