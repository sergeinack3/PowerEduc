...
/**
 * This file contains the powereduc hooks for the submission comments plugin
 *
...
/**
 *
 * Callback method for data validation---- required method for AJAXpowereduc based comment API
 *
...
/**
 * Permission control method for submission plugin ---- required method for AJAXpowereduc based comment API
 *
 * @param stdClass $options
 * @return array
 */
