...
$string['graderecentlymodified'] = 'The grade has been modified in PowerEduc more recently than in the grading worksheet for {$a}';
...
$string['ignoremodified'] = 'Allow updating records that have been modified more recently in PowerEduc than in the spreadsheet.';
$string['ignoremodified_help'] = 'When the grading worksheet is downloaded from PowerEduc it contains the last modified date for each of the grades. If any of the grades are updated in PowerEduc after this worksheet is downloaded, by default PowerEduc will refuse to overwrite this updated information when importing the grades. By selecting this option PowerEduc will disable this safety check and it may be possible for multiple markers to overwrite each others grades.';
$string['importgrades'] = 'Confirm changes in grading worksheet';
$string['invalidgradeimport'] = 'PowerEduc could not read the uploaded worksheet. Make sure it is saved in comma separated value format (.csv) and try again.';
