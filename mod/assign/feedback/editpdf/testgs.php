...
$PAGE->set_url(new powereduc_url('/mod/assign/feedback/editpdf/testgs.php'));
...
$PAGE->navbar->add(get_string('pluginname', 'assignfeedback_editpdf'), new powereduc_url('/admin/settings.php?section=assignfeedback_editpdf'));
...
switch ($result->status) {
    case assignfeedback_editpdf\pdf::GSPATH_OK:
        ...
        $imgurl = new powereduc_url($PAGE->url, array('sendimage' => 1));
...
$returl = new powereduc_url('/admin/settings.php', array('section' => 'assignfeedback_editpdf'));
