YUI.add('powereduc-assignfeedback_editpdf-editor', function (Y, NAME) {
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME: 'powereduc-assignfeedback_editpdf-editor',
    ATTRS: {
        userid: {
...
M.assignfeedback_editpdf.editor.init = M.assignfeedback_editpdf.editor.init || function(params) {
    ...
    "requires": [
        ...
        "powereduc-core-notification-dialog",
        "powereduc-core-notification-alert",
        "powereduc-core-notification-warning",
