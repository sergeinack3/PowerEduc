 ...
 */
class powereduc1_mod_chat_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHAT does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'chat', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHAT',
                array(
                    'newfields' => array(
                        'introformat' => 0
                    )
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHAT
     * data available
     */
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/CHAT/MESSAGES/MESSAGE
     * data available
     */
