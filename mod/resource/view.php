...
if ($redirect && !course_get_format($course)->has_view_page() &&
        (has_capability('powereduc/course:manageactivities', $context) ||
        has_capability('powereduc/course:update', context_course::instance($course->id)))) {
    $redirect = false;
}
...
if ($redirect && !$forceview) {
    ...
    $fullurl = powereduc_url::make_file_url('/pluginfile.php', $path, $displaytype == RESOURCELIB_DISPLAY_DOWNLOAD);
    redirect($fullurl);
}
