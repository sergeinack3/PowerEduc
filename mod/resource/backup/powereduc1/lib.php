 ...
 */
class powereduc1_mod_resource_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the paths /POWEREDUC_BACKUP/COURSE/MODULES/MOD/RESOURCE do not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'resource', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/RESOURCE',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
    ...
    public function process_resource(array $data, array $raw) {
        ...
        $resource['intro'] = powereduc1_converter::migrate_referenced_files($resource['intro'], $this->fileman);
     ...
     * @throws powereduc1_convert_exception for the unknown types
     * @return null|powereduc1_mod_handler the instance of the handler, or null if the type does not have a successor
     */
    protected function get_successor($type, $reference) {
        ...
        switch ($type) {
            ...
            case 'file':
                ...
                break;
            default:
                throw new powereduc1_convert_exception('unknown_resource_successor', $type);
        }
        ...
        if (!isset($this->successors[$name])) {
            ...
            $class = 'powereduc1_mod_'.$name.'_handler';
