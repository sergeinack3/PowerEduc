 ...
 */
class powereduc1_mod_survey_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/SURVEY does not
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'survey', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/SURVEY',
                array(
                    'newfields' => array(
                        'introformat' => 0,
                    ),
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/SURVEY
     * data available
     */
