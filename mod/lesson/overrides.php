...
$accessallgroups = ($lessongroupmode == NOGROUPS) || has_capability('powereduc/site:accessallgroups', $context);
...
$url = new powereduc_url('/mod/lesson/overrides.php', array('cmid' => $cm->id, 'mode' => $mode));
...
navigation_node::override_active_url(new powereduc_url('/mod/lesson/overrides.php', ['cmid' => $cmid]));
...
$overridedeleteurl = new powereduc_url('/mod/lesson/overridedelete.php');
$overrideediturl = new powereduc_url('/mod/lesson/overrideedit.php');
