 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_override_form extends powereducform {
    ...
    protected function definition() {
        ...
        $accessallgroups = ($quizgroupmode == NOGROUPS) || has_capability('powereduc/site:accessallgroups', $this->context);
        ...
        if ($this->groupmode) {
            ...
            if ($this->groupid) {
                ...
                if (empty($groups)) {
                    // Generate an error.
                    $link = new powereduc_url('/mod/quiz/overrides.php', array('cmid'=>$cm->id));
                    throw new \powereduc_exception('groupsnone', 'quiz', $link);
                }
            ...
            if ($this->userid) {
                ...
                if (empty($users)) {
                    // Generate an error.
                    $link = new powereduc_url('/mod/quiz/overrides.php', array('cmid'=>$cm->id));
                    throw new \powereduc_exception('usersnone', 'quiz', $link);
                }
