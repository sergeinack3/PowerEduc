...
/**
 * Defines the PowerEduc forum used to add random questions to the quiz.
 *
 * @package   mod_quiz
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_add_random_form extends powereducform {
    ...
    protected function definition() {
        ...
        $usablecontexts = $contexts->having_cap('powereduc/question:useall');
