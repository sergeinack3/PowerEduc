...
class powereduc1_mod_lti_handler extends powereduc1_mod_handler {
     ...
     * defined.
     *
     * Note that the path /POWEREDUC_BACKUP/COURSE/MODULES/MOD/LTI does not
    ...
    public function get_paths() {
        ...
        return array(
            new convert_path(
                'basiclti', '/POWEREDUC_BACKUP/COURSE/MODULES/MOD/LTI'
            )
        );
    ...
    /**
     * This is executed every time we have one /POWEREDUC_BACKUP/COURSE/MODULES/MOD/LTI
     * data available
     */
