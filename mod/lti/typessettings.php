...
/**
 * This file contains the script used to clone PowerEduc admin setting page.
 *
...
if (!empty($id)) {
    ...
    if (!empty($type->toolproxyid)) {
        ...
        $redirect = new powereduc_url('/mod/lti/toolssettings.php', $params);
        redirect($redirect);
    }
} else {
    $type = new stdClass();
...
$pageurl = new powereduc_url('/mod/lti/typessettings.php');
if (!empty($id)) {
    $pageurl->param('id', $id);
}
if (!empty($returnto)) {
...
$PAGE->navbar->add(get_string('manage_external_tools', 'lti'), new powereduc_url('/mod/lti/toolconfigure.php'));
