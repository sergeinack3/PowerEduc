...
class tool_configure_page implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $url = new powereduc_url('/mod/lti/typessettings.php', array('sesskey' => sesskey(), 'returnto' => 'toolconfigure'));
        $data->configuremanualurl = $url->out();
        $url = new powereduc_url('/admin/settings.php?section=modsettinglti');
        $data->managetoolsurl = $url->out();
        $url = new powereduc_url('/mod/lti/toolproxies.php');
