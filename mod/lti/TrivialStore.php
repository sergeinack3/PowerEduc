...
class TrivialOAuthDataStore extends OAuthDataStore {
     ...
     * @param string $consumerkey     Consumer key
     *
     * @return powereduc\mod\lti\OAuthConsumer  OAuthConsumer object
     */
     ...
     *
     * @param powereduc\mod\lti\OAuthConsumer $consumer     Consumer
     * @param string $tokentype    Type of token
     * @param string $token        Token ID
     *
     * @return powereduc\mod\lti\OAuthToken OAuthToken object
     */
