...
getenv('GITHUB_WORKFLOW') || die; // phpcs:ignore powereduc.Files.PowerEducInternal.PowerEducInternalGlobalState
...
$CFG->dataroot  = realpath(dirname(__DIR__)) . '/powereducdata';
$CFG->admin     = 'admin';
