...
if (!$authplugin = signup_is_enabled()) {
    throw new \powereduc_exception('notlocalisederrormessage', 'error', '', 'Sorry, you may not use this page.');
}
...
if (isloggedin() and !isguestuser()) {
    ...
    $logout = new single_button(new powereduc_url('/login/logout.php',
...
if (\core_auth\digital_consent::is_age_digital_consent_verification_enabled()) {
    ...
    if ($isminor === false) {
        ...
        redirect(new powereduc_url('/login/verify_age_location.php'));
    } else if ($isminor === 'yes') {
