...
$PAGE->set_url(new powereduc_url('/local/powerschool/campus.php'));
...
$templatecontext = (object)[
    ...
    'campusedit' => new powereduc_url('/local/powerschool/campusedit.php'),
    'campussupp'=> new powereduc_url('/local/powerschool/campus.php'),
