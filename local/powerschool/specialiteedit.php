...
$recordtoinsert = new specialite();
    ...
    if($fromform->id) {
        ...
        $recordtoinsert->update_specialite($fromform->id, $fromform->libellespecialite,$fromform->abreviationspecialite,$fromform->idfiliere );
        redirect($CFG->wwwroot . '/local/powerschool/specialite.php', 'Bien modifier');
