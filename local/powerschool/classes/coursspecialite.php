...
class coursspecialite extends moodleform {
     ...
     */
    public function update_coursspecialite(int $id, string $idcourse, string $idspecialite, string $idcycle ): bool
    {
        global $DB;
        global $USER;
        $object = new stdClass();
    ...
    public function verifcourspeciali(int $coursid,int $cycle,$sp){
