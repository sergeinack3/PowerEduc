...
class configurerpaiement extends moodleform {
    ...
    public function definition() {
        ...
        $sql4 = "SELECT cy.id as cyid,libellecycle FROM {cycle} cy,{filiere} fi,{coursspecialite} cou,{specialite} sp,{campus} ca
                 WHERE cy.id=cou.idcycle AND cou.idspecialite=sp.id AND sp.idfiliere=fi.id AND ca.id=fi.idcampus
                 AND fi.idcampus='".$_GET["idca"]."'";
