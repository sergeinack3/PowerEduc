...
$recordtoinsert = new seance();
    ...
    if($fromform->id) {
        ...
        $recordtoinsert->update_seance($fromform->id, $fromform->idcourses,$fromform->idsalle,$fromform->idspecialite,$fromform->idcycle,$fromform->$datecours,$fromform->heuredebutseance,$fromform->heurefinseance);
