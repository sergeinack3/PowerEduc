...
$recordtoinsert = new coursspecialite();
    ...
    if($fromform->id) {
        ...
        $recordtoinsert->update_coursspecialite($fromform->id, $fromform->idcourses,$fromform->idspecialite,$fromform->idcycle);
        redirect($CFG->wwwroot . '/local/powerschool/coursspecialite.php', 'Bien modifier');
