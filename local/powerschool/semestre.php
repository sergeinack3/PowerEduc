...
$PAGE->set_url(new powereduc_url('/local/powerschool/semestre.php'));
...
$templatecontext = (object)[
    ...
    // 'datefinsem' => $datefin,
    'semestreedit' => new powereduc_url('/local/powerschool/semestreedit.php'),
    'semestresupp'=> new powereduc_url('/local/powerschool/semestre.php'),
