...
$templatecontext = (object)[
    ...
    'catfiliere' => new powereduc_url('/course/editcategory.php'),
    'cattfiliere' => new powereduc_url('/local/powerschool/filiere.php'),
    'root'=>$CFG->wwwroot,
    'idca'=>$_GET["idca"],
...
$campuss=(object)[
    'campus'=>array_values($campus),
    'confpaie'=>new powereduc_url('/local/powerschool/filiere.php'),
            ]; 
