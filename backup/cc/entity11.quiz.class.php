...
class cc11_quiz extends entities11 {
    ...
    public function generate_node_course_modules_mod () {
        ...
        cc112powereduc::log_action('Creating Quiz mods');
    ...
    private function create_node_course_modules_mod_quiz_feedback () {
        ...
        $sheet_question_mod_feedback = cc112powereduc::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_QUIZ_FEEDBACK);
    ...
    private function generate_instances () {
        ...
        foreach ($types as $type) {
            ...
            if (!empty(cc112powereduc::$instances['instances'][$type])) {

                foreach (cc112powereduc::$instances['instances'][$type] as $instance) {
                    ...
                    if (!empty($assessment_file)) {
                        ...
                        $assessment = $this->load_xml_resource(cc112powereduc::$path_to_manifest_folder . DIRECTORY_SEPARATOR . $assessment_file);
    ...
    private function create_node_course_modules_mod ($instance) {
        ...
        $sheet_question_mod = cc112powereduc::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_QUIZ);
    ...
    private function get_global_config ($assessment, $option, $default_value, $replace_values = '') {
        ...
        $xpath = cc112powereduc::newx_path($assessment, cc112powereduc::getquizns());
    ...
    private function create_node_course_modules_mod_quiz_question_instances ($instance) {
        ...
        $sheet_question_mod_instance = cc112powereduc::loadsheet(SHEET_COURSE_SECTIONS_SECTION_MODS_MOD_QUIZ_QUESTION_INSTANCE);
    ...
    private function create_node_course_question_categories ($instances) {
        ...
        $sheet_question_categories = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES);
    ...
    private function create_node_course_question_categories_question_category ($instance) {
        ...
        $sheet_question_categories_quetion_category = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY);
    ...
    private function create_node_course_question_categories_question_category_question ($instance) {
        ...
        $sheet_question_categories_question = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION);
    ...
    private function create_node_course_question_categories_question_category_question_multiple_choice ($question) {
        ...
        $sheet_question_categories_question = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_MULTIPLE_CHOICE);
    ...
    private function create_node_course_question_categories_question_category_question_eesay ($question) {
        ...
        $sheet_question_categories_question = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_EESAY);
    ...
    private function create_node_course_question_categories_question_category_question_shortanswer ($question) { //, &$fib_questions) {
        ...
        $sheet_question_categories_question = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_SHORTANSWER);
        $node_course_question_categories_question_answer = '';
    ...
    private function create_node_course_question_categories_question_category_question_true_false ($question) {
        ...
        $sheet_question_categories_question = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_TRUE_FALSE);
    ...
    private function create_node_course_question_categories_question_category_question_answer ($answer) {
        ...
        $sheet_question_categories_question_answer = cc112powereduc::loadsheet(SHEET_COURSE_QUESTION_CATEGORIES_QUESTION_CATEGORY_QUESTION_ANSWER);
