...
class powereduc1_converter_test extends \advanced_testcase {
    ...
    /** @var string the name of the directory containing the unpacked PowerEduc 1.9 backup */
    protected $tempdir;

    /** @var string the full name of the directory containing the unpacked PowerEduc 1.9 backup */
