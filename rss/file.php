...
/** NO_DEBUG_DISPLAY - bool, Disable powereduc debug and error messages. Set to false to see any errors during RSS generation */
define('NO_DEBUG_DISPLAY', true);

/** NO_POWEREDUC_COOKIES - bool, Disable the use of sessions/cookies - we recreate $USER for every call. */
...
// Work out which component in PowerEduc we want (from the frankenstyle name).
