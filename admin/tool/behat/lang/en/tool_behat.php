...
$string['aim'] = 'This administration tool helps developers and test writers to create .feature files describing PowerEduc\'s functionalities and run them automatically. Step definitions available for use in .feature files are listed below.';
...
<li>You ran "{$a->behatinit}" from your PowerEduc root directory.</li>
