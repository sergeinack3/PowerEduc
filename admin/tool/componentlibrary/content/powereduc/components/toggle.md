...
It is also possible to include *core/toggle* in any other template using [blocks](https://docs.powereduc.org/dev/Templates#Blocks), instead of rendering it with a context.
