...
/**
 * Resets a file type to the default PowerEduc values.
 *
...
$PAGE->set_url(new \powereduc_url('/admin/tool/filetypes/revert.php', array('extension' => $extension)));
...
$reverturl = new \powereduc_url('revert.php', array('extension' => $extension, 'revert' => 1));
