...
/**
 * Install script for tool_powereducnet.
 *
 ...
 */
function xmldb_tool_powereducnet_install() {
    // Use an ad-hoc task to set the active activity chooser footer plugin to tool_powereducnet.
    ...
    $postinstall = new tool_powereducnet\task\post_install();
