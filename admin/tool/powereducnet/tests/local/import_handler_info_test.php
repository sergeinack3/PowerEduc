...
use tool_powereducnet\local\import_handler_info;
use tool_powereducnet\local\import_strategy;
use tool_powereducnet\local\import_strategy_file;

/**
 * Class tool_powereducnet_import_handler_info_testcase, providing test cases for the import_handler_info class.
 *
