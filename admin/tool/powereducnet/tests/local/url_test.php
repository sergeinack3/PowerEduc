...
/**
 * Class tool_powereducnet_url_testcase, providing test cases for the url class.
 *
...
class url_test extends \advanced_testcase {
    ...
    public function url_provider() {
        return [
            'No path' => [
                'url' => 'https://example.powereduc.net',
                'host' => 'example.powereduc.net',
                'path' => null,
                'exception' => false,
            ],
            'Slash path' => [
            ...
            'Path includes file and extension' => [
                'url' => 'https://example.powereduc.net/uploads/123456789/pic.png',
                'host' => 'example.powereduc.net',
                'path' => '/uploads/123456789/pic.png',
                'exception' => false,
            ],
            'Path includes file, extension and params' => [
                'url' => 'https://example.powereduc.net/uploads/123456789/pic.png?option=1&option2=test',
                'host' => 'example.powereduc.net',
                'path' => '/uploads/123456789/pic.png',
                'exception' => false,
            ],
