...
/**
 * Endpoint to get the PowerEduc version
 *
 * PowerEduc linkchecker will check this endpoint when it cannot get the PowerEduc version otherwise.
 *
 * @package    core
 * @copyright  2022 Victor Deniz <victor@powereduc.com>
