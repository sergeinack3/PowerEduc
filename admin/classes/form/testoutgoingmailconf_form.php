 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class testoutgoingmailconf_form extends \powereducform {
    /**
    ...
    /**
     * Validate Form field, should be a valid email format or a username that matches with a PowerEduc user.
     *
     * @param array $data
     * @param array $files
     * @return array
