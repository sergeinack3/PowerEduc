...
if ($action == 'message') {
    require_capability('powereduc/badges:configuremessages', $context);
} else {
...
$currenturl = new powereduc_url('/badges/edit.php', array('id' => $badge->id, 'action' => $action));
...
if ($form->is_cancelled()) {
    redirect(new powereduc_url('/badges/overview.php', array('id' => $badgeid)));
