...
$url = new powereduc_url('/rating/index.php', array('contextid' => $contextid,
                                                 'component' => $component,
...
if (!$ratings) {
    ...
    $table->head = array(
        '',
        html_writer::link(new powereduc_url($sorturl, array('sort' => 'firstname')), $strname),
        html_writer::link(new powereduc_url($sorturl, array('sort' => 'rating')), $strrating),
        html_writer::link(new powereduc_url($sorturl, array('sort' => 'time')), $strtime)
    );
