...
abstract class data_controller {
     ...
     */
    public function instance_form_definition_after_data(\PowerEducQuickForm $mform) {
     ...
     * @param \PowerEducQuickForm $mform
     */
    public abstract function instance_form_definition(\PowerEducQuickForm $mform);
