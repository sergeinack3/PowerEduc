...
class manual extends base {
    ...
    public function get_config_form(PowerEducQuickForm $mform): void {
        ...
        $options = [
            ...
            'valuehtmlcallback' => function($userid) {
                ...
                return fullname($user, has_capability('powereduc/site:viewfullnames', context_system::instance()));
            }
        ];
    ...
    public function user_can_add(): bool {
        return has_capability('powereduc/user:viewalldetails', context_system::instance());
    }
