 ...
 * @copyright   2021 Sara Arjona <sara@powereduc.com> based on Alberto Lara Hernández <albertolara@powereduc.com> code.
...
class format {
    ...
    public static function percent(?float $value): string {
        ...
        return get_string('percents', 'powereduc', format_float($value));
    }
}
