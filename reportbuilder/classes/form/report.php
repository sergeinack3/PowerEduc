...
class report extends dynamic_form {
    ...
    public function process_dynamic_submission() {
        ...
        return (new powereduc_url('/reportbuilder/edit.php', ['id' => $reportpersistent->get('id')]))->out(false);
    }
     ...
     */
    public function get_page_url_for_dynamic_submission(): powereduc_url {
        return new powereduc_url('/reportbuilder/index.php');
    }
