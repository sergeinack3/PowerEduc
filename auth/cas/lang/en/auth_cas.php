...
$string['auth_cas_broken_password'] = 'You cannot proceed without changing your password, however there is no available page for changing it. Please contact your PowerEduc Administrator.';
...
$string['auth_cas_create_user'] = 'Turn this on if you want to insert CAS-authenticated users in PowerEduc database. If not then only users who already exist in the PowerEduc database can log in.';
...
$string['auth_cas_logout_return_url'] = 'Provide the URL that CAS users shall be redirected to after logging out.<br />If left empty, users will be redirected to the location that powereduc will redirect users to';
$string['auth_cas_logoutcas'] = 'Select \'yes\' if you want to logout from CAS when you disconnect from PowerEduc';
