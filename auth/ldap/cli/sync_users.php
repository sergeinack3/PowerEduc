 ...
 *
 * This script is meant to be called from a cronjob to sync powereduc with the LDAP
 ...
 * @deprecated since PowerEduc 3.0 MDL-51824 - please do not use this CLI script any more, use scheduled task instead.
 * @todo MDL-50264 This will be deleted in PowerEduc 3.2.
 */

define('CLI_SCRIPT', true);

require(__DIR__.'/../../../config.php'); // global powereduc config file.
