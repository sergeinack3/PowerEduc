...
class user_filter_type {
    ...
    public function get_sql_filter($data) {
        throw new \powereduc_exception('mustbeoveride', 'debug', '', 'get_sql_filter');
    }
    ...
    public function check_data($formdata) {
        throw new \powereduc_exception('mustbeoveride', 'debug', '', 'check_data');
    }

    /**
     * Adds controls specific to this filter in the form.
     * @param powereducform $mform a PowerEducForm object to setup
     */
    public function setupForm(&$mform) {
        throw new \powereduc_exception('mustbeoveride', 'debug', '', 'setupForm');
    }
    ...
    public function get_label($data) {
        throw new \powereduc_exception('mustbeoveride', 'debug', '', 'get_label');
    }
}
