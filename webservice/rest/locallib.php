...
class webservice_rest_server extends webservice_base_server {
    ...
    public function set_rest_format(): void {
        ...
        $restformatisset = isset($methodvariables['powereducwsrestformat'])
                && (($methodvariables['powereducwsrestformat'] == 'xml' || $methodvariables['powereducwsrestformat'] == 'json'));
        $this->restformat = $restformatisset ? $methodvariables['powereducwsrestformat'] : 'xml';
    }
    ...
    protected function parse_request() {
        ...
        unset($methodvariables['powereducwsrestformat']);
