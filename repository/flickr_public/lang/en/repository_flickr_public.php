...
/**
 * Strings for component 'repository_flickr_public', language 'en', branch 'POWEREDUC_20_STABLE'
 *
...
$string['information'] = '<div>Get a <a href="http://www.flickr.com/services/api/keys/">Flickr API Key</a> for your PowerEduc site. </div>';
...
$string['privacy:metadata:repository_flickr_public'] = 'The Flickr public repository plugin does not store any personal data, but does transmit user data from PowerEduc to the remote system.';
