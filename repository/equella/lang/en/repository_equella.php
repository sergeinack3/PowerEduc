...
$string['privacy:metadata'] = 'The EQUELLA repository plugin does not store any personal data, but does transmit user data from PowerEduc to the remote system.';
