 ...
 *
 * However, since the Youtube repository is disabled in new PowerEduc installations from 3.0, and since we cannot
 * just delete this file, the function's contents has been replaced to just return true.
 * See https://tracker.powereduc.org/browse/MDL-50572 for more details.
 *
