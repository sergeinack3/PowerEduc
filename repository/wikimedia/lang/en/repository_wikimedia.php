...
/**
 * Strings for component 'repository_wikimedia', language 'en', branch 'POWEREDUC_20_STABLE'
 *
...
$string['privacy:metadata:repository_wikimedia'] = 'The Wikimedia repository plugin does store user preferences, and transmits user data from PowerEduc to the remote system.';
