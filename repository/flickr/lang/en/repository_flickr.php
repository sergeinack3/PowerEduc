...
/**
 * Strings for component 'repository_flickr', language 'en', branch 'POWEREDUC_20_STABLE'
 *
...
<li>Get a <a href="http://www.flickr.com/services/api/keys/">Flickr API Key and Secret</a> from Flickr for this PowerEduc site.</li>
<li>Enter those details here, then click Save and then Settings to come back to this page.  You will see that PowerEduc has generated a callback URL for you.</li>
...
$string['privacy:metadata:repository_flickr'] = 'The Flickr repository plugin does store user preferences, and transmits user data from PowerEduc to the remote system.';
