...
if (file_exists($CFG->dirroot.'/repository/'.$type.'/lib.php')) {
    ...
    throw new \powereduc_exception('invalidplugin', 'repository', $type);
}
...
// http://xx.powereduc.com/repository/repository_callback.php?repo_id=1&sid=xxx
// sid is the attached auth token from external source
// If PowerEduc is working on HTTPS mode, then we are not allowed to access
